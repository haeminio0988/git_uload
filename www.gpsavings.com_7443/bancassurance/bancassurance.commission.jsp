...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
<!-- 				<li><a href="/bancassurance/bancassurance.insurance.jsp">저축보험</a></li> -->
<!-- 				<li><a href="/bancassurance/bancassurance.annuity.jsp">연금보험</a></li> -->
<!-- 				<li><a href="/bancassurance/bancassurance.injury.jsp">상해보험</a></li> -->
<!-- 				<li><a href="/bancassurance/bancassurance.healthinsurance.jsp">건강보험</a></li> -->
				<li><a href="/bancassurance/bancassurance.business.jsp">기업종합보험</a></li>
				<li><a href="/bancassurance/bancassurance.commission.jsp">모집수수료</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_bancassurance_5.gif" alt="모집수수료" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li ><a href="/bancassurance/bancassurance.business.jsp">기업종합보험</a></li>
							<li class="on"><a href="/bancassurance/bancassurance.commission.jsp">모집수수료</a></li>
						
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 방카슈랑스 &gt; <span>모집수수료</span></div>
		</div>
		<div class="con_body bancassurance commission">
			<div class="box1">
				<h3 class="hiding">모집수수료율</h3>
				<p style="height:40px;"></p>
				<h6>
					<span><strong><font color="black" size="3">모집수수료율</font><font size="1"> (기준일 : 2017년 10월 19일)</font></strong></span>
				</h6>
				<div class="tables type1 mb20">
					<table>
						...
						<thead class="theads">
							<tr>
								<th>상품명</th>
								<th>납입주기<span class="bar"></span></th>
								<th>납입기간<span class="bar"></span></th>
								<th>모집수수료율<span class="bar"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
								<td class="ta_l pl15">삼성명품 비지니스패키지</td>
								<td>연납</td>
								<td>1년</td>
								<td>8.8</td>
							</tr>
							<tr>
								<td class="ta_l pl15">삼성명품 재산종합보험</td>
								<td>연납</td>
								<td>1년</td>
								<td>8.8</td>
							</tr>
							<tr>
								<td class="ta_l pl15">Samsung's Trademark Package</td>
								<td>연납</td>
								<td>1년</td>
								<td>8.8</td>
							</tr>
				...
				<ul class="mt20">
					<li>상기 '모집수수료율'은 보험회사가 금융기관보험대리점에 지급하는 대리점 수수료 중, 신계약체결의 대가로 지급하는 '신계약모집수수료'와 보험계약 유지시 지급하는 효율(유지)수수료 등을 포함한 총 수수료가 보험료 납입기간 동안 들어오는 보험료 전액에서 차지하는 비율입니다.</li>
				</ul>
				<h4 class="mb45"><img src="../inc/img/footer_bancassurance_2.gif" alt="삼성화재" /></h4>
			</div><!-- box1 -->
		</div><!-- saving -->		
	</div>
	<address>
