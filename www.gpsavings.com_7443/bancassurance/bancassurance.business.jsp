...
<!-- 				<li><a href="/bancassurance/bancassurance.healthinsurance.jsp">건강보험</a></li> -->
			...
			<h2><img src="../inc/img/txt/h2_bancassurance_4.gif" alt="기업종합보험" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/bancassurance/bancassurance.business.jsp">기업종합보험</a></li>
							<li ><a href="/bancassurance/bancassurance.commission.jsp">모집수수료</a></li>
						
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 방카슈랑스 &gt; <span>기업종합보험</span></div>
		</div>
		<div class="con_body bancassurance business">
			<div class="box1">
				<h3 class="hiding">화재위험, 집기비품의 손해, 제3자에 대한 각종 배상책임 등을 종합적으로 보장하는 비즈니스 패키지</h3>
				<p style="height:70px;"></p>
				<h4><img src="../inc/img/txt/h4_bancassurance_14.gif" alt="삼성명품 비즈니스 패키지" /></h4>
				<p style="height:40px;"></p>
				<h6>
					<img src="../inc/img/txt/txt_join.gif" alt="가입조건" />
				</h6>
				<div class="tables type2">
					<table>
						<tbody class="tbodys">
							<tr>
								<th>가입대상</th>
								<td>점포, 공장, 사무실, 음식점 등 (개인사업자, 법인고객)</td>
							</tr>
							<tr>
								<th>납입기간</th>
								<td>1년~3년 (납입주기 : 일시납)</td>
							</tr>
							<tr>
								<th>보장범위</th>
								<td>화재손해, 기계손해, 영업배상 등</td>
							</tr>
						</tbody>
					</table>
				</div>
				<ul class="mt20">
					<li> 자세한 상담은 영업점으로 문의 주시기 바랍니다</li>
				</ul>
				<h4 class="mb45"><img src="../inc/img/footer_bancassurance_1.gif" alt="삼성화재" /></h4>
				<h5 class="mb45">공평저축은행 준법감시인 심의필 제201호 (2015.02.27)</h5>
			</div><!-- box1 -->
		</div><!-- saving -->		
	</div>
	<address>
