...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 대출상품 &gt; 담보대출 &gt; <span>유가증권 담보대출</span></div>
		</div>
		<div class="con_body loan_info securities">
			<div class="box1">
				<h3 class="hiding">거래소 또는 코스닥 상장주식, 국공채, 지방채, 기타 유가증권을 담보로 필요하신 자금을 지원해 드리는 대출상품입니다.</h3>
				<h4><img src="../inc/img/txt/h4_loan_info_27.gif" alt="유가증권 담보대출" /></h4>
					...
					<table>
						...
						<tbody class="tbodys">
							...
							<tr>
								...
								<td><font color="red">유가증권의 종류에 따라 심사 후 결정</font></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="moreline">
									유가증권 실물, 실명확인증표, 소득증빙서류, 세금완납서류, 주민등록등초본 등 (자세한 사항은 영업점 문의 요망)
								</td>
							</tr>
							<tr>
								...
								<td class="moreline">
									...
									°&nbsp;대출금의 상환 또는 이자납입이 지연된 경우 연체이율이 적용되며 예금 등 기타채권과의 상계나 법적절차 등으로 재산상의 불이익을 당하실 수 있습니다.<br/>
									°&nbsp;기타 자세한 내용은 창구직원 또는 고객상담센터(☎ : 1577-1771)로 문의하시거나 상품설명서를 반드시 참조하시기 바랍니다.
