...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 대출상품 &gt; 기타대출 &gt; <span>어음할인</span></div>
		</div>
		<div class="con_body loan_info billdis">
			<div class="box1">
				<h3 class="hiding">거래자가 보유하고 있는 지급기일이 도래하지 않은 어음을 저축은행이 만기일까지의 할인료를 어음금액에서 차감한 금액을 지급하고 그 어음을 할인매입하는 형식으로 할인의뢰인에게 필요하신 자금을 지원해 드리는 대출 상품입니다.</h3>
				<h4><img src="../inc/img/txt/h4_loan_info_32.gif" alt="어음할인" /></h4>
				...
				<div class="tables">
					<table>
						...
						<tbody class="tbodys">
							<tr>
								<th colspan="2">할인대상어음</th>
								<td>진성어음(상거래에 수반하여 발생한 어음, CP(기업어음)</td>
							</tr>
							<tr>
								<th colspan="2">할인한도</th>
								<td>채무자의 재무상태 및 상환능력, 어음발행인의 신용도를 고려하여 한도결정</td>
							</tr>
							<tr>
								<th colspan="2"><font color="red">할인율(금리)</font></th>
							...
							<tr>
								<th colspan="2">할인기간</th>
								<td class="moreline">할인일로부터 대상어음의 지급기일까지<br/>(6개월 이내)</td>
							</tr>
							<tr>
								<th colspan="2">상환방식</th>
								<td class="moreline">
									만기일시상환방식<br/>
									°&nbsp;만기일시상환 : 원금은 만기일에 일시상환하고 할인료는 취급일로부터 할인기일 전까지의 기간에 대한 선취. 다만, 결제지연으로인한 이자는 후취
								</td>
							</tr>
							<tr>
								<th colspan="2">필요서류</th>
								<td class="moreline">
									어음원본, 세금계산서, 계약서류, 실명확인증표, 사업자등록증, 재무제표 등<br/>(자세한 사항은 영업점 문의 요망)
								</td>
							</tr>
							<tr>
