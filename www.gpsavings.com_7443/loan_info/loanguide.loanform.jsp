...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 대출상품 &gt; 대출가이드 &gt; <span>대출신청시 필요서류</span></div>
		</div>
		<div class="con_body loan_info loanform">
			<div class="box1">
				<h3 class="hiding"></h3>
				<h4><img src="../inc/img/txt/h4_loan_info_42.gif" alt="대출가이드" /></h4>
				<h5><img src="../inc/img/txt/h5_loan_info_421.gif" alt="개인, 개인사업자" /></h5>
				<div class="tables type1">
					<table>
						...
						<tbody class="tbodys">
							...
							<tr>
								<td>국세 및 지방세 완납증명서</td>
								<td></td>
							</tr>
							<tr>
								<td>부동산등기부등본, 등기권리증</td>
								<td>담보대출시</td>
							</tr>
							<tr>
								<td>매매계약서, 임대차계약서</td>
				...
				<h5 class="mt20"><img src="../inc/img/txt/h5_loan_info_422.gif" alt="법인" /></h5>
				...
				<span class="notice"><i class="ico notice"></i> 대출상품에 따라 필요서류가 추가 될 수 있으니, 자세한 상담은 영업점에 문의하시면 친절히 상담해 드리겠습니다.</span>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
	<address>
