...
<script>
	function viewLoanGoodsManual(){
		window.open("/loan_info/loan.loangoodsmanual.jsp", "openManual", "width=920,height=640, toolbar=0, status=no, top=0, left=100, resizable=no, scrollbars=yes");
	}
</script>
<script type="text/javascript">
	function fnFileDownload(fileno) {
		...
		frm.action = "/include/file_download.jsp";
...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<h2><img src="../inc/img/txt/loan.justloan.gif" alt="신용대출" /></h2>
			
						
				<div class="tab_menu">
					<ul>
						
							<li class="on"><a href="/loan_info/loan.justloan.jsp">신용대출</a></li>
			...
			<div class="navi">홈 &gt; 대출상품 &gt; 신용대출 &gt; <strong>저스트론</strong></div>
		</div>
		<div class="con_body loan_info justloan">
			<div class="box1">
				<h3 class="hiding">돈을 부르는 올바른 선택! 저스트론!</h3>
				<a href="http://www.justloan.co.kr/" target="_blank">
					<img src="../inc/img/btn/btn_detail.gif" alt="자세히 보기" />
				</a>
<!-- 				<a href="#" onClick="javascript:viewLoanGoodsManual();"> -->
				<a href="#" onClick="javascript:fnFileDownload('1');">
					<img src="../inc/img/btn/btn_loanmanual.gif" alt="대출상품설명서" />
				</a>		
				<ul>
					
					<li>
						<a href="http://www.justloan.co.kr/product/product01.do" target="_blank"><img src="../inc/img/img/img_loan.just2_1.jpg" alt="" /></a>
						<div class="hiding">
							<h4>직장인 대출</h4>
							<p>현명한 대출을 위한 합리적 결정!</p>
							<p>한도: 100만원 ~ 5,000만원</p>
							<p>금리: 연7.0% ~ 39%</p>
						</div>
					</li>
					<li>
						<img src="../inc/img/img/img_loan.just8.jpg" alt="" />
						
					</li>
					<li>
						<a href="http://www.justloan.co.kr/product/product04.do" target="_blank"><img src="../inc/img/img/img_loan.just3_1.jpg" alt="" /></a>
						<div class="hiding">
							<h4>직장인 대환론</h4>
							<p>사용하고 있는 금리 보다 더 낮게 더 높은 한도로 실속있게 관리하기!</p>
							<p>한도: 100만원 ~ 7,000만원</p>
							<p>금리: 연7% ~ 39%</p>
						</div>
					</li>
					<li>
						<img src="../inc/img/img/img_loan.just4.jpg" alt="" />
					</li>
					<li>
                        <a href="http://www.justloan.co.kr/product/product09.do" target="_blank"><img src="../inc/img/img/img_loan.just9_1.jpg" alt="" /></a>
                        <div class="hiding">
							<h4>기타대출</h4>
							<p>현명한 대출을 위한 합리적 결정!</p>
							<p>한도: 100만원 ~ 7,000만원</p>
					...
					<li>
						<img src="../inc/img/img/img_loan.just6.jpg" alt="" />
					</li>
	...
	<iframe name="hidden_frame" width="0" height="0" frameborder="0"></iframe>
	<address>
		<!-- 카피와 주소 실제 읽히는 내용 -->
