...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/loan_info/etcloan.pf.jsp">Project Financing(PF)</a></li>
				<li><a href="/loan_info/etcloan.billdis.jsp">어음할인</a></li>
				<li><a href="/loan_info/etcloan.hatsal.jsp">햇살론</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_loan_info_3.gif" alt="기타대출" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/loan_info/etcloan.pf.jsp">기타대출</a></li>
							<li ><a href="/loan_info/loanguide.loanterm.jsp">대출가이드</a></li>
						
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 대출상품 &gt; 기타대출 &gt; <span>Project Financing(PF)</span></div>
		</div>
		<div class="con_body loan_info pf">
			<div class="box1">
				<h3 class="hiding">PF는 부동산개발 관련 특정 프로젝트의 사업성을 평가하여 그 사업에서 발생할 미래 현금흐름과 사업자를 담보로 토지매입금, 송사비, 사업비 등을 지원해드리는 대출 상품입니다.</h3>
				<h4><img src="../inc/img/txt/h4_loan_info_31.gif" alt="Project Financing" /></h4>
					...
					<table>
						...
						<tbody class="tbodys">
							...
							<tr>
								...
								<td>프로젝트 관련 토지매입자금, 공사자금, 운영자금</td>
							</tr>
							<tr>
								<th rowspan="2">대출한도</th>
								<th style="border-left:1px solid #cfcfcf">최대한도</th>
								<td>당행 자기자본의 20%이내</td>
							</tr>
							<tr>
								<th style="border-left:1px solid #cfcfcf">산정기준</th>
								<td class="moreline">
									사업타당성, 사업시행자 및 시공사의 신용도, 제반 리스크 점검 후 소요자금 범위내에서 적정한도 산정
								</td>
							</tr>
							<tr>
								<th colspan="2"><font color="red">금리</font></th>
								<td><font color="red">내부 심사 후 결정</font></td>
							</tr>
							<tr>
							...
							<tr>
								<th rowspan="3" class="moreline">수수료 및<br/>대출기한전<br/>상환수수료 등</th>
								<th style="border-left:1px solid #CCC6BC">수수료</th>
								<td>내부심사 후 결정</td>
							</tr>
							<tr>
								<th style="border-left:1px solid #CCC6BC">연체이자율</th>
							...
							<tr>
								<th style="border-left:1px solid #CCC6BC" class="moreline">대출기한전<br/>상환수수료 등</th>
								<td class="moreline">
									1. 대출의 상환기일이 도래하기 전에 대출금을 상환할 경우 고객이 부담하는 금액<br/>
									2. 대출기간중 일정 기간내에 상환이 있는 경우 상환금액에 대해 고객이 부담하는 수수료<br/>
									°&nbsp;계산방식 : 기한전상환대출금액 × 기한전상환수수료율 × 대출잔여일수 / 대출약정기간<br/><br/>
									※ 대출약정체결전에 미리 중도상환수수료 계산방법과 부담조건, 면제조건 등을 확인하시기 바랍니다.
								</td>
							</tr>							
							<tr>
							...
							<tr>
								...
								<td class="moreline">
									사업계획서, 사업수지표, 현금흐름표, 토지조서, 인허가 관련서류, 사업자등록증, 법인등기부등본, 실명확인증표 등<br/>
									(자세한 사항은 영업점 문의 요망)
								</td>
							</tr>
							<tr>
