...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 대출상품 &gt; 대출가이드 &gt; <span>대출부대비용 및 수수료</span></div>
		</div>
		<div class="con_body loan_info commission">
			<div class="box1">
				<h4 class="mb45"><img src="../inc/img/txt/h4_loan_info43.gif" alt="대출 부대비용 및 수수료" /></h4>
				...
				<div class="tables type1 mb20">
					<table>
						...
						<thead class="theads">
							<tr>
								<th colspan="2"><span class="bar set10"></span>구분</th>
				...
				<div class="tables type1">
					<table>
						...
						<thead class="theads">
							<tr>
								<th>대출금액<span class="bar set10"></span></th>
