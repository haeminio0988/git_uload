...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 대출상품 &gt; 담보대출 &gt; <span>전세보증금 담보대출</span></div>
		</div>
		<div class="con_body loan_info charter">
			<div class="box1">
				<h3 class="hiding">아파트에 거주하는 임차인에게 임대차보증금을 담보로 가계자금 및 사업자금을 지원해 드리는 대출상품입니다.</h3>
				<h4><img src="../inc/img/txt/h4_loan_info_26.gif" alt="전세보증금 담보대출" /></h4>
				...
				<div class="tables">
					<table>
						...
						<tbody class="tbodys">
							<tr>
								<th colspan="2">대출물건</th>
								<td class="moreline">
								서울, 경기, 인천지역 및 기타지역 아파트, 빌라, 다세대, 다가구주택</br>
								(기타지역: 광역시, 천안시, 아산시, 춘천시, 원주시, 세종시)
								</td>
							</tr>
							<tr>
								<th colspan="2">대출형식</th>
								<td>일반자금대출</td>
							</tr>
							<tr>
								<th colspan="2">대출한도</th>
								<td class="moreline">
								임차보증금담보대출  = 최대 90%(임차보증금)</br>
								입주잔금대출 = 최대 80%(임차보증금)</br>
								※기타 심사조건에 따른 한도적용
								</td>
							</tr>
							<tr>
								<th rowspan="2"><font color="red">금리</th>
								<th style="border-left:1px solid #CCC6BC"><font color="red">금리</font></th>
								<td class="moreline">
									신용등급별 차등적용(최저 7.3%~최대 16%)</br>
									(후순위 전세보증금대출의 경우 최저 11%~ 최대 18% 적용)
								</td>
							</tr>
							<tr>
								<th style="border-left:1px solid #CCC6BC">가산금리</th>
								<td class="moreline">대출기간 12개월 이하, 미등기아파트여부, 재외국인여부, </br>수도권 외 기타지역 등 (여부에 따른 가산금리 적용)
							...
							<tr>
								...
								<td class="moreline">
									상환금액의 2%(대출 만기일로부터 2개월 전 면제) <br/>
									°&nbsp;계산방식: 기한전상환대출금액 * 중도상환수수료(2%) * (대출잔여일수 / 대출약정기간)
								</td>
							</tr>
							<tr>
								<th colspan="2"><font color="red">인지비용부담</font></th>
								<td class="moreline">
									°&nbsp;인지비용은 법규에 의하여 고객 50%, 당행 50% 적용됨.</br>
									°&nbsp;대출금 5천만원 초과 시 대출금액 별 차등적용</br>
									※ 5천만원 초과시 70,000원(고객부담 35,000원, 은행부담 35,000원)</br>
									&nbsp;&nbsp;&nbsp;1억 초과시 150,000원(고객부담 75,000원, 은행부담 75,000원)</br>
									&nbsp;&nbsp;&nbsp;10억 이상 시 350,000원(고객부담 175,000원, 은행부담 175,000원)
								</td>
							</tr>
							<tr>
								<th colspan="2">대출기간</th>
								<td>대출실행일부터 임대차만기일까지(최소 6개월 ~ 최장 2년 이상)</td>
							</tr>
							<tr>
				...
				<h5 class="mb45">공평저축은행 준법감시인 심의필 2017-004호(2017.01.19)</h5>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
	<address>
