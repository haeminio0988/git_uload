...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 대출상품 &gt; 기타대출 &gt; <span>햇살론</span></div>
		</div>
		<div class="con_body loan_info hatsal">
			<div class="box1">
				<h3 class="hiding">2010년 7월 26일 공평저축은행 햇살론 전격 출시!</h3>
				<p class="hiding">공평저출은행 햇살론 전격 출시! 2010년 7월 26일부터 전국의 공평저축은행 지점에서 햇살론을 만나보세요.</p>
				<h4><img src="../inc/img/txt/h4_loan_info_33.gif" alt="햇살론" /></h4>
				...
				<div class="tables">
					<table>
						...
						<tbody class="tbodys">
							<tr>
								<th colspan="2">대출대상</th>
								<td class="moreline">
									저신용, 저소득 근로자와 자영업자등
									<ul class="mt5">
										<li>근로자: 신용등급 6등급 이하 또는 연간소득 2,600만원 이하의 3개월 이상 재직 중인 근로자</li>
										<li>자영업자: 신용등급 6등급 이하 또는 연간소득 2,600만원 이하의 자영업자</li>
									</ul>
								</td>
							</tr>
							<tr>
								...
								<td class="moreline">
									신용등급별로 대출 최고금액에 차이가 있습니다.
									<ul class="mt5">
										<li>근로자: 6등급 1,000만원 이내, 7등급 800만원 이내 등</li>
										<li>자영업자: 6등급 2,000만원 이내, 7등급 1,700만원 이내 등</li>
									</ul>
								</td>
							</tr>
							<tr>
								...
								<td class="moreline">
									<font color="red">저축은행 중앙회에서 매월 고시하는 상한금리 범위 내에서 결정</font>
								</td>
							</tr>
							<tr>
								<th>대출이자율</th>
							...
							<tr>
								<th colspan="2">대출기간<br />상환방식</th>
								<td class="moreline">
									근로자와 자영업자의 대출기간이 다릅니다.
									<ul class="mt5">
										<li>근로자: 3년, 5년 중 택일 가능, 매월 원금균등분할상환</li>
										<li>자영업자: 1년 거치 4년 이내, 원금균등분할상환</li>
									</ul>
									°&nbsp;균등분할상환 : 대출기간(거치기간 제외)동안 원금(원리금)을 균등하게 분할하여 상환
								</td>
							</tr>
							<tr>
								<th colspan="2">준비할 서류</th>
								<td class="moreline">
									근로자: 주민등록등본, 재직증명서, 급여통장 원본, 소득금액증명원 등<br/>
									자영업자: 주민등록등본, 사업사실확인서류, 저소득증빙서류 등
								</td>
							</tr>
							<tr>
								<th colspan="2">대출 취급기간</th>
								<td>2010년 7월 26일 ~ 한도소진 또는 사업종료 시까지</td>
							</tr>
							<tr>
								<th colspan="2">상담 및 신청</th>
								<td>공평저축은행 5개 지점에서 대출신청 하실 수 있습니다.</td>
							</tr>
				...
				<div class="hastaladbout mt20">
					<dl>
						<dt style="position:relative;">
							<img src="../inc/img/img/hatsal/txt_hatsal.gif" alt="햇살론이란?" />
							<a style="position:absolute; top:0; right:0" href="http://www.fsb.or.kr/2009/13_assurance/01_asr_intro.asp" target="_blank"><img src="../inc/img/hatsal/btn_more.gif" alt="햇살론 자세히 보기" /></a>
						</dt>
						<dd>저신용, 저소득 서민에 대한 금융지원을 위해 <strong>저축은행과 정부가 재원을 출연</strong>하여 이를 바탕으로 <strong>서민층에게 대출</strong>을 해드리는 상품입니다.</dd>
					</dl>
				</div>
