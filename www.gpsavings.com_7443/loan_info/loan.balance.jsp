...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/loan_info/loan.apthome.jsp">아파트담보대출 (가계 자금용)</a></li>
				<li><a href="/loan_info/loan.aptcom.jsp">아파트담보대출 (사업 자금용)</a></li>
				<li><a href="/loan_info/loan.land.jsp">부동산담보대출</a></li>
				<li><a href="/loan_info/loan.balance.jsp">경락잔금대출</a></li>
				<li><a href="/loan_info/loan.savings.jsp">예금담보대출</a></li>
				<li><a href="/loan_info/loan.charter.jsp">전세보증금 담보대출</a></li>
				<li><a href="/loan_info/loan.securities.jsp">유가증권 담보대출</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_loan_info_2.gif" alt="담보대출" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/loan_info/loan.apthome.jsp">담보대출</a></li>
							<li ><a href="/loan_info/etcloan.pf.jsp">기타대출</a></li>
							<li ><a href="/loan_info/loanguide.loanterm.jsp">대출가이드</a></li>
						
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 대출상품 &gt; 담보대출 &gt; <span>경락잔금대출</span></div>
		</div>
		<div class="con_body loan_info balance">
			<div class="box1">
				<h3 class="hiding">법원경매로 경락 받으신 부동산을 담보로, 소유권 이전과 동시에 부족한 경락잔금을 지원해드리는 대출상품입니다.</h3>
				<h4><img src="../inc/img/txt/h4_loan_info_24.gif" alt="경락잔금대출" /></h4>
				<h5><img src="../inc/img/txt/h5_product_info.gif" alt="상품정보" /></h5>
				...
				<div class="tables">
					<table>
						...
						<tbody class="tbodys">
							<tr>
								<th colspan="2">대출자격</th>
								<td>법원 경매부동산을 낙찰받은 개인(개인사업자 포함), 법인</td>
							</tr>
							<tr>
								<th colspan="2">자금용도</th>
								<td>낙찰 부동산에 대한 낙찰잔금</td>
							</tr>
							<tr>
								<th colspan="2">대출한도</th>
								<td class="moreline">
									경락물건, 법원감정가, 낙찰가율 등에 따라 차등
								</td>
							</tr>
							<tr>
								<th rowspan="3"><font color="red">금리</font></th>
								<th style="border-left:1px solid #CCC6BC"><font color="red">계산방식</font></th>
								<td><font color="red">기준금리 + 가산금리</font></td>
							</tr>
							<tr>
								<th style="border-left:1px solid #CCC6BC"><font color="red">기준금리</font></th>
								<td><font color="red">당행 <strong>계약기간 12개월 정기예금</strong> 기준금리</font></td>
							</tr>
							<tr>
								<th style="border-left:1px solid #CCC6BC"><font color="red">가산금리</font></th>
								<td><font color="red">담보물건에 따라 차등(최저 4.4% ~ 최대 6.5%)</font></td>
							</tr>
							<tr>
								<th rowspan="2">대출이자율</th>
								<th style="border-left:1px solid #CCC6BC">고정금리</th>
								<td class="moreline">
									대출실행시 결정한 금리가 약정기간 동안 동일하게 적용되는 금리
								</td>
							</tr>
							<tr>
								<th style="border-left:1px solid #CCC6BC">변동금리</th>
								<td class="moreline">
									대출약정 기간내에 기준금리가 변경될 경우 당해 대출금리가 변동되는 금리로서 기준금리가 인상될 경우 고객의 이자부담이 증가될 수 있음
								</td>
							</tr>
							<tr>
								<th colspan="2">연체이자율</th>
								<td class="moreline">1. 대출금리가 13% 이하인 경우
									<div class="tables type1 mb20">
										<table>
											...
											<thead class="theads">
												<tr>
													<th rowspan="2">구분</th>
													<th colspan="3">연체기간<span class="bar"></th>
												</tr>
												<tr>
													<th style="border-top-width:0px !important;">1개월이하<span class="bar"></th>
													<th class="moreline" style="border-top-width:0px !important;">1개월초과~<br/>2개월이하<span class="bar"></th>
													<th style="border-top-width:0px !important;">2개월초과<span class="bar"></th>
												</tr>
											</thead>
											<tbody class="tbodys" >
												<tr>
													<td style="text-align:center !important;">연체금리</td>
													<td style="text-align:center !important;">23%</td>
													<td style="text-align:center !important;">24%</td>
													<td style="text-align:center !important;">25%</td>
												</tr>
											</tbody>
										</table>
									</div>
									...
									<div class="tables type1 mt10 mb10">
										<table>
											...
											<tbody class="tbodys">
												<tr>
													<td style="text-align:center !important;">연체금리</td>
													<td style="text-align:center !important;">대출금리+10%p</td>
													<td style="text-align:center !important;">대출금리+11%p</td>
													<td style="text-align:center !important;">대출금리+12%p</td>
												</tr>
											</tbody>
										</table>
									</div>
							...
							<tr>
								<th colspan="2">중도상환수수료</th>
								<td class="moreline">
									상환금액의 2.0% (단, 대출기간 1년 경과시 면제) <br/>
									°&nbsp;계산방식: 기한전상환대출금액 * 기한전상환수수료율 * (대출잔여일수 / 대출약정기간)
								</td>
							</tr>
							<tr>
								<th colspan="2"><font color="red">인지비용부담</font></th>
								<td class="moreline">
									°&nbsp;대출금 5천만원까지는 수입인지 비용이 없으며, 5천만원 초과시 대출금액별로 수입인지 비용이 차등 부과<br/>
									°&nbsp;수입인지 비용은 각 50%씩 고객과 저축은행이 부담
								</td>
							</tr>
							<tr>
								<th colspan="2">대출기간</th>
								<td>1년 이내(최장 5년까지)</td>
							</tr>
							<tr>
								<th colspan="2">상환방식</th>
								<td class="moreline">
									만기일시상환 또는 원금(원리금)균등분할상환<br/>
								 	°&nbsp;만기일시상환 : 원금은 만기일에 일시상환하고 이자는 일정기간(일, 반월, 월, 분기단위 등)마다 후취<br/>
							...
							<tr>
								...
								<td class="moreline">
									법원 입찰보증금 영수증, 대금납부 기일통지서, 낙찰허가결정문, 실명확인증표, 등기부등본, 소득증빙서류, 세금완납서류, 주민등록등·초본 등<br/>
									(자세한 사항은 영업점 문의 요망)
								</td>
							</tr>
							<tr>
								...
								<td class="moreline">
								    °&nbsp;저축은행 심사기준과 고객의 신용도에 따라 대출여부가 결정됩니다.<br/>
								    °&nbsp;대출금리는 기준금리 변동에 따라 변경될 수 있습니다. <br/>
								    °&nbsp;기간 연장시점에 개인신상에 변경이 있는 경우 대출금의 일부 또는 전부가 회수될 수 있습니다. <br/>
								    °&nbsp;대출금의 상환 또는 이자납입이 지연된 경우 연체이율이 적용되며 예금 등 기타채권과의 상계나 법적절차 등으로 재산상 불이익을 당하실 수 있습니다.<br/>
								    °&nbsp;기타 자세한 내용은 창구직원 또는 고객상담센터(☏ : 1577-1771 )로 문의하시거나 상품설명서를 반드시 참조하시기 바랍니다.<br/>
								    °&nbsp;대출과 관련하여 대출모집인 등이 어떠한 명목 (수수료, 컨설팅비 등) 이건 금전을 수취하는 행위는 불법입니다.<br/>
								</td>
							</tr>
						</tbody>
					</table>
				</div>
				<ul class="mt20" style="width:100%"></ul>
