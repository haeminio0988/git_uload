...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 대출상품 &gt; 대출가이드 &gt; <span>금리인하요구권</span></div>
		</div>
		
		
		<div class="con_body loan_info loanform">
			<div class="box1">
				<h3 class="hiding"></h3>
				<h4><img src="../inc/img/txt/h4_loan_info_45.gif" alt="금리인하요구권" /></h4>
				<h5><img src="../inc/img/txt/h5_loan_info_451.gif" alt="가계대출" /></h5>
					...
					<table>
						...
						<tbody class="tbodys">
							<tr>
								...
								<td>
									<ol>
										<li>▶ 은행의 개인신용평가시스템(CSS)에 따라 금리가 차등 적용되는 
											가계신용대출에 한합니다.
										</li>
										<li>
							...
							<tr>
								...
								<td>
									<ol>
                        				...
                        				<li>&nbsp;&nbsp;&nbsp;(예) 무직에서 취업한 경우, 중소기업에서 대기업, 정부기관 등으로 이직한 경우 등
                        				</li>
                        				<li>▶ 동일 직장내 차주의 직위(직급)가 상승한 경우.
                       					</li>
                       					<li>▶ 차주의 신용등급이 개선된 경우.
                       					</li>
	                        			<li>▶ 차주가 우수고객으로 선정된 경우.
	                        			</li>
	                        			<li>▶ 차주의 연소득 또는 재산이 일정비율 이상 증가한 경우.
	                        			</li>
                        				<li>▶ 차주가 전문직 자격증을 취득하고 현업에 종사하게 된 경우. 
                        				</li>
                        				<li>&nbsp;&nbsp;&nbsp;(예) 변호사, 공인회계사, 세무사, 변리사, 의사, 한의사 등
                        				</li>
                        				<li>▶ 기타 대표이사가 별도로 정하는 경우 등.
                        				</li>
                        			</ol>
								</td>
							</tr>
							<tr>
								...
								<td>
									<ol>
										<li>▶ 신청서식 및 확인서류 접수일로부터 10영업일이내 고객앞 통지.
										</li>
									</ol>
								</td>
							</tr>
							<tr>
								...
								<td>
									<ol>
									 <li>▶ 금리인하요구권 신청서 및 해당증명서류.</li>
									 <li>▶ 이자율변경 추가약정서. (금리인하 약정체결시).</li>
									</ol>								
								</td>
							</tr>
						</tbody>
				...
				<h5 class="mt20"><img src="../inc/img/txt/h5_loan_info_452.gif" alt="기업대출" /></h5>
					...
					<table>
						...
						<tbody class="tbodys">
							<tr>
								...
								<td>
									<ol>
										<li>▶ 정책자금대출, 협약대출, 지급보증, 전액담보부 여신 등을 제외한 기업여신.
										</li>
									</ol>
								</td>
							</tr>
							<tr>
								...
								<td>
									<ol>
										<li>▶ 회사채등급상승, 재무상태개선, 특허권취득.
	                        			</li>
	                       				<li>▶ 재무상태개선, 신용등급 상승.
	                       				</li>
	                       				<li>▶ 담보재공 및 담보제공 계획이 있는 경우.
										</li>	                       															
									</ol>
								</td>
							</tr>
							<tr>
								...
								<td>
									<ol>
										<li>▶ 신청서식 및 확인서류 접수후 담보 및 신용평가등 심사결과일로부터 10영업일이내 고객앞 통지.
										</li>
									</ol>
								</td>
							</tr>
							<tr>
								...
								<td>
									<ol>
									 	<li>▶ 금리인하요구권 신청서 및 해당증명서류.
									 	</li>
										<li>▶ 이자율변경 추가약정서(금리인하 약정체결시).
										</li>
									</ol>								
								</td>
							</tr>
				...
				<span class="notice"><i class="ico notice"></i> 
				&nbsp;&nbsp;금리인하요구권이란 대출거래 약정당시와 비교하여 신용상태의 개선 등 금리인하 요청요건에 
                        	해당하는 고객이 절차에 따라 신청서식 및 확인서류를 제출하여 금리인하를 요구할 수 있는 제도입니다. 
                        	다만, 개인신용평가시스템(CSS)평과결과에 따라서 금리인하가 되지 않을 수도 있습니다.</span>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
	<address>
