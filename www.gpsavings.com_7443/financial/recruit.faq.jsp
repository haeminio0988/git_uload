	...
	$(document).ready(function() {
		$(".faq_list > li > span").click(function(){
			if (!$(this).parent('li').hasClass("over")) {
				...
				$(this).parent('li').find("div.faq_a").show(0,function(){
...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<h2><img src="../inc/img/txt/bank_info/h2_bank_info_31.gif" alt="인재채용" /></h2>
			...
			<div class="navi">홈 &gt; 은행안내 &gt; 인재채용 &gt; <span>채용전형 FAQ</span></div>
		</div>
		<div class="con_body financial faq">
			<h4 class="mb0"><img src="../inc/img/txt/h4_financial_33.gif" alt="채용전형 FAQ" /></h4>
			<div class="box1 pt35">
				<div class="faq">
					<ul class="faq_list">
						...
						<li>
							...
							<span class="faq_list_tit">외국어 성적이 없으면 지원이 불가능합니까?</span>
							<div class="faq_a">
								<span class="faq_list_q"><img src="../inc/img/bbs/a.jpg" alt="답변" /></span>
								<span class="faq_list_tit">외국어 성적은 서류전형 시 참고 사항일 뿐입니다.</span>
							</div>
						</li>

						<li>
							<span class="faq_list_q"><img src="../inc/img/bbs/q.jpg" alt="질문" /></span>
							<span class="faq_list_tit">연봉 수준에 대해 알고 싶습니다.</span>
							<div class="faq_a">
								<span class="faq_list_q"><img src="../inc/img/bbs/a.jpg" alt="답변" /></span>
								<span class="faq_list_tit">지원자의 학력 및 경력, 전문성에 따라 처우는 달라지기 때문에 정확한 연봉 내역을 말씀드릴 수는 없지만, 저희 공평 저축은행은 업계 최상위 수준의 연봉을 제공하고 있습니다.</span>
							</div>
						</li>

						<li>
							<span class="faq_list_q"><img src="../inc/img/bbs/q.jpg" alt="질문" /></span>
							<span class="faq_list_tit">제출서류는 언제 제출해야 합니까?</span>
							<div class="faq_a">
								<span class="faq_list_q"><img src="../inc/img/bbs/a.jpg" alt="답변" /></span>
								<span class="faq_list_tit">서류전형 통과 후, 추후 통보된 날짜에 제출하시면 됩니다. 다만, 이메일로 지원하실 경우, 당사 양식의 입사지원서 외 제출서류는 첨부하지 않으셔도 됩니다. 
</span>
							</div>
						</li>
						...
						<li>
							<span class="faq_list_q"><img src="../inc/img/bbs/q.jpg" alt="질문" /></span>
							<span class="faq_list_tit">[신입사원] 모집공고에 명시된 전공자만 지원이 가능합니까?</span>
							<div class="faq_a">
								<span class="faq_list_q"><img src="../inc/img/bbs/a.jpg" alt="답변" /></span>
								<span class="faq_list_tit">명시된 전공분야와 유사 관련 전공자도 지원이 가능합니다.</span>
							</div>
						</li>

						<li>
							<span class="faq_list_q"><img src="../inc/img/bbs/q.jpg" alt="질문" /></span>
							<span class="faq_list_tit">합격 여부에 대한 통보는 어떻게 이루어 집니까?</span>
							<div class="faq_a">
								<span class="faq_list_q"><img src="../inc/img/bbs/a.jpg" alt="답변" /></span>
								<span class="faq_list_tit">서류전형 결과는 합격한 분에 한하여 유선으로 연락을 드리고, 면접 전형 결과는 응시자 전원에게 유선이나 SMS로 통보해 드립니다.
</span>
							</div>
						</li>
				...
				<form method="post" id="frmPaging" action="notice.jsp">
