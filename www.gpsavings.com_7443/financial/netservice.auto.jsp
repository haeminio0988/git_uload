...
<![endif]-->
<title>공평저축은행 - 온라인서비스 이용안내</title>
...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/financial/netservice.new.jsp">신규계좌개설안내</a></li>
				<li><a href="/financial/netservice.deposit.jsp">입금안내/사고신고</a></li>
				<li><a href="/financial/netservice.auto.jsp">자동화기기이용안내</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_financial_deposit.gif" alt="" /></h2>
			
			 			
				<div class="tab_menu2">
					<ul>
						<li ><a href="/financial/netinfo.netbk.jsp">인터넷뱅킹안내</a></li>
						<li class="on"><a href="/financial/netservice.new.jsp">온라인이용안내</a></li>
			...
			<div class="navi">홈 &gt; 금융도우미 &gt; 온라인서비스 이용안내 &gt; <span>자동화기기 이용안내</span></div>
		</div>
		<div class="con_body financial auto">
			<div class="box1">
            <h4><img src="../inc/img/txt/h4_financial_auto.gif" alt="자동화기기 이용안내" /></h4>
			<!--h5><img src="../inc/img/txt/h5_financial_auto_1.gif" alt="자동화기기 이용안내" /></h5-->
			<p>
				저희 공평저축은행에서 발급받으신 현금카드(IC카드)는 시중은행을 포함하여 금융결제원 CD공동망 서비스에 가입된 모든 현금자동입출금기(CD기, ATM기)에서 인출, 조회 등의 금융서비스를 이용하실 수 있습니다. (단, 고객부담 이용수수료가 발생하며 자동화기기에 따라 일부 업무는 제한될 수 있습니다.)
			</p>
			<p class="auto_text"><img src="../inc/img/img/bg_financial_auto_2.jpg" alt="금융결제원CD공동망서비스" /></p>
			<!--p>
				기존 국민은행 연체카드의 인출가능시간은 <strong>평일 및 토요일에 08:30 ~ 23:00 까지 (연중무휴)입니다.</strong><br />
				기존 연계카드를 가지고 계신 분은 당사현금카드로 교체하시면<strong> 08:00 ~ 23:00 (연중무휴)</strong>까지 서비스를 받으실 수 있습니다.
			</p-->
			<h4><img src="../inc/img/txt/h4_financial_auto_2.gif" alt="자동화기기 이용한도 축소안내" /></h4>
			<p>전자금융 이용한도 변경’에 의해 CD공동 업무 현금지급 한도가 아래와 같이 변경되오니CD/ATM 이용시 참고하시기 바랍니다.</p>
			<h4><img src="../inc/img/txt/h4_financial_auto_3.gif" alt="전자금융감독규정 변경내용" /></h4>
			<div class="tables">
				<table summary="전자금융감독규정 변경내용">
					<thead class="theads">
					<tr>
						<th colspan="2"></th>
						<th>변경전</th>
					...
					<tbody class="tbodys">
					<tr>
						<td rowspan="2">인출한도</td>
						<td class="left_line">1회</td>
						<td class="left_line2">70만원</td>
						<td>100만원</td>
					</tr>
					<tr>
						<td class="left_line">1일</td>
						<td class="left_line2">600만원</td>
						<td>600만원</td>
					</tr>
					<tr>
						<td rowspan="2">이체한도</td>
						<td class="left_line">1회</td>
						<td class="left_line2">600만원</td>
						<td>600만원</td>
					</tr>
					<tr>
						<td class="left_line">1일</td>
						<td class="left_line2">3,000만원</td>
						<td>3,000만원</td>
					</tr>
					</tbody>
				</table>
			...
			<p class="tip">
				금융기관 또는 전자금융업자와 이용자간에 별도의 계약이 있는 경우에는 그 이용한도를 달리 정할 수 있음. <br />(전자금융거래법시행령 제13조 2항)<br />
				<strong>최근 1년간 CD/ATM을 이용한 계좌이체 실적이 없는 고객의 이체한도는 70만원으로 하향 조정. (중앙회 경영 제257호)</strong>
			</p>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
