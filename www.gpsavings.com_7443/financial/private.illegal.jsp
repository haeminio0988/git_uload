...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 금융도우미 &gt; 개인정보처리방침 &gt; <span>부당대출모집 주의안내</span></div>
		</div>
		<div class="con_body financial illegal">
			<div class="box1">
				<h4><img src="../inc/img/txt/financial/h4_financial_35.gif" alt="부당대출모집 주의안내"/></h4>
				<p><img src="../inc/img/txt/financial/p_financial_35.gif" alt=""/></p>
				<p class="hiding">
				최근 일부 대출모집인들이 금융기관을 사칭하거나 허위 과장광고를 하는 사례가 발생하여 거래자의 피해가 우려되오니, 각별한 주의를 부탁드리며, 아래대상이 발생할 경우 저축은행중앙회 “부당 대출모집행위 신고센터”로 신고하여 주시기 바랍니다.
				</p>
				<img class="txt_report" src="../inc/img/txt/financial/txt_report.gif" alt="신고대상행위"/>
				<div class="desciption">
					<ul class="dot">
						<li><strong>금융기관 명의를 도용한 불법적인 무단광고</strong></li>
						<li><strong>해당금융기관 외에 대부업자 등 제3의 대출기관과 연계하여 후순위 대출을 광고 또는 중개하는 행위</strong></li>
						<li><strong>사업자 대출을 내세운 허위 과장광고</strong></li>
						<li><strong>금융기관의 승인을 받지 않은 무단 광고전단지 배포</strong></li>
						<li><strong>금융기관 지점 또는 직원으로 오해 소지가 있는 명칭 사용</strong></li>
						<li><strong>고객으로부터 별도 수수료 징수</strong></li>
					</ul>
				</div>
				<img class="txt_reportway" src="../inc/img/txt/financial/txt_reportway.gif" alt="신고방법"/>
				<div class="tables type2">
					<table>
						...
						<tbody class="tbodys">
							<tr>
								<th class="ta_l pl15">인터넷</th>
								<td class="moreline">저축은행중앙회 홈페이지 신고센터 (http://fsb.or.kr)</td>
							</tr>
							<tr>
								<th class="ta_l pl15">전화</th>
								<td>02-397-8636</td>
							</tr>
							<tr>
								<th class="ta_l pl15">FAX</th>
								<td>02-397-8670</td>
							</tr>
							<tr>
								<th class="ta_l pl15">우편</th>
								<td>서울 종로구 도렴동 60 도렴빌딩 10층 저축은행중앙회 경영지원부<br/>(우편번호 : 110-716)</td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="private_btn">
					<a href="http://www.fsb.or.kr/2009/06_customer/statement.asp" target="_blank"><img src="../inc/img/img/financial/img_financial_private_btn.gif" alt="부당 대출모집행위 신고하기"></a>
				</div>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
