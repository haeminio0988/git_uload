...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 금융도우미 &gt; 인터넷뱅킹안내 &gt; <span>신규가입안내</span></div>
		</div>
		<div class="con_body financial netbk">
			<div class="box1">
				<h3><img src="../inc/img/txt/h3_financial_1.gif" alt="신규가입안내" /></h3>
				<p><img src="../inc/img/img/financial_member_info.gif" alt="영업점에서 인터넷가입,공평저축은행홈페이지접속,
				인터넷뱅킹신규가입클릭후약관동의,영업점에서가입하신아이디주민번호를입력,이용자비밀번호등록" /></p>
				<div class="banking">
					<dl>
						<dt><img src="../inc/img/txt/dt_financial_1.gif" alt="인터넷뱅킹가입절차" /></dt>
						<dd><strong>통장이 없는 경우</strong> 영업점에서 통장개설 ( 신분증, 도장지참)</dd>
						<dd><strong>통장이 있는 경우</strong> 통장을 지참하여 영업점 방문 후 인터넷뱅킹 신청</dd>
					</dl>
					<dl>
						<dt><img src="../inc/img/txt/dt_financial_2.gif" alt="영업점방문시준비물" /></dt>
						<dd>
							신분증, 통장, 거래인감 또는 서명 <br />
							(미성년자도 신청 가능하며, 본인 이외에 대리 신청은 불가능합니다.)
						</dd>
					</dl>
					<p class="tip">영업점에서 인터넷뱅킹에 가입 후 3일 안에 인터넷상에서 신규가입 하셔야 합니다.</p>
				</div>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
