...
<![endif]-->
<title>공평저축은행 - 개인신용정보처리방침1</title>
...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/financial/private.credit.jsp">개인정보처리(취급)방침</a></li>
				<li><a href="/financial/private.trust.jsp">위탁업체현황</a></li>
				<li><a href="/financial/private.illegal.jsp">부당대출모집 주의안내</a></li>
				<li><a href="/financial/private.cctv.jsp">영상정보처리기기 운영관리방침</a></li>

			</ul>
			<h2><img src="../inc/img/txt/financial/h2_financial_31.gif" alt="개인정보처리방침" /></h2>
				...
				<div class="tab_menu2">
					<ul>
						...
						<li class="on"><a href="/financial/private.credit.jsp">개인정보<br>처리방침</a></li>
						...
						<li ><a href="/financial/termslib.jsp">각종약관</a></li>
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 금융도우미 &gt; 개인정보처리방침 &gt; <span> 개인정보처리(취급)방침</span></div>
		</div>
		<div class="financial private credit">
			<div class="box1">
				<h4><img src="../inc/img/img/private/title01.png" alt="개인정보처리(취급)방침"/></h4>
				<h6>&nbsp;</h6>
				
							<div class="tab_menu_sub">
				<ul>
					
					<li ><a href="/financial/private.credit.jsp">2015년1월9일 개정</a></li>
					<li class="on"><a href="/financial/private.credit_20131209.jsp">2013년12월9일 개정</a></li>
										
				</ul>
			</div>
				<h5>개인정보처리(취급)방침</h5>
				<p>공평저축은행은 「개인정보보호법」 제30조, 「정보통신망 이용촉진 및 정보보호에 관한 법률」 제27조의2에 따라 고객의 개인정보 보호 및 권익을 보호하고, 개인정보와 관련한 고객의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.</p>
				<h6>제1조 (개인정보의 처리 목적)</h6>
				<p>공평저축은행은 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 목적 외의 용도로는 사용되지 않으며, 이용 목적이 변경될 시에는 사전 동의를 구할 예정입니다.</p>
				<dl>
					<dt>1. (금융)거래 관계 관련</dt>
					<dd> (금융)거래와 관련하여 신용조회회사 또는 신용정보집중기관에 대한 개인신용정보의 조회, (금융)거래 관계의 설정 여부의 판단, (금융)거래 관계의 설정·유지·이행·관리, 금융사고 조사, 분쟁 해결, 민원 처리 및 법령상 의무이행 등의 목적으로 개인정보를 처리합니다.</dd>
					<dt>2. 상품 및 서비스 홍보 및 판매 권유</dt>
					<dd>고객 만족도 조사를 통한 신규 서비스 개발 및 맞춤 서비스 제공, 인구통계학적 특성에 따른 서비스 제공 및 광고의 게재, 서비스의 유효성 확인, 경품지급, 사은행사 등 고객의 편의 및 참여기회 제공, 접속빈도 파악, 회원의 서비스 이용에 대한 통계 등의 목적으로 개인정보를 처리합니다.</dd>
					<dt>3. 회원 가입 및 관리</dt>
					<dd> 회원가입, 회원제 서비스 이용, 제한적 본인 확인제에 따른 본인확인, 개인식별, 부정이용방지, 비인가 사용방지, 가입의사 확인, 만14세 미만 아동 개인정보 수집 시 법정대리인 동의여부 확인, 추후 법정 대리인 본인확인, 사고조사, 분쟁해결, 민원처리 및 고지사항 전달 등의 목적으로 개인정보를 처리합니다.</dd>
					<dt>4. 온라인 거래 관련 목적</dt>
					<dd>전자금융거래법 제21조(안전성의 확보의무), 제22조(전자금융거래기록의 생성 및 보존)에 의해 전자금융거래의 내용 추적 및 검색, 보안 정책 수립용 통계자료로 활용 등을 목적으로 개인정보를 처리합니다. </dd>
				</dl>
				<h6>제2조 (개인정보의 처리 및 보유 기간)</h6>
				<p>① (금융)거래와 관련한 개인(신용)정보는 수집·이용에 관한 동의일로부터 (금융)거래 종료일까지 제1조의 이용목적을 위하여 보유·이용됩니다. 단, (금융)거래 종료일 이후에는 금융사고 조사, 분쟁 해결, 민원처리, 법령상 의무이행 및 공평저축은행의 리스크 관리 업무만을 위하여 보유·이용됩니다.</p>
				<p>② 개인(신용)정보의 조회를 목적으로 수집된 개인(신용)정보는 수집·이용에 대한 동의일로부터 고객에 대한 신용정보 제공·조회 동의의 효력 기간까지 보유·이용됩니다. 단, 개인(신용)정보 제공·조회 동의의 효력 기간 종료 후에는 금융사고 조사, 분쟁해결, 민원처리 및 법령상 의무이행만을 위하여 보유·이용됩니다.</p>
				<p>③ 상품 및 서비스 홍보 및 판매 권유 등과 관련한 개인(신용)정보는 수집·이용에 관한 동의일로부터 동의 철회일까지 보유·이용됩니다. 단, 동의 철회일 후에는 제1조의 목적과 관련된 사고 조사, 분쟁 해결, 민원처리, 법령상 의무이행만을 위하여 보유·이용됩니다.</p>
				<p>④ 회원 가입 및 관리 목적으로 수집된 개인(신용)정보는 고객의 회원 가입일로부터 회원 탈퇴일까지 보유·이용됩니다. 단, 회원 탈퇴일 후에는 제1조의 목적과 관련된 사고 조사, 분쟁 해결, 민원처리, 법령상 의무이행만을 위하여 보유·이용됩니다.</p>
				<p>⑤ 온라인 거래 관련한 개인(신용)정보는 전자금융거래법 시행령 제12조(거래기록의 보존기간 및 방법 등)에서 정하는 기간까지 보유·이용됩니다.</p>
				<h6>제3조 (개인정보의 제3자 제공)</h6>
				<p>① 공평저축은행은 원칙적으로 고객의 개인정보를 제1조에서 명시한 목적 범위 내에서 처리하며, 고객의 사전 동의 없이는 본래의 범위를 초과하여 처리하거나 제3자에게 제공하지 않습니다. 단, 다음의 각 호의 경우에는 고객 또는 제3자의 이익을 부당하게 침해할 우려가 있을 때를 제외하고는 개인정보를 목적 외의 용도로 이용하거나 이를 제3자에게 제공할 수 있습니다.</p>
				<ol>
				...
				<P>② 공평저축은행은 다음 각 호와 같이 개인정보를 제공하고 있습니다.</P>
				<dl>
					<dt>1. 제공받는 자 </dt>
					<dd>가. 신용정보집중기관 및 신용조회회사에 대한 제공</dd>
					<dd>- 신용정보집중기관[전국은행연합회 등]</dd>
					<dd>- 신용조회회사[코리아크레딧뷰로(주), NICE평가정보(주) 등]</dd>
					
					<dd>나. 제휴업체</dd>
					<dd>- 공평저축은행과 정식으로 업무제휴계약을 체결한 업체</dd>
				</dl>
				<dl>
					<dt>2. 제공받는 자의 이용 목적</dt>
					<dd>가. 신용정보집중기관 및 신용조회회사에 대한 제공</dd>
					<dd>- 본인의 신용을 판단하기 위한 자료로 활용하거나 공공기관에서 정책 자료로 활용</dd>
					<dd>나. 제휴업체에 대한 제공</dd>
					<dd>- 제휴 상품·서비스의 홍보 및 판매 권유와 채권관리 및 추심을 위한 자료로 활용</dd>
				</dl>
				<dl>
					<dt>3. 개인정보 제공항목 </dt>
					<dd>가. 신용정보집중기관 및 신용조회회사에 대한 제공</dd>
					<dd>- 개인식별정보, 신용거래정보, 신용능력정보, 신용평가를 위한 정보</dd>
					<dd>나. 제휴업체에 대한 제공</dd>
					<dd>- 개인식별정보, (금융)거래 정보, 거래신청서에 기재된 개인식별정보 외의 정보 또는 고객이 제공한 정보(주거 및 가족사항, 거주기간, 세대구성, 결혼여부 등)</dd>
					<dd>※ 본 동의 이전에 수집된 개인(신용)정보도 포함됩니다.</dd>
				</dl>
				<dl>
					<dt>4. 개인정보 보유 기간</dt>
					<dd>개인(신용)정보는 제공된 날로부터 동의를 철회할 때까지 또는 제공된 목적을 달성할 때까지 보유·이용됩니다. 동의 철회 또는 제공된 목적 달성 후에는 위에 기재된 이용목적과 관련된 금융사고 조사, 분쟁 해결, 민원처리, 법령상 의무이행을 위하여 필요한 범위 내에서만 보유·이용됩니다.</dd>
				</dl>
				<h6>제4조 (개인정보처리 위탁)</h6>
				<p>① 공평저축은행은 고객의 동의를 받아 다음 각 호와 같이 개인정보의 처리를 위탁하고 있습니다.</p>
				<dl>
					<dt>1. 수탁업체</dt>
					<dd>가. 상품 및 서비스 홍보, 판매 권유를 위한 마케팅 업체 [(주)MPC등 홈페이지 위수탁 업체 현황 참조] </dd>
					<dt><a href="/financial/private.trust.jsp">   - <bold><u>위탁업체현황</bold></u></a></br></dt>
					<dd>나. 사은행사 관련 이벤트 업체</dd>
					<dd>다. 고객 만족도 조사를 위한 리서치 업체</dd>
					<dd>라. 전산시스템 운영, 유지보수 업체</dd>
					<dd>마. 채권 가치평가 업체</dd>

				</dl>
				<dl>
					<dt>2. 수탁의 목적</dt>
					<dd>가. (금융)거래의 설정·유지·이행·관리 등에 필요한 경우로서 위탁받은 업무의 수행</dd>
					<dd>나. 상품 및 서비스 홍보 및 판매 권유, 사은행사, 고객 만족도 조사 등에 필요한 경우로서 위탁받은 업무의 수행</dd>
				</dl>
				<dl>
					<dt>3. 개인정보 제공항목</dt>
					<dd>가. 개인식별정보: 성명, 주민등록번호 등 고유식별정보, 국적, 직업, 주소·전자우편 주소·전화번호 등 연락처</dd>
					<dd>나. (금융)거래정보: 상품종류, 거래조건(이자율, 만기, 담보 등), 거래일시 금액등 거래 설정 및 내역 정보</dd>
					<dd>다. 개인식별정보 외에 거래신청서에 기재된 정보 또는 고객이 제공한 정보</dd>
					<dd>※  본 동의 이전에 수집된 개인(신용)정보도 포함됩니다.</dd>
				</dl>
				<p>② 위탁계약 시 개인정보보호 관련 법규의 준수, 개인정보에 관한 제3자 제공금지 및 책임부담 등을 명확히 규정하고, 당해 계약내용을 서면 및 전자 보관하고 있습니다. 업체 변경 시에는 공지사항 및 개인정보처리방침을 통해 고지하겠습니다.</p>
				<h6>제5조 (고객의 권리,의무 및 그 행사 방법)</h6>
				<p>① 고객은 공평저축은행이 처리하는 자신 및 14세 미만 아동(법정대리인만 해당)의 개인정보의 열람을 요구할 수 있습니다.</p>
				<p>② 자신의 개인정보를 열람한 고객은 사실과 다르거나 확인할 수 없는 개인정보에 대하여 공평저축은행에 정정 또는 삭제를 요구할 수 있습니다. 다만, 다른 법령에서 그 개인정보가 수집 대상으로 명시되어 있는 경우에는 그 삭제를 요구할 수 없습니다. </p>
				<p>③ 고객은 공평저축은행에 대하여 자신의 개인정보 처리의 정지를 요구할 수 있습니다. 다만, 다음 각 호의 어느 하나에 해당하는 경우에는 공평저축은행은 해당 사유를 고객에게 알리고, 처리정지 요구를 거절할 수 있습니다. </p>
				<ol>
				...
				<h6>제6조 (처리하는 개인정보의 항목)</h6>
				<p>공평저축은행은 (금융)거래의 설정·유지·이행·관리 및 상품서비스의 제공을 위한 필수정보 및 선택정보를 다음 각 호와 같이 수집하고 있습니다.</p>
				<dl>
					<dt>1. 필수적 정보</dt>
					<dd>가. 개인식별정보: 성명, 주민등록번호 등 고유식별정보, 국적, 직업, 주소·전자우편 주소·전화번호 등 연락처</dd>
					<dd>나. (금융)거래정보: 상품종류, 거래조건(이자율, 만기, 담보 등), 거래일시, 금액 등 거래 설정 및 내역 정보</dd>
					<dd>다. 신용평가를 위한 정보(여신거래에 한함)</dd>
					<dd>- 신용능력정보: 재산·채무·소득의 총액, 납세실적</dd>
					<dd>- 신용도판단정보: 연체, 대위변제, 대지급, 부도, 관련인 발생사실 등</dd>
					<dd>라. 기타 금융거래의 설정·유지·이행·관리를 위한 상담, 채권관리 등을 통해 생성되는 정보</dd>
				</dl>
				<dl>
					<dt>2. 선택적 정보</dt>
					<dd>가. 개인식별정보 외에 거래신청서에 기재된 정보 또는 고객이 제공한 정보</dd>
				</dl>
				<dl>
					<dt>3. 전자금융거래법에 따른 수집 정보(온라인 거래에 한함)</dt>
					<dd>가. 고객 아이디, 접속 일시, IP Address, HDD Serial, MAC Address, 개인방화벽 설정, 운영체제 종류, 브라우저 버전 등</dd>
					<dd>※ 공평저축은행은 고객의 사생활을 침해할 우려가 있는 민감정보에 대해서는 원칙적으로 수집하지 않으며, 필요한 경우 고객의 별도 동의를 받아 수집하고 동의 목적을 위해서만 제한적으로 이용합니다. </dd>
				</dl>
				<dl>
					<dt>4. 수집방법</dt>
					<dd>가. 공평저축은행 영업점에 내방한 고객으로부터 직접 수집</dd>
					<dd>나. 홈페이지, 서면양식, 팩스, 전화, 상담 게시판, 이메일, 응모내역, 배송요청</dd>
					<dd>다. 고객센터의 문의사항을 통한 수집</dd>
				</dl>
				<h6>제7조 (개인정보의 파기)</h6>
				<p>① 공평저축은행은 개인정보의 보유기간이 경과된 경우에는 다음 각 호의 사유가 없는 한 보유기간의 종료일로부터 5영업일 이내에, 개인정보의 처리 목적 달성, 해당 서비스의 폐지, 사업의 종료 등 그 개인정보가 불필요하게 되었을 때에는 다음 각 호의 사유가 없는 한 개인정보의 처리가 불필요한 것으로 인정되는 날로부터 5영업일 이내에 그 개인정보를 파기합니다.</p>
				<ol>
					<li>1. 신용정보집중기관 또는 신용조회회사가 신용정보의 집중관리·활용 또는 개인의 신용도 등을 평가하기 위한 목적으로 개인신용정보를 보유하는 경우(보유기간에 한함)</li>
					<li> 2. 신용정보회사 등이 민·형사상의 책임 또는 시효가 지속되거나 분쟁의 입증자료로서 개인신용정보를 보유하는 경우</li>
					<li>3. 상법 제33조 등 법령에 따라 보존하여야 하는 경우</li>
					<li> 4. 기타 이와 유사한 정당한 사유가 있는 경우</li>
				</ol>
				<p>② 개인정보가 기록된 출력물, 서면 등은 파쇄 또는 소각의 방법으로 파기하고, 전자적 파일형태의 개인정보는 복원이 불가능한 방법으로 영구 삭제하는 방법으로 파기합니다.</p>
				<h6>제8조 (개인정보의 안전성 확보 조치)</h6>
				<p>공평저축은행은 개인정보보호법 제29조(안전조치의무)에 따라 다음 각 호와 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.</p>
				<dl>
					<dd>1. 비밀번호의 암호화</dd>
					<dd>고객의 비밀번호는 암호화 되어 저장 및 관리되고 있어, 본인만이 알 수 있으며, 중요한 데이터는 파일 및 전송 데이터를 암호화 하거나 파일 잠금기능을 사용하는 등의 별도 보안기능을 사용하고 있습니다.</dd>
				</dl>
				<dl>
					<dd>2. 해킹 등에 대비한 기술적 대책</dd>

					<dd>공평저축은행은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며, 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고  
       있습니다.</dd>
				</dl>
				<dl>
					<dd>3. 개인정보처리시스템 접근 제한</dd>
				...
				<dl>
					<dd>4. 개인정보 취급 직원의 최소화 및 교육</dd>
					<dd>개인정보를 취급하는 직원을 지정하고 담당자에 한정시켜 최소화 하여 개인정보를 관리하는 대책을 시행하고 있습니다.</dd>
				</dl>
				<h6>제9조 (개인정보 처리방침의 변경)</h6>
				<p>공평저축은행이 개인정보 처리방침을 변경하는 경우에는 변경 및 시행의 시기, 변경된 내용을 지속적으로 공개하며, 변경된 내용은 고객이 쉽게 확인할 수 있도록 변경 전·후를 비교하여 공개합니다. </p>
				<h6>제10조 (권익침해 구제방법) </h6>
				<p>고객은 개인정보침해로 인한 신고나 상담이 필요하신 경우 아래 기관에 문의하실 수 있습니다.</p>
				<ol style="color: #71635a;">
					<li>1. 개인정보분쟁조정위원회(www.kopico.or.kr/02-405-4710)</li>
					<li>2. 한국인터넷진흥원 개인정보침해신고센터(www.1336.or.kr/02-405-5118)</li>
				...
				<p>공평저축은행은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 고객의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.</p>
				<dl style="color: #71635a;">
					<dt>[ 개인정보 보호책임자 ]</dt>
					<dd>소속/직책 : 경영기획본부장</dd>
					<dd>성명 : 이명수</dd>
					<dd>전화번호/FAX : 031-698-8105/ 031-698-8113</dd>
				</dl>
				<p>
					<span>* 개인정보 처리방침 변경공고일자: 2013. 12. 09.</span>
					<span>* 개인정보 처리방침 시행일자: 2011. 09. 30.</span>
				</p>
				</div><!-- box1 -->
		</div><!-- saving -->
	</div>
