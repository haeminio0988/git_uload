...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/financial/terms.loan.jsp">여신거래 기본약관</a></li>
				<li><a href="/financial/terms.saving.jsp">예금거래 기본약관</a></li>
				<li><a href="/financial/term.eft.jsp">전자금융거래 기본약관</a></li>
				<li><a href="/financial/term.work.jsp">재형저축특약</a></li>
			</ul>
			<h2><img src="../inc/img/txt/financial/h2_financial_63.gif" alt="각종약관" /></h2>
			
			 			
				<div class="tab_menu2">
					<ul>
						<li ><a href="/financial/netinfo.netbk.jsp">인터넷뱅킹안내</a></li>
						<li ><a href="/financial/netservice.new.jsp">온라인이용안내</a></li>
						<li ><a href="/financial/private.credit.jsp">개인정보<br>처리방침</a></li>
						<li ><a href="/financial/private.protection.jsp">개인신용<br>처리방침</a></li>
						<li ><a href="/financial/formlib.jsp">서식자료</a></li>
						<li ><a href="/financial/commission.saving.jsp">수수료안내</a></li>

						<li class="on"><a href="/financial/termslib.jsp">각종약관</a></li>
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 금융도우미 &gt; 각종 약관 &gt; <span>재형저축특약</span></div>
		</div>
		<div class="con_body financial work">
			<div class="box1">
				<h4><img src="../inc/img/txt/financial/h4_financial_64.gif" alt="재형저축특약"></h4>
				<h6>&nbsp;</h6>
				
							<div class="tab_menu_sub">
				<ul>
					
					<li ><a href="/financial/term.work.jsp">2015년1월1일 개정</a></li>
					<li class="on"><a href="/financial/term.work_20130314.jsp">2013년3월14일 개정</a></li>
										
				</ul>
			</div>
				<div class="term">
					<ul>
						<li><a href="#제1조"><img src="../inc/img/txt/financial/li_financial.term.work_01.gif" alt="제1조 약관의 적용"></a></li>
						<li><a href="#제2조"><img src="../inc/img/txt/financial/li_financial.term.work_02.gif" alt="제2조 예금과목"></a></li>
						<li><a href="#제3조"><img src="../inc/img/txt/financial/li_financial.term.work_03.gif" alt="제3조 가입대상"></a></li>
						<li><a href="#제4조"><img src="../inc/img/txt/financial/li_financial.term.work_04.gif" alt="제4조 저축방법 및 가입한도"></a></li>
						<li><a href="#제5조"><img src="../inc/img/txt/financial/li_financial.term.work_05.gif" alt="제5조 계약기간"></a></li>
					</ul>
					<ul>
						<li><a href="#제6조"><img src="../inc/img/txt/financial/li_financial.term.work_06.gif" alt="제6조 세율의 적용"></a></li>
						<li><a href="#제7조"><img src="../inc/img/txt/financial/li_financial.term.work_07.gif" alt="제7조 중도해지와 세율의 적용"></a></li>
						<li><a href="#제8조"><img src="../inc/img/txt/financial/li_financial.term.work_08.gif" alt="제8조 가입자격의 검증"></a></li>
						<li><a href="#제9조"><img src="../inc/img/txt/financial/li_financial.term.work_09.gif" alt="제9조 가입자격 부적격 판정 통보 및 의견제시"></a></li>
						<li><a href="#제10조"><img src="../inc/img/txt/financial/li_financial.term.work_10.gif" alt="제10조 제한사항"></a></li>
					</ul>
					<ul>
						<li><a href="#제11조"><img src="../inc/img/txt/financial/li_financial.term.work_11.gif" alt="제11조 이자율의 적용"></a></li>
						<li><a href="#제12조"><img src="../inc/img/txt/financial/li_financial.term.work_12.gif" alt="제12조 중도해지이자율 및 만기후이자율"></a></li>
					</ul>
				</div>		
				<div class="work_box" id="제1조">
					<h6>제1조 약관의 적용</h6>
					<p>이 특약은 고객과 ㈜공평저축은행(이하 "저축은행"이라고 한다)과의 「공평재형저축」(이하 "이 예금"이라고 한다) 거래에 적용하며, 이 특약에서 정하지 않은 사항은 조세특례제한법령, 예금거래기본약관 및 적립식예금약관을 적용합니다.</p>
				</div>
				<div class="work_box" id="제2조">
					<h6>제2조 예금과목</h6>
					<p>이 예금은 적립식예금으로만 가입할 수 있습니다.</p>
				</div>
				<div class="work_box" id="제3조">
					<h6>제3조 가입대상</h6>
					<p>이 예금의 가입대상은 가입일 현재 직전 과세기간에 근로소득 또는 사업소득이 있는 소득세법상 거주자로서 다음 각 호의 어느 하나에 해당하여야 합니다.</p>
					<ol>
						<li><strong>01.</strong><span>직전 과세기간의 총급여액이 5천만원 이하인 고객으로서 직전 과세기간에 근로소득만 있거나 근로소득 및 종합소득과세표준에 합산되지 않는 종합소득이 있는 경우로 한정합니다.</span></li>
						<li><strong>02.</strong><span>제1호에 해당하지 않는 고객으로서 직전 과세기간의 종합소득과세표준에 합산되는 종합소득금액이 3천500만원 이하인 고객.</span></li>
					</ol>
				</div>
				<div class="work_box" id="제4조">
					<h6>제4조 저축방법 및 가입한도</h6>
					<ol>
						<li><strong>01.</strong><span>이 예금은 분기 300만원을 초과하지 않는 범위내에서 1만원 단위로 자유롭게 저축할 수 있습니다.<br />
						단, 가입한도는 모든 금융기관에 공통으로 적용되는 한도입니다.</span></li>
						<li><strong>02.</strong><span>저축은행은 세금우대저축한도집중기관을 통하여 고객의 저축가입 가능한도를 조회·확인할 수 있습니다.</span></li>
					</ol>
				</div>
				<div class="work_box" id="제5조">
					<h6>제5조 계약기간</h6>
					<ol>
						<li><strong>01.</strong><span>이 예금의 계약기간은 7년으로 합니다.</span></li>
						<li><strong>02.</strong><span>만기일 1영업일 이전까지 신청하는 경우 1회에 한하여 3년 이내의 범위에서 1년 단위로 연장할 수 있습니다.</span></li>
					</ol>
				</div>
				<div class="work_box" id="제6조">
					<h6>제6조 세율의 적용</h6>
					<ol>
						<li><strong>01.</strong><span>이 예금에서 발생하는 이자소득에 대해서는 소득세가 부과되지 않습니다.<br />
						다만 다음 각 호의 경우 소득세가 부과될 수 있습니다.
							<ol>
								<li><strong>a.</strong><span>이 약관 제3조 각 호의 가입자격, 제4조 제1항의 분기 가입한도, 제5조의 계약기간, 제8조 제1항의 소득확인증명서 제출 조건을 충족하지 못하는 경우 이 예금에서 발생하는 이자 전액에 대해서는 소득세가 부과됩니다.</span></li>
								<li><strong>b.</strong><span>이 예금의 만기일 이후 발생하는 이자에 대해서는 소득세가 부과됩니다.</span></li>
							</ol></span>
						</li>
						<li><strong>02.</strong><span>위 제1항에 따라 이자소득세가 부과되지 않는 경우 감면된 세금의 10%가 농어촌특별세로 부과됩니다.</span></li>
					</ol>
				</div>
				<div class="work_box" id="제7조">
					<h6>제7조 중도해지와 세율의 적용</h6>
					<ol>
						<li><strong>01.</strong><span>이 예금을 계약기간의 만료일(이 약관 제5조 제2항에 따라 계약기간을 연장한 경우는 그 연장한 계약기간의 만료일) 이전에 해지하는 경우 이 예금에서 발생하는 이자소득에 대하여 소득세가 부과됩니다.</span></li>
						<li><strong>02.</strong><span>위 제1항에도 불구하고 저축자의 사망, 해외이주 또는 해지 전 6개월 이내에 발생한 다음 각 호의 사유에 해당하는 경우에는 조세특례제한법시행규칙이 정하는 특별해지사유신고서를 제출하고 특별해지 할 수 있습니다.<br />
						이 경우 이자소득에 대하여 소득세가 부과되지 않습니다.
							<ol>
								<li><strong>a.</strong><span>천재·지변</span></li>
								<li><strong>b.</strong><span>저축자의 퇴직</span></li>
								<li><strong>c.</strong><span>사업장의 폐업</span></li>
								<li><strong>d.</strong><span>저축자의 3월 이상의 입원치료 또는 요양을 요하는 상해·질병의 발생</span></li>
								<li><strong>e.</strong><span>저축취급기관의 영업의 정지, 영업인가·허가의 취소, 해산결의 또는 파산선고</span></li>
							</ol></span>
						</li>
					</ol>
				</div>
				<div class="work_box" id="제8조">
					<h6>제8조 가입자격의 검증</h6>
					<ol>
						<li><strong>01.</strong><span>이 예금에 가입하고자 하는 경우 고객은 세무서에서 발행하는 소득확인증명서를 저축은행에 제출하여야 합니다.</span></li>
						<li><strong>02.</strong><span>저축은행은 고객이 저축은행에 제출한 소득확인증명서에 기재된 내용이 제3조의 가입조건에 해당하는지 확인하여 가입 처리합니다.</span></li>
						<li><strong>03.</strong><span>위 제2항의 저축은행의 가입자격 확인에도 불구하고 국세청은 고객이 제3조의 가입조건에 해당하는지 검증하여 그 결과를 고객이 가입한 연도의 다음 연도 2월 말일까지 저축은행에 통보합니다.</span></li>
						<li><strong>04.</strong><span>국세청에서 실시하는 검증절차에서 부적격으로 판정되어 저축은행에 그 사실이 통보된 경우 그 통보된 날을 기준으로 이 예금은 해지된 것으로 보아 추가 입금과 이자의 제공이 중단됩니다.</span></li>
						<li><strong>05.</strong><span>부적격자로 판정되어 이 예금을 해지하는 경우 저축은행에 그 사실이 통보된 날의 전일까지 발생한 이자소득에 대하여서는 소득세를 부과하지 않으며, 중도해지이자율을 적용하는 제12조에도 불구하고 제11조에서 정한 이자율을 적용합니다.</span></li>
					</ol>
				</div>
				<div class="work_box" id="제9조">
					<h6>제9조 가입자격 부적격 판정 통보 및 의견제시</h6>
					<ol>
						<li><strong>01.</strong><span>저축은행은 국세청으로부터 고객이 이 예금에 대한 가입 자격이 부적격 하다고 통보를 받을 경우 이를 받은 날로부터 14일 이내에 고객에게 우편과 휴대전화 단문자(또는 전자우편)의 방법으로 알립니다.</span></li>
						<li><strong>02.</strong><span>고객은 국세청으로부터 통보받은 내용에 이의가 있을 경우 저축은행이 통보받은 날로부터 2개월 이내에 납세지 관할 세무서장에게 의견서를 제출하고 그 사실을 저축은행에 알려야 합니다.</span></li>
						<li><strong>03.</strong><span>위 제2항에도 불구하고 고객의 사망, 해외장기출장 및 그 밖의 부득이한 사유가 있는 경우 그 사유가 끝난 날로부터 7일 이내에 납세지 관할 세무서장에게 의견서를 제출 할 수 있습니다.</span></li>
						<li><strong>04.</strong><span>국세청은 위 제2항과 제3항에 따라 고객으로부터 의견을 제시 받은 경우 이를 받은 날로부터 14일 이내에 저축은행에 그 수용 여부를 통보하며, 고객의 이의가 수용되어 가입자격이 적격으로 다시 판정되고 국세청이 이를 저축은행에 통보한 경우 저축은행은 제8조 제4항에 의거하여 중단된 입금이 다시 가능하도록 즉시 조치합니다.</span></li>
					</ol>
				</div>
				<div class="work_box" id="제10조">
					<h6>제10조 제한사항</h6>
					<ol>
						<li><strong>01.</strong><span>이 예금은 제3자에게 양도할 수 없습니다.</span></li>
						<li><strong>02.</strong><span>이 예금은 계좌분할 및 일부 해지 할 수 없습니다.</span></li>
						<li><strong>03.</strong><span>이 예금은 다른 상품으로 전환할 수 없습니다.</span></li>
						<li><strong>04.</strong><span>이 약관에도 불구하고 조세특례제한법 및 그 시행령, 시행규칙의 변경시 해당 법령에 따릅니다.<br />
						다만 저축은행은 그 변경 사항을 즉시 약관에 반영하고 이를 예금거래기본약관 제20조에서 정하는 게시 또는 공고하는 방법으로 고객에게 알립니다.</span></li>
					</ol>
				</div>
				<div class="work_box" id="제11조">
					<h6>제11조 이자율의 적용</h6>
					<ol>
						<li><strong>01.</strong><span>가입일 당일 및 이자율 변경일에 저축은행 영업점 및 홈페이지에 고시한 이자율을 적용하여 해지시 원금과 약정한 이자를 지급합니다.</span></li>
						<li><strong>02.</strong><span>제5조 제2항에 의거 계약기간이 연장된 경우 연장된 기간에 적용되는 이자율은 연장된 기간이 시작되는 날 저축은행 영업점 및 홈페이지에 고시된 이자율을 적용합니다.<br />
						다만, 이 예금의 가입기한이 종료되어 고시된 이자율이 없는 경우 연장된 계약기간을 초과하지 않는 가장 근접한 기간으로 공시한 정기예금의 이자율을 적용합니다.</span></li>
					</ol>
				</div>
				<div class="work_box" id="제12조">
					<h6>제12조 중도해지이자율 및 만기후이자율</h6>
					<ol>
						<li><strong>01.</strong><span>가입일 당일 저축은행 영업점 및 홈페이지에 고시한 중도해지이자율 및 만기후이자율을 적용하여 해지시 원금과 이자를 지급합니다.</span></li>
						<li><strong>02.</strong><span>제5조 제2항에 의거 계약기간이 연장된 경우에는 다음과 같이 중도해지이자율 및 만기후이자율을 적용합니다.<br />
						다만, 이 예금의 가입기한이 종료되어 고시된 이자율이 없는 경우 연장된 계약기간을 초과하지 않은 가장 근접한 기간의 정기예금의 중도해지이자율 및 만기후이자율을 적용합니다.
							<ol>
								<li><strong>a.</strong><span><strong>중도해지이자율 :</strong><span>최초가입시부터 7년이 되는 날까지는 제11조의 이자율을 적용하며, 연장후 중도해지하는 경우에 적용되는 중도해지이자율은 연장된 기간이 시작되는 날 저축은행 영업점 및 홈페이지에 고시된 이자율을 적용합니다.</span></span></li>
								<li><strong>b.</strong><span><strong>만기후이자율 :</strong><span>연장된 기간이 시작되는 날 저축은행 영업점 및 홈페이지에 고시된 만기후이자율을 적용합니다.</span></span></li>
							</ol></span>
						</li>
					</ol>
				</div>
