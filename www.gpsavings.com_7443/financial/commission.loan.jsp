...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 금융도우미 &gt; 수수료안내 &gt; <span>대출수수료</span></div>
		</div>
		<div class="con_body financial cmiss">
			<div class="box1">
				<h5><img src="../inc/img/txt/h5_loan_info431.gif" alt="대출업무 관련 수수료" /></h5>
				<div class="tables type1 mb20">
					<table>
						...
						<thead class="theads">
							<tr>
								<th colspan="2">구분</th>
								<th>수수료<span class="bar set10"></span></th>
								<th>비고<span class="bar set10"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
								<td colspan="2">부채잔액증명서</td>
								<td>10,000원/1부</td>
								<td></td>
							</tr>
							<tr>
								<td colspan="2">금융거래확인서</td>
								<td>10,000원/1부</td>
								<td></td>
							</tr>
							<tr>
								<td colspan="2" class="moreline">금융거래조회서 <br />(회계감사용)</td>
								<td>20,000원/1부</td>
								<td></td>
							</tr>
						</tbody>
				...
				<p class="notive"><i class="ico notice"></i> 대출 중도상환수수료는 대출상품에 따라 상이합니다.</p>
				<h5 class="mt20"><img src="../inc/img/txt/h5_loan_info432.gif" alt="대출 금액에 따른 인지세" /></h5>
				<div class="tables type1">
					<table>
						...
						<thead class="theads">
							<tr>
								<th>대출금액</th>
								<th>인지세<span class="bar set10"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
	            ...
	            <tr>
								<th>인지비용 부담</th>
                <td class="moreline" style="text-align:left">
									- &nbsp;대출금 5천만원 까지는 수입인지 비용이 없으며, 5천만원 초과시 대출 금액별로 수입인지 비용이 차등 부과<br/>
