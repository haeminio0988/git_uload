...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<h2><img src="../inc/img/txt/h2_financial_deposit.gif" alt="온라인서비스 이용안내" /></h2>
			...
			<div class="navi">홈 &gt; 금융도우미 &gt; 온라인서비스 이용안내 &gt; <span>입금안내/사고신고</span></div>
		</div>
		<div class="con_body financial deposit">
			<div class="box1">
            <h4><img src="../inc/img/txt/h4_financial_deposit.gif" alt="입금안내/사고신고" /></h4>
			<dl>
				<dd><img src="../inc/img/txt/h4_financial_deposit_1.gif" alt="입금안내" /></dd>
				<dd>시중은행 창구, 자동화기기(CD, ATM)를 통하여 고객님의 입출금계좌(보통예금, 종합통장)에 직접 입금할 수 있습니다. (단, 고객부담 이용수수료가 발생합니다.)</dd>
			</dl>
			<dl>
				<dd><img src="../inc/img/txt/h4_financial_deposit_2.gif" alt="입금절차" /></dd>
				<!--dd>아래의 두 가지 형태의 계좌번호가 아닌 고객님께서는 당행 각 지점에 문의 바랍니다.</dd-->
			</dl>
			<p class="deposit1"><img src="../inc/img/txt/p_financial_deposit.gif" alt="공평저축은행계좌" /></p>
			<p class="deposit2"><img src="../inc/img/img/bg_financial_deposit.jpg" alt="사고신고" /></p>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
	<address>
