...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/financial/netinfo.netbk.jsp">신규가입안내</a></li>
				<li><a href="/financial/netinfo.commission.jsp">수수료/이체한도</a></li>
				<li><a href="/financial/netinfo.servicehours.jsp">이용시간</a></li>
				<li><a href="/financial/netinfo.term.jsp">인터넷뱅킹이용약관</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_financial_1.gif" alt="인터넷뱅킹안내" /></h2>
			
			 			
				<div class="tab_menu2">
					<ul>
						<li class="on"><a href="/financial/netinfo.netbk.jsp">인터넷뱅킹안내</a></li>
			...
			<div class="navi">홈 &gt; 금융도우미 &gt; 인터넷뱅킹안내 &gt; <span>수수료/이체한도</span></div>
		</div>
		<div class="con_body financial preview">
			<div class="box1">
				<h4 class="mb35"><img src="../inc/img/txt/h3_financial_commission.gif" alt="수수료/이체한도" /></h4>
				<h5><img src="../inc/img/txt/h4_financial_limit.gif" alt="수수료/이체한도" /></h5>
				<p class="hiding">가까운 공평저축은행 영업점에서 인터넷뱅킹에 가입하시면 이체 등 모든 서비스를 사용하실 수 있습니다.</p>
				<div class="tables type2 mb20">
					<table summary="수수료/이체한도">
						<colgroup>
							<col width="26%"/>
							<col width="37%"/>
							<col width="37%"/>
						...
						<tbody class="tbodys">
							<tr>
								<th>조회서비스</th>
								<td colspan="2">수수료없음</td>
							</tr>
							<tr>
								<th rowspan="3">송금서비스</th>
								<td>공평저축은행내 계좌이체</td>
								<td style="border-left:1px solid #ccc"></td>
							</tr>
							<tr>
								<td>저스트e-뱅킹예금 계좌이체</td>
								<td style="border-left:1px solid #ccc">수수료없음</td>
							</tr>
							<tr>
								<td>보통예금, 저스트보통예금 계좌이체</td>
								<td style="border-left:1px solid #ccc">500원/건</td>
							</tr>
						</tbody>
					</table>
				</div>
				<p class="notice mb25"><i class="ico notice"></i> 이체거래가 취소될 경우에 수수료는 환불해 드립니다.</p>

				<h5 class="mb15"><img src="../inc/img/txt/h4_financial_limit_2.gif" alt="지급이체한도" /></h5>
				<div class="tables type1 mb15">
					<table summary="지금이체한도">
						<thead class="theads">
							<tr>
								<th colspan="3" class="moreline">1일 이체 한도</th>
								<th colspan="2" class="moreline">1일 이체한도<span class="bar"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
								<td rowspan="2" class="moreline">개인고객<br />(개인사업자 포함)</td>
								<td class="moreline" style="background:#fff4ea;">지정시</td>
								<td class="moreline">지정한 금액<br />(5천만원 이내)</td>
								<td rowspan="2" class="moreline">공평저축은행내<br />자동이체</td>
								<td rowspan="2" class="moreline">1일 이체한도 범위<br />1천만원 내에서 지정</td>
							</tr>
							<tr>
								<td class="moreline" style="background:#f4f4f4; border-left:1px solid #ccc">미 지정시</td>
								<td class="moreline">1천만원</td>
							</tr>
							<tr>
								<td class="moreline">기업고객<br />(OTP 의무사용)</td>
								<td colspan="2" class="moreline">지정한 금액(5억원 이하)</td>
								<td class="moreline">다른은행으로 이체</td>
								<td class="moreline last">1일 이체한도 범위내<br />법인: 1억원 이하</td>
							</tr>
							<tr>
								<td class="moreline">개인고객<br />(OTP 선택)</td>
								<td  colspan="2" class="moreline">지정한 금액(5억원이하)<br /></td>
								<td colspan="2"  class="moreline">1일 이체한도 내에서 지정한 금액(1억원 이하)</td>
							</tr>
						</tbody>
					</table>
				</div>
				<p class="notice mb25"><i class="ico notice"></i>
					개인고객의 1일 자금이체 한도는 최대 5천만원이며, 인터넷뱅킹 신규가입시 지정하지 않은 경우는 1천만원으로 자동 지정됩니다. 자금이체 한도를 늘리시려면 개인고객이 직접 영업점을 방문하셔서 '전자금융 1일 이체 한도 추가 약정서' 작성하시면 됩니다.
				</p>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
