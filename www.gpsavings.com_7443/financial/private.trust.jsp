...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 금융도우미 &gt; 개인정보처리방침 &gt; <span>위탁업체현황</span></div>
		</div>
		<div class="con_body financial trust">
			<div class="box1">
				<h4><img src="../inc/img/txt/financial/h4_financial_34.gif" alt="위탁업체현황"/></h4>
				<h5><img src="../inc/img/txt/financial/h5_financial_34.gif" alt="위탁업체현황"/></h5>
				<div class="tables type1 mb15">
					<table>
						<colgroup>
							<col width="24%">
							<col width="8%">
						...
						<tbody class="tbodys">
							<tr>
								<td class="moreline">(주)코아신용정보</td>
								<td>처리</td>
								<td class="moreline">해피콜, 사전납입일 안내, 상환안내,<br/>대출업무처리, 대출만기연장 안내,<br/>전화상담, 만기고객안내, 금리안내,<br/>대출업무처리</td>
								<td class="moreline">주민번호, 성명, 주소, 전화번호</td>
							</tr>
							<tr>
								<td class="moreline">모빌리언스</td>
								<td>처리</td>
								<td class="moreline">휴대폰 본인 인증</td>
								<td class="moreline">위수탁 계약만 수행,<br/>사용되고 있지 않음</td>
							</tr>
							<tr>
								<td class="moreline">(주)나우크레딧</td>
								<td>수집</td>
								<td class="moreline">대출모집</td>
								<td class="moreline">대출신청정보</td>
							</tr>
							<tr>
								<td class="moreline">(주)오케이다이렉트</td>
								<td>수집</td>
								<td class="moreline">대출모집</td>
								<td class="moreline">대출신청정보</td>
							</tr>
							<tr>
								<td class="moreline">(주)케이아이비플러스</td>
								<td></td>
								<td class="moreline">근저당 설정 위탁</td>
								<td class="moreline"></td>
							</tr>
							<tr>
								<td class="moreline">상호저축은행 중앙회</td>
								<td>처리</td>
								<td class="moreline">고객 금융거래 업무 처리</td>
								<td class="moreline">전산시스템을 구축하여 고객의 개인<br/>정보 및 각종 거래 정보 보관 관리</td>
							</tr>
							<tr>
								<td class="moreline">법무법인 이수<br/>법무법인 율우<br/>법무법인 화우<br/>장병재 법무사<br/>백지훈 법무사<br/>김충관 법무사</td>
								<td>처리</td>
								<td class="moreline">근저당권설정, 해지업무, 법적조치업무</td>
								<td class="moreline">주민번호, 성명, 주소, 전화번호,<br/>대출과목, 대출금액</td>
							</tr>
							<tr>
								<td class="moreline">대일감정원<br/>하나 감정평가법인<br/>중앙 감정평가법인</td>
								<td>처리</td>
								<td class="moreline">담보평가, 조사</td>
								<td class="moreline">성명, 주소, 전화번호</td>
							</tr>
							<tr>
								<td class="moreline">삼정회계법인</td>
								<td>처리</td>
								<td class="moreline">회계감사</td>
								<td class="moreline">채무자 관련 정보 외 회계감사자료</td>
							</tr>
							<tr>
								<td class="moreline">헬로인사</td>
								<td>처리</td>
								<td class="moreline">임직원 급여작업, 증명서발급</td>
								<td class="moreline">임직원 개인정보</td>
							</tr>
							<tr>
								<td class="moreline">이츠코어(주)</td>
								<td></td>
								<td class="moreline">PC, 프린터/복합기, 부대설비(UPS,<br/>소화설비), 주변기기 유지보수</td>
								<td class="moreline">PC, 프린터/복합기, 부대설비(UPS,<br/>소화설비), 주변기기 유지보수</td>
							</tr>
							<tr>
								<td class="moreline">(주)에스텍<br/>캡스텍<br/>에스원(세콤)</td>
								<td></td>
								<td class="moreline">분당사옥 보안관리, 청경용역</td>
								<td class="moreline">물리적 보안</td>
							</tr>
							<tr>
								<td class="moreline">(주)이비즈엔시스템</td>
								<td></td>
								<td class="moreline">SMS/MMS서비스<br/>카카오톡 알림톡 발송</td>
								<td class="moreline">성명,전화번호</td>
							</tr>
						</tbody>
					</table>
				</div>
				<ul>
					<li>위의 제휴/위탁업체는 공평저축은행이 보다 나은 서비스를 드리기 위해 고객님의 개인정보의 일부를 제공하고 있는 업체들입니다.</li>
					<li>아울러, 동 업체와 비밀준수 등을 위해 보안관리약정을 체결하고 당해 계약내용을 서면보관 하고 있습니다.</li>
				</ul>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
