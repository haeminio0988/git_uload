...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 은행안내 &gt; 인재채용 &gt; <span>급여 및 복리후생</span></div>
		</div>
		<div class="con_body financial recruit_welfare">
			<div class="box1">
                <h4><img src="../inc/img/txt/h4_recruit.welfare_32.gif" alt="급여 및 복리후생" /></h4>
                <h5><img src="../inc/img/txt/h5_recruit.welfare_321.gif" alt="급여 (2012년 3월 기준)" /></h5>
                <div class="tables type2">
                    <table>
                        <tbody class="tbodys">
                            ...
                            <tr>
                                <th>성과급</th>
                                <td><strong>연공서열에 따른 보상이 아닌 성과주의 보상제도를 실시함으로써 임직원 개개인의 동기유발을 동력하고 있습니다.</strong><br/>
                                    - <span>인센티브 : 기본급 외에 팀/부서 및 개인의 성과 평가를 통해 매월 인센티브를 지급합니다.</span><br/>
                                    - <span>성과급(PS : Profit Sharing) : 매년 회사의 경영실적에 따라 초과 수익의 일부분을 임직원들에게 지급하고 있습니다.</span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>

                <h5><img src="../inc/img/txt/h5_recruit.welfare_322.gif" alt="건강관리 지원" /></h5>
                <div class="tables type2">
                    <table>
                        <tbody class="tbodys">
                            <tr>
                                <th>건강검진실시</th>
                                <td>직원의 건강을 위해 정기적으로 건강검진을 실시하고 있으며 그 결과에 따라 개개인의 건강 증진을 위해 다양한 지원을 실시하고 있습니다.</td>
                            </tr>
                            <tr>
                                <th>의료 보조비</th>
                                <td>본인의 경우 연간 최고 300만원의 의료비를 보조합니다.<br/></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <h5><img src="../inc/img/txt/h5_recruit.welfare_324.gif" alt="경조사 지원" /></h5>
                <div class="tables type2">
                    <table>
                        <tbody class="tbodys">
                            <tr>
                                <th>경조사 지원</th>
                                <td>본인 및 가족의 경조사 발생시 업계 최고수준의 경조금과 화환/조화를 제공합니다.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
