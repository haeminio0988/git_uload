...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
<ul>
				<li><a href="/financial/private.protection.jsp">개인신용정보관리 보호정책</a></li>
				<li><a href="/financial/credit.protection.jsp">개인신용정보 관리∙보호지침(규정)</a></li>
				<li><a href="/financial/private.use.jsp">신용정보 활용체제의 공시</a></li>
				<li><a href="/financial/private.sign.jsp">신용정보 제공활용에 대한 고객권리 안내문</a></li>
			</ul>
			<h2><img src="../inc/img/txt/financial/h2_financial_31.gif" alt="개인정보처리방침" /></h2>
				...
				<div class="tab_menu2">
					<ul>
						...
						<li class="on"><a href="/financial/private.protection.jsp">개인신용<br>처리방침</a></li>
			...
			<div class="navi">홈 &gt; 금융도우미 &gt; 개인신용처리방침 &gt; <span>신용정보제공활용에 대한 고객권리안내문</span></div>
		</div>
		<div class="financial private sign">
			<div class="box1">
				<h4><img src="../inc/img/img/private/title04.png" alt="신용정보제공활용에 대한 고객권리안내문"/></h4>
				<h5>1. 금융서비스 이용 범위</h5>
				<p>고객의 신용정보는 고객이 동의한 활용 목적만으로 사용되며, 제휴회사 등에 대한 정보의 제공 · 활용 동의여부와 관계없이 금융서비스를 이용하실 수 있습니다. 다만, 제휴회사 등에 대한 정보의 제공 · 활용에 동의하지 않으시는 경우 제휴 및 부가서비스, 신상품 · 서비스 등은 제공받지 못할 수도 있습니다.</p>
				<h5>2. 고객 신용정보의 제공 및 활용 중단 신청</h5>
				<p>&nbsp;&nbsp;&nbsp;&nbsp;<strong>가.</strong>고객은 가입 신청시 동의한 본인 정보의 제3자(정보제공업체)앞 제공 또는 귀사의 금융상품(서비스) 소개 등 영업목적 사용에 대하여 전체 또는 사안별로 제공 · 활용을 중단 시킬 수 있습니다. 다만, 신용정보 인프라를 해하고, 금융회사의 업무 효율성을 저해할 우려가 있는 신용정보집중기관, 신용정보업자, 업무위탁회사 등에 대한 동의철회는 제한됩니다.</p>
				<ul>
					<li>본인 정보의 활용 제한· 중단을 원하시는 고객은 아래의 매체를 통하여 신청하여 주시기 바랍니다.</li>
					<li>당사 : 고객센터 1577-1771, 홈페이지 www.gpsavings.com / 협회 : 홈페이지 www.fsb.or.kr (상호저축은행중앙회)</li>
					<li>* 신청자 제한 : 신규 거래고객은 계약 체결일로부터 3개월 간은 신청할 수 없습니다.</li>
				</ul>
				<p>&nbsp;&nbsp;&nbsp;&nbsp;<strong>나.</strong>위의 신청과 관련하여 불편함을 느끼시거나 애로가 있으신 경우 당사의 정보관리· 보호인, 또는 협회 · 금융감독원 정보보호 담당자 앞으로 연락하여 주시기 바랍니다.</p>
				<ul>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1) 당사 고객 정보관리 · 보호인 연락처 : 공평저축은행 감사실(031-698-8181)</li>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2) 협회 정보보호 담당자 연락처 : 상호저축은행중앙회 경영지원부(02-397-8635)</li>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3) 금융감독원 민원전화 : 1332(국번없이)</li>
				</ul>
				<h5>3. 고객정보 제공사실 통보 요구 및 오류정보 정정 요구</h5>
				<p>&nbsp;&nbsp;&nbsp;&nbsp;<strong>가.</strong> 고객은 「신용정보의 이용 및 보호에 관한 법률」 및 「신용정보업 감독규정」등에 따라 아래의 권리가 부여되어 있습니다. 동 권리의 세부내용에 대해서는 당사 인터넷 홈페이지(www.gpsavings.com) 또는 금융감독원 홈페이지(www.fss.or.kr)에 게시되어 있으며, 동 권리를 행사하고자 하는 고객은 신용정보제공사실 통보 요구권의 경우 당사 고객정보 보호담당자에게, 신용정보 열람 및 정정청구는 당사 각 영업점 앞으로 신청하여 주시기 바랍니다.</p>
				<ul>
					<li><strong class="font-orange">신용정보 제공사실 통보 요구권(법 제35조)</strong></li>
					<li>고객이 본인의 신용정보를 신용정보업자 등에게 제공한 주요정보 내용 등을 통보 요구할 수 있는 권리</li>
					<br /><br />
					<li><strong class="font-orange">신용정보 열람 및 정정요구권(법 제38조)</strong></li>
					<li>고객은 신용정보업자 등이 보유하는 본인 정보의 열람 청구가 가능하며 본인 정보가 사실과 다른 경우 이의 </li>
					<li>정정요구 및 정정 처리결과에 이의가 있는 경우 금감위에 시정 요청 가능</li>
				</ul>
				<p>&nbsp;&nbsp;&nbsp;&nbsp;<strong>나.</strong>고객은 본인 신용정보를 개인신용평가회사(한국신용정보, 한국신용평가정보, 서울신용평가정보, 코리아크레딧뷰로 등)를 통하여 연간 일정범위 내에서 무료로 확인할 수 있습니다.<br />자세한 사항은 각 개인신용평가회사에 문의하시기 바랍니다.</p>
				<ul>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1) 한국신용정보(주) | ☎ 02-2122-4000 | 인터넷 : http://www.nice.co.kr</li>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2) 한국신용평가정보(주) | ☎ 02-3771-1000 | 인터넷 : http://www.kisinfo.com</li>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3) 서울신용평가정보(주) | ☎ 02-3445-5000 | 인터넷 : http://www.sci.co.kr</li>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4) 코리아크레딧뷰로(주) | ☎ 02-708-6000 | 인터넷 : http://www.koreacb.com</li>
				</ul>
				<h5>4. 개인정보 유출시 피해보상</h5>
				<p><strong>공평저축은행의 고의 또는 과실 등 귀책사유로 인한 개인정보 유출로 고객님에게 발생한 손해에 대해 관계 법령 등에 따라 보상 받으실 수 있습니다.</strong></p>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
	<address>
