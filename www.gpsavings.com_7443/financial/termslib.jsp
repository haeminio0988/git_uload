...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 금융도우미 &gt; <strong>각종약관</strong></div>
		</div>
		<div class="con_body bank_info termslib">
			<div class="box1">
				<div class="settl">
					<form method="post" id="frmSearch" action="termslib.jsp">
					<div class="serchbox">
						<span>제목&nbsp;&nbsp;</span>
					...
					<table>
						...
						<thead>
							<tr>
								...
								<th><img src="../inc/img/txt/down_tit.jpg" alt="다운로드" /></th>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								<td>33</td>
								<td class="bbstit">체크카드회원약관</td>
								<td><a href="/include/file_download.jsp?seq=33&gubun=11"><img src="../inc/img/img/formlib_down.jpg" alt="다운로드" /></a></td>
							</tr>

							<tr>
								<td>32</td>
								<td class="bbstit">야간금고약관</td>
								<td><a href="/include/file_download.jsp?seq=32&gubun=11"><img src="../inc/img/img/formlib_down.jpg" alt="다운로드" /></a></td>
							</tr>

							<tr>
								<td>31</td>
								<td class="bbstit">ISA정기예금 특약</td>
								<td><a href="/include/file_download.jsp?seq=31&gubun=11"><img src="../inc/img/img/formlib_down.jpg" alt="다운로드" /></a></td>
							</tr>

							<tr>
								<td>30</td>
								<td class="bbstit">골드바판매(매입)대행 약관</td>
								<td><a href="/include/file_download.jsp?seq=30&gubun=11"><img src="../inc/img/img/formlib_down.jpg" alt="다운로드" /></a></td>
							</tr>

							<tr>
								<td>29</td>
								<td class="bbstit">기업자유예금 특약</td>
								<td><a href="/include/file_download.jsp?seq=29&gubun=11"><img src="../inc/img/img/formlib_down.jpg" alt="다운로드" /></a></td>
							</tr>

							<tr>
								<td>28</td>
								<td class="bbstit">보호예수약관</td>
								<td><a href="/include/file_download.jsp?seq=28&gubun=11"><img src="../inc/img/img/formlib_down.jpg" alt="다운로드" /></a></td>
							</tr>

							<tr>
								<td>27</td>
								<td class="bbstit">대여금고약관</td>
								<td><a href="/include/file_download.jsp?seq=27&gubun=11"><img src="../inc/img/img/formlib_down.jpg" alt="다운로드" /></a></td>
							</tr>

							<tr>
								<td>26</td>
								<td class="bbstit">압류방지 전용통장특약</td>
								<td><a href="/include/file_download.jsp?seq=26&gubun=11"><img src="../inc/img/img/formlib_down.jpg" alt="다운로드" /></a></td>
							</tr>

							<tr>
								<td>25</td>
								<td class="bbstit">실업급여 안심통장특약</td>
								<td><a href="/include/file_download.jsp?seq=25&gubun=11"><img src="../inc/img/img/formlib_down.jpg" alt="다운로드" /></a></td>
							</tr>

							<tr>
								<td>24</td>
								<td class="bbstit">긴급지원 안심통장특약</td>
								<td><a href="/include/file_download.jsp?seq=24&gubun=11"><img src="../inc/img/img/formlib_down.jpg" alt="다운로드" /></a></td>
							</tr>
