...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<h2><img src="../inc/img/txt/board_tit.jpg" alt="공지소식" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/news/news.jsp">공평소식</a></li>
							<li ><a href="/news/mode.jsp">부동산매각안내</a></li>
						
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 공지사항 &gt; <strong>공평소식</strong></div>
		</div>
		<div class="con_body bank_info settlement news">
			<div class="box1">
				<div class="settl">
                    <h4><img src="../inc/img/txt/h4_news_2.gif" alt="공평소식" /></h4>
					<form method="post" id="frmSearch" action="news.jsp">
					<div class="serchbox">
