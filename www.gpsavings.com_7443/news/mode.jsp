...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<h2><img src="../inc/img/img/mode_tit.jpg" alt="부동산매각안내" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li ><a href="/news/news.jsp">공평소식</a></li>
							<li class="on"><a href="/news/mode.jsp">부동산매각안내</a></li>
						
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 공지사항 &gt; <strong>부동산매각안내</strong></div>
		</div>
		<div class="con_body bank_info settlement mode">
			<div class="box1">
				<div class="settl">
                    <h4><img src="../inc/img/img/mode_tt.jpg" alt="부동산매각안내" /></h4>
					<form method="post" id="frmSearch" action="mode.jsp">
					<div class="serchbox">
				...
				<div class="setbbs mt15">
					<table>
						...
						<tbody>
							...
							<tr>
								<td>1</td>
								<td class="bbstit"><a href="/include/read_count.jsp?type=mode&seq=149">[비업무용 부동산 공매 공고]</a></td>
								<td>2013-12-17</td>
								<td>2400</td>
							</tr>
				...
				<form method="post" id="frmPaging" action="mode.jsp">
					<input type="hidden" name="search_type" value="">
					<input type="hidden" name="search_keyword" value="">
					<input type="hidden" name="page" id="pPage" value="">
				</form>
				<!--
				<div class="pages">
					<span>
