...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 은행안내 &gt; 영업점안내 &gt; <span>평촌지점</span></div>
		</div>
		<div class="con_body bank_info map">
			<div class="box1">
				<h4><img src="../inc/img/txt/bank_info/h4_bank_info_41.gif" alt="영업점찾기"></h4>
				<h5><img src="../inc/img/txt/bank_info/h5_bank_info_45.gif" alt="평촌지점"></h5>
				<div class="rough_map">
					<img src="../inc/img/img/bank_info/img_bank_info_09.gif" alt="">
				</div>
				<img class="pyeongchon_direction" src="../inc/img/img/bank_info/img_bank_info_10.gif" alt="평촌지점 오시는길">
				<p class="hiding">
				일반버스<br/>
				1, 6, 10, 11-5, 301, 303, 917<br/>
				직통버스<br/>
				333, 1303, 3030, 3330, 9503<br/>
				지하철<br/>
				지하철 범계역 8번출구<br/>
				</p>
				<a href="http://me2.do/x8Fqrjp1" target="_blank"><img class="naver_btn" src="../inc/img/img/bank_info/img_bank_btn.gif"  alt="네이버지도 바로가기"></a>
				<div class="bank_info_bottom">
					<img class="location" src="../inc/img/txt/bank_info/txt_location.gif" alt="위치">
					<p class="bottom_01"><strong>도로명: </strong>(431-817) 경기도 안양시 동안구 시민대로 161, 안양무역센터 3층 실 3호 (비산동)<p>
					<p><strong>지번주소: </strong>경기도 안양시 동안구 비산동 1107 안양무역센터 3층 실 3호</p>
					<img class="call" src="../inc/img/txt/bank_info/txt_QnAcall.gif" alt="문의전화">
					<p><strong>tel.&nbsp;</strong>031-479-8000<strong class="main_strong">fax.&nbsp;</strong>031-479-8008</p>
				</div>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
