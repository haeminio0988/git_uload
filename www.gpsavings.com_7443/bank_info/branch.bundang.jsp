...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 은행안내 &gt; 영업점안내 &gt; <span>수지지점</span></div>
		</div>
		<div class="con_body bank_info map">
			<div class="box1">
				<h4><img src="../inc/img/txt/bank_info/h4_bank_info_41.gif" alt="영업점찾기"></h4>
				<h5><img src="../inc/img/txt/bank_info/h5_bank_info_43.gif" alt="수지지점"></h5>
				<div class="rough_map">
					<img src="../inc/img/img/bank_info/img_bank_info_05.gif" alt="">
				</div>
				<img class="bundang_direction" src="../inc/img/img/bank_info/img_bank_info_06.gif" alt="수지지점 오시는길">
				<p class="hiding">
				일반버스<br/>
				720-1, 720-2, 700-2, 7, 7-2, 720, 730<br/>
				좌석버스<br/>
				1550-3, 6900, 5500, 1002<br/>
				지하철<br/>
				지하철 분당선 죽전역 3번출구<br/>
				</p>
				<a href="http://me2.do/x8XfCvSr" target="_blank"><img class="naver_btn" src="../inc/img/img/bank_info/img_bank_btn.gif"  alt="네이버지도 바로가기"></a>
				<div class="bank_info_bottom">
					...
					<p class="bottom_01"><strong>도로명: </strong>(448-509) 경기도 용인시 수지구 풍덕천로 122 하나로프라자 3층 1호<p>
					<p><strong>지번주소: </strong>경기도 용인시 수지구 풍덕천동 1080-9 하나로프라자 3층 1호</p>
					<img class="call" src="../inc/img/txt/bank_info/txt_QnAcall.gif" alt="문의전화">
					<p><strong>tel.&nbsp;</strong>031-8067-2000 <strong class="main_strong">fax.&nbsp;</strong>031-8067-2008</p>
				</div>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
