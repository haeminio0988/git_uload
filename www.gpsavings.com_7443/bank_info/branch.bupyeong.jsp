...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/bank_info/branch.main.jsp">분당본점(서현)</a></li>
				<li><a href="/bank_info/branch.ilsan.jsp">일산지점</a></li>
				<li><a href="/bank_info/branch.bundang.jsp">수지지점</a></li>
				<li><a href="/bank_info/branch.bupyeong.jsp">부천지점</a></li>
				<li><a href="/bank_info/branch.pyeongchon.jsp">평촌지점</a></li>
				<!-- <li><a href="/bank_info/branch.suwon.jsp">수원지점</a></li> -->
			</ul>
			<h2><img src="../inc/img/txt/bank_info/h2_bank_info_01.gif" alt="은행안내" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/bank_info/branch.main.jsp">영업점 안내</a></li>
						
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 은행안내 &gt; 영업점안내 &gt; <span>부천지점</span></div>
		</div>
		<div class="con_body bank_info map">
			<div class="box1">
				<h4><img src="../inc/img/txt/bank_info/h4_bank_info_41.gif" alt="영업점찾기"></h4>
				<h5><img src="../inc/img/txt/bank_info/h5_bank_info_44.gif" alt="부천지점"></h5>
				<div class="rough_map">
					<img src="../inc/img/img/bank_info/img_bank_info_07.gif" alt="">
				</div>
				<img class="bupyeong_direction" src="../inc/img/img/bank_info/img_bank_info_08.gif" alt="부천지점 오시는길">
				<p class="hiding">
				일반버스<br/>
				23-2, 23-5, 27, 5-6, 50-1, 52, 56, 59, 59-1, 
6-2, 61, 66, 70<br/> (인천) 37, 780, 87, 9300, 9800
				광역버스<br/>
				1001, 8106, 8906<br/>
				
				지하철<br/>
				지하철 7호선 상동역 4번 출구<br/>
				</p>
				<a href="http://me2.do/GqxtTzKz" target="_blank"><img class="naver_btn" src="../inc/img/img/bank_info/img_bank_btn.gif"  alt="네이버지도 바로가기"></a>
				<div class="bank_info_bottom" >
					<p style="padding-right:510px;"><img class="location" src="../inc/img/txt/bank_info/txt_location.gif" alt="위치"></p>
					<p class="bottom_01"><strong>도로명: </strong>(420-864) 경기도 부천시 원미구 상동로 87 가나베스트타운쓰리 제2층 204호<p>
					<p><strong>지번주소: </strong>경기 부천시 원미구 상동 544-4 2층</p>
					<img class="call" src="../inc/img/txt/bank_info/txt_QnAcall.gif" alt="문의전화">
					<p><strong>tel.&nbsp;</strong>032-363-8000<strong class="main_strong">fax.&nbsp;</strong>032-363-8008</p>
				</div>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
