...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/bank_info/public.summary.jsp">요약공시</a></li>
				<li><a href="/bank_info/public.settlement.jsp">결산공시</a></li>
				<li><a href="/bank_info/public.spot.jsp">수시공시</a></li>
			</ul>
			<h2><img src="../inc/img/txt/summary_tit.jpg" alt="경영공시" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/bank_info/public.summary.jsp?year=0&quarter=0">경영공시</a></li>
							<li ><a href="/financial/recruit.notice.jsp">인재채용</a></li>
							<li ><a href="/bank_info/branch.main.jsp">영업점 안내</a></li>
						
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 은행안내 &gt; 경영공시 &gt; <span>결산공시</span></div>
		</div>
		<div class="con_body bank_info settlement">
			<div class="box1">
				<div class="settl public_settlement">
                    <h4><img src="../inc/img/txt/h4_bank_info_22.gif" alt="결산공시" /></h4>
					<form method="post" id="frmSearch" action="public.settlement.jsp">
					<div class="serchbox">
						<select name="search_type" id="search_type" style="width: 107px;height: 22px;">
							<option value="board_subject" selected="selected">제목</option>
							<option value="board_content">내용</option>
						</select>
						<input type="text" name="search_keyword" value="" class="settinp"><input style="border: none;" type="image" src="../inc/img/btn/settl_serbt.jpg" alt="검색">
					</div>
					</form>
				</div>
				<div class="setbbs mt0s">
					<table>
						<colgroup>
							<col width="10%" />
							<col width="65%" />
						...
						<!--임시
							<tr>
									<td>38</td>
									<td class="bbstit"><a href="http://www.gpsavings.com/bank_info/public.settlement.view02.jsp">제43기 반기 통일경영공시</a></td>
									<td>2014-02-28</td>
									<td>-</td>
							</tr>
							...
							<tr>
									<td>37</td>
									<td class="bbstit"><a href="http://www.gpsavings.com/bank_info/public.settlement.view01.jsp">제43기 반기 검토보고서</a></td>
									<td>2014-02-28</td>
									<td>-</td>
							</tr>
						임시-->
								...
								<tr>
									<td>69</td>
									<td class="bbstit"><a href="/include/read_count.jsp?type=settlement&seq=90">제47기 2분기 통일경영공시 별첨자료 - 검토보고서</a></td>
									<td>2017-08-31</td>
									<td>94</td>
								</tr>
								...
								<tr>
									<td>68</td>
									<td class="bbstit"><a href="/include/read_count.jsp?type=settlement&seq=89">제47기 2분기 통일경영공시</a></td>
									<td>2017-08-31</td>
									<td>73</td>
								</tr>
								...
								<tr>
									<td>67</td>
									<td class="bbstit"><a href="/include/read_count.jsp?type=settlement&seq=88">제47기 1분기 통일경영공시 별첨자료 - 검토보고서</a></td>
									<td>2017-05-31</td>
									<td>120</td>
								</tr>
								...
								<tr>
									<td>66</td>
									<td class="bbstit"><a href="/include/read_count.jsp?type=settlement&seq=87">제47기 1분기 통일경영공시</a></td>
									<td>2017-05-31</td>
									<td>117</td>
								</tr>
								...
								<tr>
									<td>65</td>
									<td class="bbstit"><a href="/include/read_count.jsp?type=settlement&seq=86">제46기 통일경영공시 별첨자료 - 감사보고서</a></td>
									<td>2017-03-31</td>
									<td>124</td>
								</tr>
								...
								<tr>
									<td>64</td>
									<td class="bbstit"><a href="/include/read_count.jsp?type=settlement&seq=85">제46기 통일경영공시</a></td>
									<td>2017-03-31</td>
									<td>129</td>
								</tr>
								...
								<tr>
									<td>63</td>
									<td class="bbstit"><a href="/include/read_count.jsp?type=settlement&seq=84">제46기 3분기 통일경영공시 별첨자료 - 검토보고서</a></td>
									<td>2016-11-30</td>
									<td>164</td>
								</tr>
								...
								<tr>
									<td>62</td>
									<td class="bbstit"><a href="/include/read_count.jsp?type=settlement&seq=83">제46기 3분기 통일경영공시</a></td>
									<td>2016-11-30</td>
									<td>144</td>
								</tr>
								...
								<tr>
									<td>61</td>
									<td class="bbstit"><a href="/include/read_count.jsp?type=settlement&seq=82">제46기 2분기 통일경영공시 별첨자료 - 검토보고서</a></td>
									<td>2016-08-31</td>
									<td>139</td>
								</tr>
								...
								<tr>
									<td>60</td>
									<td class="bbstit"><a href="/include/read_count.jsp?type=settlement&seq=81">제46기 2분기 통일경영공시</a></td>
									<td>2016-08-31</td>
									<td>113</td>
								</tr>
				...
				<div class="pages">
					<span><a href="#"><img src="../inc/img/bbs/settlement_18.jpg" alt="이전글이 존재하지 않습니다."></a><a href="#"><img src="../inc/img/bbs/settlement_20.jpg" alt="이전글이 존재하지 않습니다."></a></span><ul class="bbspages"><li><a href="#" onclick="goPage(1);" class=""><span class="nowPage">1</span></a></li><li><a href="#" onclick="goPage(2);" class="">2</a></li><li><a href="#" onclick="goPage(3);" class="">3</a></li><li><a href="#" onclick="goPage(4);" class="">4</a></li><li><a href="#" onclick="goPage(5);" class="">5</a></li><li><a href="#" onclick="goPage(6);" class="">6</a></li><li><a href="#" onclick="goPage(7);" class="">7</a></li></ul><span><a href="#"><img src="../inc/img/bbs/settlement_23.jpg" alt="다음글이 존재하지 않습니다."></a><a href="#" onclick="goPage(7);" class=""><img src="../inc/img/bbs/settlement_25.jpg" alt="오른쪽끝"></a></span>
				</div>
				<form method="post" id="frmPaging" action="public.settlement.jsp">
					<input type="hidden" name="search_type" value="board_subject">
