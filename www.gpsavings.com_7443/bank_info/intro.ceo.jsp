...
<!-- 				<li><a href="/bank_info/intro.organization.jsp">조직도</a></li> -->
			...
			<h2><img src="../inc/img/txt/header.intro.ceo.jpg" class="mr10" alt="CEO인사말" /><img src="../inc/img/txt/header.intro2.ceo.jpg" /></h2>
			...
			<div class="navi">홈 &gt; 은행안내 &gt; 은행소개 &gt; <span>CEO인사말</span></div>
		</div>
		<div class="con_body bank_info intro_ceo">
			<div class="box1">
				<h3 class="hiding">고객과 함께하는 건실하고 안전한 초우량 Retail 금융기관</h3>
				<h4 class="hiding">공평저축은행이 실현하고자 하는 기업의 Vision입니다.</h4>
				<p class="hiding">
					공평저축은행 홈페이지를 방문해주신 고객 여러분 안녕하십니까. <br />
					변함없는 관심과 격려에 깊은 감사를 드립니다. <br />

					이제부터 공평 저축은행 임직원 모두는 우리의 Vision을 실현하기 위해 시장에서 신뢰받고 <br />
					모든 서민에게 공평한 혜택을 제공할 수 있는 고객 중심 경영 체제와 지역사외와의 공생발전 체제를 <br />
					강력히 구죽해 나갈 것 입니다. <br />
					또한 공정한 기업문화를 정립하고 도덕적으로 무장한 내부 인재를 육성함은 물론 System에 입각한 위험관리 능력을 강화시켜 <br />
					누구에게나 믿음과 만족을 주는 초우량 저축은행을 만들어 나갈 것입니다. <br />

					또한 초지일관으로 법과 원칙에 충실하고, 낮은 자세로 고객의 소리에 귀 기울여, 저축은행 본연의 역할인 서민금융기관으로서 <br />
					역할을 다할 수 있도록 혼신의 노력을 다해 나가겠습니다. <br />

					앞으로도 새롭게 출범하는 공평저축은행에 지속적인 사랑과 많은 가르침을 부탁드리며, <br />
					고객 여러분의 건승과 행복을 기원합니다. <br />
