...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 은행안내 &gt; 은행소개 &gt; <span>경영이념</span></div>
		</div>
		<div class="con_body bank_info idea">
			<div class="box1">
				<h4><img src="../inc/img/txt/a_intro1.jpg" alt="경영이념" /></h4>
				<h5><img src="../inc/img/txt/a_intro2.jpg" alt="경영이념" /></h5>
				<img src="../inc/img/txt/a_intro3.jpg" alt="" /><p class="hiding">대한민국 금융미래를 책임지는 저축은행으로서 공정한 경영, 윤리 경영, 고객중심 경영을 통해
					고객에게 기쁨과 만족을 주는 은행, 건전한 수익기반을 갖춘 은행, 주주가치의 극대화를 구현하는 은행이 되겠습니다.
					</p>
				<h5 class="idea_tit"><img src="../inc/img/txt/a_intro4.jpg" alt="Vision 및 경영방침" /></h5>
				<div class="left100">
					<p class="hiding">
						Vision <br />
						고객과 함께하는 건실하고 안전한 <br />
						초우량 Retail은행 <br />
					</p>
					<ul class="hiding">
						<li>SYSTEM</li>
				...
				<div class="idea_bg">
					<h4><img src="../inc/img/txt/idea_tit_01.jpg" alt="가치경영" /></h4>
					<ul class="dot">
						<li>우수한 금융 서비스 제공으로 모든 서민에세 공평한 혜택 제공</li>
						<li>사회 공헌을 통한 개인, 기업 및 지역의 공생 발전 도모</li>
						<li>시스템에 기반을 둔 업계 최고의 위험관리 능력 확보</li>
					</ul>
					<h4><img src="../inc/img/txt/idea_tit_02.jpg" alt="정도경영" /></h4>
					<ul class="dot">
						<li>법과 원칙을 철저히 지켜 시장에서의 신뢰 확보</li>
						<li>공정한 기업 문화 구축과 기업 윤리 준수</li>
					</ul>
					<h4><img src="../inc/img/txt/idea_tit_03.jpg" alt="인재경영" /></h4>
					<ul class="dot">
						<li>도덕성과 능력을 겸비한 인재상을 정립하여 우수인재 육성</li>
						<li>내부 인력에 대한 체계적인 교육을 통한 자아실현 기반 마련</li>
					</ul>
				</div>
			</div><!-- box1 -->
		</div><!-- saving -->
