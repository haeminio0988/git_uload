...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 은행안내 &gt; 영업점안내 &gt; <span>일산지점</span></div>
		</div>
		<div class="con_body bank_info map">
			<div class="box1">
				<h4><img src="../inc/img/txt/bank_info/h4_bank_info_41.gif" alt="영업점찾기"></h4>
				<h5><img src="../inc/img/txt/bank_info/h5_bank_info_42.gif" alt="일산지점"></h5>
				<div class="rough_map">
					<img src="../inc/img/img/bank_info/img_bank_info_03.gif" alt="">
				</div>
				<img class="lisan_direction" src="../inc/img/img/bank_info/img_bank_info_04.gif" alt="일산지점 오시는길">
				<p class="hiding">
				일반버스<br/>
				1, 5, 8, 6, 12, 76-1, 88, 150, 151, 700, 900, 919<br/>
				광역버스<br/>
				9701, 9707, 9708<br/>
				좌석버스<br/>
				200, 1000, 2000, 8880, 9700 <br/>
				지하철<br/>
				지하철 3호선 주엽역 4번 출구<br/>
				</p>
				<a href="http://me2.do/FZG40pw" target="_blank"><img class="naver_btn" src="../inc/img/img/bank_info/img_bank_btn.gif"  alt="네이버지도 바로가기"></a>
				<div class="bank_info_bottom">
					<img class="location" src="../inc/img/txt/bank_info/txt_location.gif" alt="위치">
					<p class="bottom_01"><strong>도로명: </strong>(411-838) 경기도 고양시 일산서구 중앙로 1443, 가람그린타워1층 (주엽동)<p>
					<p><strong>지번주소: </strong>경기도 고양시 일산서구 주엽동 110-2 가람 그린타워 1층</p>
					<img class="call" src="../inc/img/txt/bank_info/txt_QnAcall.gif" alt="문의전화">
					<p><strong>tel.&nbsp;</strong>031-956-8200<strong class="main_strong">fax.&nbsp;</strong>031-956-8208</p>
				</div>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
