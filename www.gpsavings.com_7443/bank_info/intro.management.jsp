...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/bank_info/intro.ceo.jsp">CEO인사말</a></li>
				<li><a href="/bank_info/intro.idea.jsp">경영이념</a></li>
				<li><a href="/bank_info/intro.management.jsp">경영진소개</a></li>
				<li><a href="/bank_info/intro.history.jsp">연혁</a></li>
				<li><a href="/bank_info/intro.organization.jsp">조직도</a></li>
			</ul>
			<h2><img src="../inc/img/txt/intro_idea.jpg" class="mr10" alt="은행소개" /><img src="../inc/img/txt/intro_idea2.jpg" /></h2>
			
						
				<div class="tab_menu">
					<ul>
						
							<li class="on"><a href="/bank_info/intro.ceo.jsp">은행소개</a></li>
			...
			<div class="navi">홈 &gt; 은행안내 &gt; 은행소개 &gt; <span>경영진소개</span></div>
		</div>
		<div class="con_body bank_info idea">
			<div class="box1">
				<h4><img src="../inc/img/txt/h4.intro.management.gif" alt="경영진 소개" /></h4>
				<h5><img src="../inc/img/txt/h5.intro.management.gif" alt="경영진 소개" /></h5>
				<img src="../inc/img/txt/txt.intro.management.gif" alt="" />
				<p class="hiding">
					저희 경영진은 공평저축은행이 고객님으로부터 신뢰받는 건실한 금융기관으로 성장하기 위한 밑거름이 되겠습니다.
				</p>
				<table class="table_management">
					<tbody>
						<tr>
							<th>
								<img src="../inc/img/txt/txt.intro.management_name_02.png" alt="대표이사(부회장) 권현진" />
							</th>
							<td>
								<dl>
									<dt><img src="../inc/img/txt/txt.intro.management01.gif" alt="학력" /></dt>
									<dd>단국대학교 회계학과 졸업</dd>
									<dd>미국 Univ. of George Washington MBA</dd>
									<dt><img src="../inc/img/txt/txt.intro.management02.gif" alt="주요경력" /></dt>
									<dd>㈜캠시스 대표이사 역임</dd>
									<dd>㈜에이모션 대표이사 역임</dd>
								</dl>
							</td>
						...
						<tr>
							<th>
								<img src="../inc/img/txt/txt.intro.management_name_04.png" alt="영업본부장 주영천" />
							</th>
							<td>
								<dl>
									<dt><img src="../inc/img/txt/txt.intro.management01.gif" alt="학력" /></dt>
									<dd>서울대학교 역사교육학과 졸업</dd>
									<dt><img src="../inc/img/txt/txt.intro.management02.gif" alt="주요경력" /></dt>
									<dd>에스크베리타스자산운용 부동산2본부장 역임</dd>
									<dd>솔로몬저축은행 종합금융부장, 도곡지점장 역임</dd>
									<dd>진흥저축은행 금융팀장 역임</dd>
								</dl>
							</td>
						</tr>
						<tr>
							<th>
								<img src="../inc/img/txt/txt.intro.management_name_05.png" alt="리스크관리본부장 김순채" />
							</th>
							<td>
								<dl>
									<dt><img src="../inc/img/txt/txt.intro.management01.gif" alt="학력" /></dt>
									<dd>숭실대학교 경영학과 졸업</dd>
									<dt><img src="../inc/img/txt/txt.intro.management02.gif" alt="주요경력" /></dt>
									<dd>솔로몬저축은행 심사,리스크관리 담당 임원 역임</dd>
									<dd>비에이치홀딩스 이사 역임</dd>
									<dd>국민은행, 평화은행 근무</dd>
								</dl>
							</td>
						...
						<tr>
							<th>
								<img src="../inc/img/txt/txt.intro.management_name_09.png" alt="감사실장 김용광" />
							</th>
							<td>
								<dl>
									<dt><img src="../inc/img/txt/txt.intro.management01.gif" alt="학력" /></dt>
									<dd>동대문상업고등학교 졸업</dd>
									<dt><img src="../inc/img/txt/txt.intro.management02.gif" alt="주요경력" /></dt>
									<dd>우풍상호저축은행, 솔로몬저축은행 근무</dd>
								</dl>
							</td>
						</tr>
						<tr>
							<th>
								<img src="../inc/img/txt/txt.intro.management_name_06.png" alt="사외이사 김상우" />
							</th>
							<td>
								<dl>
									<dt><img src="../inc/img/txt/txt.intro.management01.gif" alt="학력" /></dt>
									<dd>서울대학교 법학과 졸업</dd>
									<dd>미국 Univ. of Oregon 경제학 석사</dd>
									<dt><img src="../inc/img/txt/txt.intro.management02.gif" alt="주요경력" /></dt>
									<dd>금융감독원 부원장보 역임</dd>
									<dd>한국은행 은행감독원 검사국 기획조정국장 역임</dd>
									<dd>조흥은행 상근감사위원 역임</dd>
								</dl>
							</td>
						</tr>
						<tr>
							<th>
								<img src="../inc/img/txt/txt.intro.management_name_07.png" alt="사외이사 조원권" />
							</th>
							<td>
								<dl>
									<dt><img src="../inc/img/txt/txt.intro.management01.gif" alt="학력" /></dt>
									<dd>서울대학교 경제학과 졸업</dd>
									<dd>서울대학교 행정대학원 정책학 석사</dd>
									<dd>미국 Univ. of Texas A&M 경제학 박사</dd>
									<dt><img src="../inc/img/txt/txt.intro.management02.gif" alt="주요경력" /></dt>
									<dd>제24회 행정고시 합격</dd>
									<dd>우송대학교 부총장(현)</dd>
									<dd>경제기획원(현 기획재정부) 기획국 종합기획과 근무</dd>
								</dl>
							</td>
						</tr>
						<tr>
							<th>
								<img src="../inc/img/txt/txt.intro.management_name_08.png" alt="사외이사 박영석" />
							</th>
							<td>
								<dl>
									<dt><img src="../inc/img/txt/txt.intro.management01.gif" alt="학력" /></dt>
