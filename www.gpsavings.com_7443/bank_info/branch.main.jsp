...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 은행안내 &gt; 영업점안내 &gt; <span>분당본점(서현)</span></div>
		</div>
		<div class="con_body bank_info map">
			<div class="box1">
				<h4><img src="../inc/img/txt/bank_info/h4_bank_info_41.gif" alt="영업점찾기"></h4>
				<h5><img src="../inc/img/txt/bank_info/h5_bank_info_41.gif" alt="본점"></h5>
				<div class="rough_map">
					<img src="../inc/img/img/bank_info/img_bank_info_01.gif" alt="">
				</div>
				<img class="main_direction" src="../inc/img/img/bank_info/img_bank_info_02.gif" alt="본사 오시는길">
				<p class="hiding">
				일반버스<br/>
				15, 17, 33, 52, 116-3, 220, 250, 300, 521, 522, 720-1, 720-2, 730<br/>
				직행버스<br/>
				102, 1151, 5500-1, 7007-1, 8106, 8109, 9000, 9001, 9401, M4102<br/>
				지하철<br/>
				분당선 서현역 5번 출구 (도보 5분)<br/>
				</p>
				<a href=" http://me2.do/xOMJ4f0A" target="_blank"><img class="naver_btn" src="../inc/img/img/bank_info/img_bank_btn.gif"  alt="네이버지도 바로가기"></a>
				<div class="bank_info_bottom">
					<img class="location" src="../inc/img/txt/bank_info/txt_location.gif" alt="위치">
					<p class="bottom_01"><strong>도로명: </strong>(463-824) 경기도 성남시 분당구 황새울로 358<p>
					<p><strong>지번주소: </strong>경기도 성남시 분당구 서현동 249-1</p>
					<img class="call" src="../inc/img/txt/bank_info/txt_QnAcall.gif" alt="문의전화">
					<p><strong>tel.&nbsp;</strong>031-698-8200<strong class="main_strong">fax.&nbsp;</strong>031-698-8208</p>
				</div>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
