...
<style type="text/css">
.summary .box1 select. { width: 107px; border: 1px solid #b8b8b8; font: normal 12px "Dotum"; color: #999999; }
</style>
<script type="text/javascript">
$(function() {
	$('#sel_quarter').change(function() {
		var year = $('#sel_year').val();
		var quarter = $('#sel_quarter').val();

		location.href = 'public.summary.jsp?year=' + year + '&quarter=' + quarter;
	});
});
</script>
</head><body>
...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 은행안내 &gt; 경영공시 &gt; <span>요약공시</span></div>
		</div>
		<div class="con_body bank_info summary">
			<div class="box1">
				<div class="sum_top">
					<h4><img src="../inc/img/txt/summary_01.jpg" alt="요약공시" /></h4>
					<h5>
						<img src="../inc/img/txt/summary_02.jpg" alt="전자경영공시지표" />
						<select name="sel_year" id="sel_year" class="select ml10" style="width: 107px;">
							...
							<option value="2014">FY2014</option>
						
							<option value="2013">FY2013</option>
						
							<option value="2012">FY2012</option>
						
							<option value="2011">FY2011</option>
						
							<option value="2010">FY2010</option>
						
							<option value="2009">FY2009</option>
						
							<option value="2008">FY2008</option>
						
							<option value="2007">FY2007</option>
						
							<option value="2006">FY2006</option>
						
							<option value="2005">FY2005</option>
						
						</select>
						<select name="sel_quarter" id="sel_quarter" class="select" style="width: 107px;">
