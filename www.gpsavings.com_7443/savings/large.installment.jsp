...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 예금상품 &gt; 목돈마련상품 &gt; <span>정기적금</span></div>
		</div>

		<div class="con_body saving large installment">
			<div class="box1">
				<h3 class="hiding">일정한 기간과 불입금액을 정하여 정기적으로 적금은 납입하는 상품입니다.</h3>
				<p class="hiding">해지 시 가입고객에게 불입금 총액과 일정한 이자를 지급하는 목돈말녀 상품입니다.</p>
				<p style="height:70px;"></p>
				<h4><img src="../inc/img/txt/h4_savings_21.gif" alt="정기적금" /></h4>
				<!-- <h5><img src="../inc/img/txt/h5_savings_21.gif" alt="정기적금 안내" /></h5> -->
					...
					<table>
						...
						<tbody class="tbodys">
							<tr>
								<th>가입대상</th>
								<td>제한없음</td>
								<th rowspan="2">가입기간</th>
								<td rowspan="2" class="moreline">6개월~36개월<br>
&#40;월단위 가입&#41;</td>
							</tr>
							<tr>
								<th>가입금액</th>
							...
							<tr>
								<th>가입한도</th>
								<td>제한없음</td>
								<td colspan="2">인터넷 뱅킹 가입시 0.1% 우대금리적용</td>
							</tr>
						</tbody>
					</table>
				</div>

				<h6 class="mt20"><img src="../inc/img/txt/txt_rate.gif" alt="이율(매월 10만원 불입 기준)" /></h6>
				<div class="tables type1">
					<table>
						...
						<thead class="theads">
							<tr>
								<th>계약기간</th>
								<th>불입총액<span class="bar"></span></th>
								<th>지급이자<span class="bar"></span></th>
								<th>계<span class="bar"></span></th>
