...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/savings/large.fixed.jsp">정기예금</a></li>
				<li><a href="/savings/nonFace.fixed.deposit.jsp">비대면 정기예금</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_savings_31.gif" alt="목돈운용상품" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/savings/large.fixed.jsp">목돈운용상품</a></li>
			...
			<div class="navi">홈 &gt; 예금상품 &gt; 목돈운용상품 &gt; <span>정기예금</span></div>
		</div>

		<div class="con_body saving large fixed">
			<div class="box1">
				<h3 class="hiding">일정기간동안 특정금액을 예치하여 높은 수익을 올릴 수 있는 거치식 예금상품입니다.</h3>
				<!--p class="hiding">만기지급식으로 가입하였어도 필요하시면 이자지급식으로 전환하여 매월 이자를 수령하실 수 있습니다.</p-->
				<p style="height:70px;"></p>
				<h4><img src="../inc/img/txt/h4_savings_31.gif" alt="정기예금" /></h4>
				<!--h5><img src="../inc/img/txt/h5_savings_31.gif" alt="정기예금 안내" /></h5-->
					...
					<table>
						...
						<tbody class="tbodys">
							<tr>
								<th>가입대상</th>
								<td>제한없음</td>
								<th rowspan="2">이자수령방법</th>
								<td rowspan="2" class="moreline">매월이자지급식&#40;단리&#41;,
만기이자지급식&#40;복리&#41;</td>
							</tr>
							<tr>
								<th>가입한도</th>
							...
							<tr>
								<th>가입기간</th>
								<td class="moreline" colspan="3">1개월 ~ 24개월
&#40;월단위, 일단위 가능&#41;</td>
							</tr>
						</tbody>
					</table>
				...
				<h6 class="mt20"><img src="../inc/img/txt/txt_rateset100.gif" alt="이율" /></h6>
				<span class="notice">단리식(매월 이자지급식 / 계약금액 1000만원 기준)</span>
				<div class="tables type1 mb15">
					<table>
						...
						<thead class="theads">
							<tr>
								<th>예치기간</span></th>
								<th>연이율<span class="bar"></span></th>
								<th>월이율<span class="bar"></span></th>
								<th>세금공제전 지급액<span class="bar"></span></th>
								<th>세금공제후 지급액<span class="bar"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
				...
				<span class="notice">복리식(월복리, 만기 이자지급식 / 계약금액 1000만원 기준)</span>
				...
				<ul class="wid mt20" style="width:100%">
					...
					<li>정기예금(매월 이자 지급식)으로 가입 후 매월 이자를 수령하지 않을 경우, 이자지급 요청시 단리이자 계산방식으로 월이자를 일괄지급</li>
					<!-- <li>정기예금 금리적용에 관한 특례: 동일인(개인, 법인) 기준으로 정기예금 계약금액의 합이 10억원 이상일 경우, 초과금액에 대한 금리는 계약기간별 기준금리에서 2.0% 차감된 금리가 적용됨.</li> -->
				</ul>
