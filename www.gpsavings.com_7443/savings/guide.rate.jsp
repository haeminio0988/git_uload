...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 예금상품 &gt; 예금가이드 &gt; <span>예금금리안내</span></div>
		</div>
		<div class="con_body saving guide rate">

			<div class="box1">
				<h3 class="hiding">자유로운 입출금, 편리한 예금상품을 안내해 드립니다.</h3>
				<h4><img src="../inc/img/txt/h4_savings_51.gif" alt="예금금리안내" /></h4>
				<h5><img src="../inc/img/txt/h5_savings_511.gif" alt="입출금자유상품" /></h5>
				<h6><img src="../inc/img/txt/txt_guide.normal.gif" alt="보통예금" /></h6>
				<div class="tables type1 mb20">
					<table>
						<colgroup>
							<col width="20%" />
							<col width="20%" />
						...
						<thead class="theads">
							<tr>
								<th>가입대상</span></th>
								<th>연이자율<span class="bar"></span></th>
								<th>이자율변경<span class="bar"></span></th>
								<th class="moreline">가입자격,<br /> 가입조건<span class="bar"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
								<td>개인, 법인</td>
								<td>연 0.1&#37;</td>
								<td class="moreline">이자율은 실제금리 변동에 따라<br/>변경될 수 있습니다.</td>
								<td>제한없음</td>
							</tr>
						</tbody>
					</table>
				...
				<h6><img src="../inc/img/txt/txt_guidegen.gif" alt="아낌없이 주는 저축예금 / 기업자유예금" /></h6>
				<div class="tables type1 mb20">
					<table>
						<colgroup>
							<col width="20%" />
						...
						<thead class="theads">
							<tr>
								<th>예금잔액</span></th>
								<th>연이자율(변동금리)<span class="bar"></span></th>
								<th>이자율변경<span class="bar"></span></th>
								<th class="moreline">가입자격,<br /> 가입조건<span class="bar"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
								<td class="ta_c pl0">50만원미만</td>
								<td class="intable">연 0.1%</td>
								<td rowspan="2" class="moreline ta_c pl10">이자율은 실제금리<p>변동에 따라 변경될 수 있습니다.</td>
								<td rowspan="2" class="ta_c pl0">- 1인 1계좌<p>-인터넷뱅킹 타행이체 수수료 면제</td>
							</tr>
                            
                            <tr>
								<td class="ta_c pl0">50만원이상</td>
								<td class="intable">연 1.7%</td>
							</tr>  
						</tbody>
					</table>
				</div>
				...
				<h6><img src="../inc/img/txt/txt_guide.just.gif" alt="저스트보통예금" /></h6>
				<div class="tables type1 mb20">
					<table>
						<colgroup>
							<col width="20%" />
				...
				<h6><img src="../inc/img/txt/txt_guide.justebk.gif" alt="저스트 e-뱅킹예금" /></h6>
				<div class="tables type1 mb20">
					<table>
						<colgroup>
							<col width="15%" />
						...
						<thead class="theads">
							<tr>
								<th>가입대상</th>
								<th>연이자율(변동금리)<span class="bar"></span></th>
								<th>이자율 변경<span class="bar"></span></th>
								<th class="moreline">가입자격,<br /> 가입조건<span class="bar"></span></th>
							</tr>
						</thead>
						...
						<!--<tbody class="tbodys">
							<tr>
								<td class="ta_c pl0">개인, 법인</td>
								<td class="intable">연3.0%</td>
								<td class="moreline ta_c pl10">이자율은 실제금리<br/>변동에 따라 변경될 수 있습니다.</td>
								<td class="ta_c pl0">- 1인1계좌<br/>- 인터넷뱅킹거래전용<br/>- 인터넷뱅킹타행이체수수료면제</td>
							</tr>
						</tbody>-->

						<tbody class="tbodys">
							<tr>
								<td class="ta_c pl0">개인</td>
								<td class="intable">연0.2&#37;</td>
								<td rowspan="2" class="moreline ta_c pl10">이자율은 실제금리<br/>변동에 따라 변경될 수 있습니다.</td>
								<td rowspan="2" class="ta_c pl0">- 1인1계좌<br/>- 인터넷뱅킹거래전용<br/>- 인터넷뱅킹타행이체수수료면제</td>
							</tr>
                            
                            <tr>
								<td class="ta_c pl0">법인·사업자</td>
								<td class="intable">연0.2&#37;</td>
							</tr>                  
						</tbody>
				...
				<h5><img src="../inc/img/txt/h5_savings_512.gif" alt="목돈운용상품" /></h5>
				<h6><img src="../inc/img/txt/txt_guide.fixed.gif" alt="정기예금" /></h6>
				<div class="tables type1 mb10">
					<table>
						<colgroup>
							<col width="16%" />
							<col width="20%" />
						...
						<thead class="theads">
							<tr>
								<th>계약기간</span></th>
								<th>연이자율(단리식)<span class="bar"></span></th>
								<th>연수익율(복리식)<span class="bar"></span></th>
								<th>중도해지 이자율<span class="bar"></span></th>
								<th>만기 후 이자율<span class="bar"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
								<td class="moreline">1개월~3개월미만</td>
								<td>연 1.70%</td>
								<td>연 1.70%</td>
								<td rowspan="6" class="moreline ta_l pl5">실제예치기간별 차등금리<br/><br/>* 6개월 미만: 연 0.1&#37;<br/><br/>* 6개월 이상: 연 0.5&#37;<br/><br/></td>
								<td rowspan="6" class="moreline">* 연0.1&#37;</td>
							</tr>
							<tr>
								<td class="moreline">3개월~6개월미만</td>
								<td>연 1.70%</td>
								<td>연 1.70%</td>
							</tr>
<!-- 							<tr>
								<td class="moreline">6개월~12개월미만</td>
								<td>연 1.90%</td>
								<td>연 1.90%</td>
							</tr> -->
							<tr>
								<td class="moreline">6개월이상~<br/>12개월미만</td>
								<td>연 1.90&#37;</td>
								<td>연 1.90&#37;</td>
							</tr>
							<tr>
								<td class="moreline">12개월이상~<br/>18개월미만</td>
								<td>연 2.30&#37;</td>
								<td>연 2.32&#37;</td>
							</tr>
							<tr>
								<td class="moreline">18개월이상~<br/>24개월미만</td>
								<td>연 2.30&#37;</td>
								<td>연 2.33&#37;</td>
							</tr>
 							<tr>
								<td class="moreline">24개월</td>
								<td >연 2.40&#37;</td>
								<td >연 2.45&#37;</td>
 							</tr>
						</tbody>
				...
				<span class="notice"><i class="ico notice"></i> 인터넷뱅킹/스마트뱅킹으로 상품 가입시 0.1% 우대</span>
				<!-- <span class="notice"><i class="ico notice"></i> 인터넷정기예금 우대금리: 신규 개설시 0.1% 우대</span> -->
				</br>
<!-- 				<h6 class="mt20"><img src="../inc/img/txt/txt_guide.covebill.gif" alt="표지어음" /></h6> -->
<!-- 				<div class="tables type1 mb20"> -->
<!-- 					<table> -->
<!-- 						<colgroup> -->
<!-- 							<col width="18%" /> -->
...
<!-- 						<thead class="theads"> -->
<!-- 							<tr> -->
<!-- 								<th>계약기간<span class="bar"></span></th> -->
<!-- 								<th>연이자율<span class="bar"></span></th> -->
<!-- 								<th>연수익율<span class="bar"></span></th> -->
<!-- 								<th>중도해지 이자율<span class="bar"></span></th> -->
<!-- 								<th>만기 후 이자율<span class="bar"></span></th> -->
<!-- 							</tr> -->
<!-- 						</thead> -->
...
<!-- 				</div> -->
				<br/>
				<h5><img src="../inc/img/txt/h5_savings_513.gif" alt="목돈마련상품" /></h5>
				<h6><img src="../inc/img/txt/txt_guide.installment.gif" alt="정기적금" /></h6>
				<div class="tables type1 mb10">
					<table>
						<colgroup>
							<col width="20%" />
						...
						<tbody class="tbodys">
							<tr>
								<td class="pl10 ta_l">6개월~11개월</td>
								<td>연 2.2&#37;</td>
								<td rowspan="5" class="moreline ta_l pl15">실제예치기간별 차등금리<br/><br/>* 6개월 미만: 연 0.1&#37;<br/><br/>* 6개월 이상: 연 0.5&#37;<br/><br/></td>
								<td rowspan="5" class="moreline">* 연0.1&#37;</td>
							</tr>
							<tr>
								<td class="pl10 ta_l">12개월~23개월</td>
								<td>연 2.3&#37;</td>
							</tr>
							<tr>
								<td class="pl10 ta_l">24개월~36개월</td>
								<td>연 2.4&#37;</td>
							</tr>
							<tr>
								<td class="pl10 ta_l">36개월</td>
								<td>연 2.4&#37;</td>
							</tr>
							<tr>
								<td class="pl10 ta_l"></td>
								<td></td>
							</tr>
						</tbody>
					</table>
				...
				<h6 class="mt20"><img src="../inc/img/txt/txt_guide.generously.gif" alt="아낌없이 주는 저축" /></h6>
				<div class="tables type1 mb20">
					<table>
						<colgroup>
							<col width="18%" />
						...
						<tbody class="tbodys">
							<tr>
								<td>12개월, 24개월</td>
								<td>기본금리 : 연 2.3&#37;<br/><br/><br/>&#40;우대금리는 우대조건 충족 여부에 따라 차등&#41;</td>
								<td class="moreline ta_l pl15">실제예치기간별 차등금리<br/><br/>* 6개월 미만: 연 0.1&#37;<br/><br/>* 6개월 이상: 연 0.5&#37;<br/><br/></td>
								<td class="moreline">* 연 0.1&#37;</td>
							</tr>
						</tbody>
					</table>
				</div>
				<h6 class="mt20"><img src="../inc/img/txt/txt_sweetener2.gif" alt="우대조건" /></h6>
				<div class="tables type1">
					<table>
						...
						<thead class="theads">
							<tr>
								<th>적용조건<span class="bar"></span></th>
								<th>우대금리<span class="bar"></span></th>
								<th>비고<span class="bar"></span></th>
						...
						<tbody class="tbodys">
							...
							<tr>
								<td>KB카드 발급, 有실적</td>
								<td>신규발급시 : 0.5%</br>재발급시 : 0.2%</td>
								<td>카드발급 후 3개월간 30만원 이상 사용</td>
							</tr>
							<tr>
								<td>보통예금 결제계좌 이용</td>
								<td>0.2%</td>
								<td>
								보험,카드,통신등 납부금 결제계좌로 </br>신청(3개월이상 이체실적 有)
								</td>
							</tr>
				...
				<span class="notice"><i class="ico notice"></i> 카드신청/재발급/신규발급 우대금리는 중복 적용되지 않습니다.</span>
				
				<h6 class="mt20"><img src="../inc/img/txt/txt_guide.2030.gif" alt="2030누구나 정기적금" /></h6>
				<div class="tables type1 mb20">
					<table>
						<colgroup>
							<col width="18%" />
				...
				<h6 class="mt20"><img src="../inc/img/txt/txt_guide.free.gif" alt="자유적립예금 (입금시점 실예치 기간에 해당하는 정기예금 이자율 적용)" /></h6>
				<div class="tables type1 mb20">
					<table>
						<colgroup>
							<col width="25%" />
						...
						<thead class="theads">
							<tr>
								<th>계약기간</span></th>
								<th>연이자율(복리식)<span class="bar"></span></th>
								<th>중도해지 이자율<span class="bar"></span></th>
								<th>만기 후 이자율<span class="bar"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
								<td class="pl10 ta_l">1개월이상 ~ 6개월미만</td>
								<td>연 1.7&#37;</td>
								<td rowspan="4" class="moreline ta_l pl10">실제예치기간별 차등금리<br/><br/>* 6개월 미만: 연 0.1&#37;<br/><br/>* 6개월 이상: 연 0.5&#37;<br/><br/></td>
								<td rowspan="4" class="moreline">* 연 0.1&#37;</td>
							</tr>
							<tr>
								<td class="pl10 ta_l">6개월이상 ~ 12개월미만</td>
								<td>연 1.9&#37;</td>
							</tr>
							<tr>
								<td class="pl10 ta_l">12개월이상 ~ 24개월미만</td>
								<td>연 2.3&#37;</td>
							</tr>
							<tr>
								<td class="pl10 ta_l">24개월</td>
								<td>연 2.4&#37;</td>
							</tr>
						</tbody>
					</table>
				</div>
				<h6 class="mt20"><img src="../inc/img/txt/txt_guide.work.gif" alt="공평재형저축 " /></h6>
				<span class="notice">※ 동 상품은 2015년 12월 31일부로 가입이 종료된 상품입니다.</span>
				<div class="tables type1 mb20">
					<table>
						<colgroup>
							<col width="12%" />
						...
						<tbody class="tbodys">
							<tr>
								<td>7년</td>
								<td class="moreline">기본이자율 연4.4&#37;<br/>&#40;우대이자율 최대 0.4&#41;</td>
								<td class="moreline ta_l pl10">실제예치기간별 차등금리<br/><br/>* 6개월 미만: 연 0.1&#37;<br/>* 6개월 이상: 연 0.5&#37;<br/><br/></td>
								<td class="moreline">* 연 0.1&#37;</td>
							</tr>
						</tbody>
					</table>
				</div>
				<!--span class="notice"><i class="ico notice"></i>！인터넷정기예금 우대금리 : 계약기간 12개월 이상~24개월 이하 신규 개설시 0.1%p 우대</span-->
			</div><!--//box1-->
		</div>
