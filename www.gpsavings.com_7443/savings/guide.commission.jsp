...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 예금상품 &gt; 예금가이드 &gt; <span>예금업무 관련 수수료</span></div>
		</div>
		<div class="con_body saving guide commission">
			<div class="box1">
				<h4><img src="../inc/img/txt/h4_savings_54.gif" alt="예금업무 관련 수수료" /></h4>
				<h5><img src="../inc/img/txt/h5_savings_541.gif" alt="예금업무 관련 수수료" /></h5>
				<div class="tables type1 mb10">
					<table>
						<thead class="theads">
							<tr>
								<th>구분</th>
								<th>수수료<span class="bar"></span></th>
								<th>비고<span class="bar"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
								<td class="ta_l pl15">제증명서 발급 수수료</td>
								<td>1,000원/1부</td>
								<td class="ta_l pl15"><span class="notice">예금잔액증명서 등</span></td>
							</tr>
							<tr>
								<td class="ta_l pl15">통장 재발급 수수료</td>
								<td>1,000원/1부</td>
								<td class="ta_l pl15"><span class="notice">최초 계좌 개설시 수수료 없음</span></td>
							</tr>
							<tr>
								<td class="ta_l pl15">명의변경 수수료</td>
								<td>1,000원/1부</td>
								<td></td>
							</tr>
							<tr>
								<td class="ta_l pl15">현금(IC)카드 / 보안카드OTP 재발급수수료</td>
								<td>1,000원/1부</td>
								<td class="ta_l pl15"><span class="notice">최초 현금(IC)카드 발급수수료 없음</span></td>
							</tr>
							<tr>
								<td class="ta_l pl15">금융거래조회서</td>
								<td>10,000원/1부</td>
								<td></td>
							</tr>
							<tr>
								<td class="ta_l pl15">질권설정승낙서 발급 수수료<sup>주1)</sup></td>
								<td>5,000원/1부</td>
								<td></td>
							</tr>
						</tbody>
				...
				<span class="notice"><strong>주1)</strong> 질권설정승낙서는 당사"예적금담보대출"이 아닌 타금융기관을 위한 질권 설정시 승낙서입니다.</span>

				<h5 class="mt20"><img src="../inc/img/txt/h5_savings_542.gif" alt="송금수수료" /></h5>
				<div class="tables type1 mb20">
					<table>
						...
						<tbody class="tbodys">
							<tr>
								<td colspan="2">당행 본지점간</td>
								<td>면제</td>
							</tr>
							<tr>
								<td rowspan="2">타금융기관간</td>
								<td>100만원 이하</td>
								<td>1,000원/1부</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5">100만원 초과</td>
								<td>2,000원/1부</td>
							</tr>
						</tbody>
					</table>
				...
				<h5><img src="../inc/img/txt/h5_savings_543.gif" alt="인터넷뱅킹 송금수수료" /></h5>
				<div class="tables type1 mb20">
					<table>
						<colgroup>
							<col />
						...
						<tbody class="tbodys">
							...
							<tr>
								<td rowspan="2">타금융기관</td>
								<td>보통예금, 저스트보통예금</td>
								<td>500언/건</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5">저스트e-뱅킹예금</td>
								<td>면제</td>
							</tr>
						</tbody>
					</table>
				...
				<h5><img src="../inc/img/txt/h5_savings_544.gif" alt="자기앞수표 관련 수수료 및 보증금" /></h5>
				<div class="tables type1 mb20">
					<table>
						<colgroup>
							<col width="20%" />
						...
						<tbody class="tbodys">
							<tr>
								<td colspan="2">수표발행수수료</td>
								<td>면제</td>
								<td rowspan="10"></td>
							</tr>
							<tr>
								<td colspan="2" class="moreline">실시간 정보교환처리 수수료 <br />(현금화 수수료)</td>
								<td>1,000원/수표 1매</td>
							</tr>
							<tr>
								<td colspan="2">사고신고수수료</td>
								<td>1,000원/신고서 1부</td>
							</tr>
							<tr>
								<td colspan="2">부도처리수수료</td>
								<td>5,000원/수표 1매</td>
							</tr>
							<tr>
								<td colspan="2">미지급증명서 발급수수료</td>
								<td>2,000원/증명서 1부</td>
							</tr>
							<tr>
								<td rowspan="5">사고신고 보증금</td>
								<td>10만원 이하</td>
								<td>수표 권면금액의 40%/1매</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5">10만원 초과~100만원 이하</td>
								<td>수표 권면금액의 30%/1매</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5">100만원 초과~500만원 이하</td>
								<td>수표 권면금액의 25%/1매</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5">500만원 초과~1,000만원 이하</td>
								<td>수표 권면금액의 20%/1매</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5">1000만원 초과</td>
								<td>수표 권면금액의 15%/1매</td>
							</tr>
						</tbody>
					</table>
				</div>
