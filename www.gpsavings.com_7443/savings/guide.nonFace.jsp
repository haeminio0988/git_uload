...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/savings/guide.nonFace.jsp">비대면계좌개설안내</a></li>
				<li><a href="/savings/nonFace.fixed.deposit.jsp">비대면정기예금</a></li>
				<li><a href="/savings/nonFace.installment.savings.jsp">비대면정기적금</a></li>
				<li><a href="/savings/nonFace.free.deposit.jsp">비대면보통예금</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_savings_61.gif" alt="비대면계좌개설" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li ><a href="/savings/guide.rate.jsp">예금가이드</a></li>
							<li class="on"><a href="/savings/guide.nonFace.jsp">비대면계좌개설</a></li>
						
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 예금상품 &gt; 비대면계좌개설 &gt; <span >비대면계좌개설</span></div>
		</div>

		<div class="con_body saving large non face">
			<div class="box1">
				<h3 class="hiding"></h3>
				<p class="hiding"></p>
				<p style="height:70px;"></p>
				<h4><img src="../inc/img/txt/h4_savings_25.gif" alt="비대면계좌개설" /></h4>
				<p style="height:20px;"></p>
				
				<h6 class="mt20"><img src="../inc/img/txt/txt_utilization.gif" alt="이용대상" /></h6>
				<div class="tables type1 mb10">
					<table>
						...
						<thead class="theads">
							<tr>
								<th>구분<span class="bar"></span></th>
								<th>내용<span class="bar"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
							...
							<tr>
								<td>준비사항</td>
								<td style="border-top:1px solid #ccc6bc;color:#333; height:25px; line-height:25px; text-align:left; padding-left:15px; padding-top:8px; padding-bottom:8px;">
								- 신분증(주민등록증,운전면허증)</br>
								: 신분증이 심하게 훼손된 경우 비대면 실명확인(촬영방식) 인식이 어려울수 있습니다.</br>
								
								- 본인명의 휴대전화</br>
								
								- OTP(당행 혹은 타행OTP) : 전자금융(인터넷뱅킹 or 스마트폰뱅킹) 이용시 필수</br>
								<!-- : OTP 미소지시 인터넷뱅킹 사용이 어렵습니다.</br> -->
								</td>
							</tr>
							<tr>
								<td>이용시간</td>
								<td style="border-top:1px solid #ccc6bc;color:#333; height:25px; line-height:25px; text-align:left; padding-left:15px; padding-top:8px; padding-bottom:8px;">
								- 영상통화인증 : 09:00 ~ 17:00</br>
								- 소액이체인증 : 09:00 ~ 23:00</br>
								  (주말,공휴일 제외)
								</td>
							</tr>
							<tr>
								<td>개설가능상품</td>
								<td  style="border-top:1px solid #ccc6bc;color:#333; height:25px; line-height:25px; text-align:left; padding-left:15px; padding-top:8px; padding-bottom:8px;">
								1. 비대면 정기예금 <a href="/savings/nonFace.fixed.deposit.jsp"> <strong>[상품상세보기]</strong> </a></br>
								2. 비대면 정기적금 <a href="/savings/nonFace.installment.savings.jsp"> <strong>[상품상세보기]</strong> </a></br>
								3. 비대면 보통예금 <a href="/savings/nonFace.free.deposit.jsp"> <strong>[상품상세보기]</strong> </a></br>								
								</td>
							</tr>
							<tr>
								<td>유의사항</td>
								<td style="border-top:1px solid #ccc6bc;color:#333; height:25px; line-height:25px; text-align:left; padding-left:15px; padding-top:8px; padding-bottom:8px;">
								- 전자금융(인터넷뱅킹) 미가입 시 이체거래, 거래내역 확인 등 사용에 제약이 있으니 가급적 가입하여 주시기 바랍니다.(계좌개설 이후에도 가입 가능)</br>
								<!-- - 비대면실명확인 및 전자금융신청 완료 후 입출금 이체조회등을 위해서는 인터넷뱅킹 접속이 필요합니다. -->
								- 금융거래목적 확인 대상인 경우 계좌 개설이 불가능 할수 있습니다.</br>(1개월 이내 당/타행 요구불예금 계좌 1건이상 개설 등)</br>
								</td>
							</tr>							
						</tbody>
					</table>
				...
				<h6 class="mt20"><img src="../inc/img/txt/txt_useProcedure.gif" alt="이용절차" /></h6>
				<div class="tables type1 mb10">
					<table>
						<colgroup>
							<col width="15%" />
						...
						<thead class="theads">
							<tr>
								<th colspan="2">순서<span class="bar"></span></th>
								<th>내용<span class="bar"></span></th>
							</tr>
						</thead>
						<tbody class="tbodys">
							<tr>
								<td>APP 설치</td>
								<td>1</td>
								<td  style="text-align:left; padding-left:15px; ">구글 플레이 스토어에서 <strong >'SB톡톡'</strong>을 검색하세요. (iOS버전은 준비중입니다.)</td>
							</tr>
							<tr>
								<td rowspan="5">상품선택</br>및</br>인증</td>
								<td>2</td>
								<td style="text-align:left; padding-left:15px; ">은행선택 ( 지역 : [경기] -> <strong>[공평] 선택</strong> )</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5;">3</td>
								<td style="text-align:left; padding-left:15px; ">상품 ( 비대면정기예금, 비대면정기적금, 비대면보통예금 ) 선택</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5;">4</td>
								<td style="border-top:1px solid #ccc6bc;color:#333; height:25px; line-height:25px; text-align:left; padding-left:15px; padding-top:8px; padding-bottom:8px;">약관동의</br>
								: 해당 은행의 동의서 여부 확인</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5;">5</td>
								<td style="border-top:1px solid #ccc6bc;color:#333; height:25px; line-height:25px; text-align:left; padding-left:15px; padding-top:8px; padding-bottom:8px;">휴대전화 본인인증</br>
								: 통신사 선택 후 정보 입력</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5;">6</td>
								<td style="border-top:1px solid #ccc6bc;color:#333; height:25px; line-height:25px; text-align:left; padding-left:15px; padding-top:8px; padding-bottom:8px;">신분증 인증(촬영방식)</br>
								: 사진 촬영 자동으로 신분증 진위확인(스크래핑)
								</td>
							</tr>
							<tr>
								<td rowspan="3">정보입력</td>
								<td>7</td>
								<td style="text-align:left; padding-left:15px; ">고객정보 입력</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5;">8</td>
								<td style="text-align:left; padding-left:15px; ">상품약관 동의</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5;">9</td>
								<td style="text-align:left; padding-left:15px; ">가입상품정보 입력</td>
							</tr>
							<tr>
								<td rowspan="3">전자금융신청</br>및</br>추가인증</td>
								<td>10</td>
								<td style="text-align:left; padding-left:15px; ">전자금융신청(기존 인터넷뱅킹 미가입시 필수, 당/타행에 기 등록된 OTP 필요)</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5;">11</td>
								<td style="border-top:1px solid #ccc6bc;color:#333; height:25px; line-height:25px; text-align:left; padding-left:15px; padding-top:8px; padding-bottom:8px;">-영상통화 인증 : 평일 09:00~17:00 (통신 환경에 따라 데이터 이용료 발생 가능)</br>
								-소액이체 인증 : 평일 09:00~23:00 (고객이 지정한 계좌에서 당행이 지정한 계좌로 <strong>지정된 금액</strong>을 5일 이내에 이체)
								</td>
							</tr>
							<tr>
								<td style="border-left:1px solid #dfdbd5;">12</td>
								<td style="text-align:left; padding-left:15px; ">핀 번호(비밀번호) 입력('SB톡톡' APP 사용 시 필요 - 진행상황 확인 등)</td>
							</tr>
							<tr>
								<td>완료</td>
								<td>13</td>
								<td style="text-align:left; padding-left:15px; ">계좌개설 완료</td>
							</tr>							
						</tbody>
					</table>
				</div>
				
				<ul style="width:100%;" class="mt20">
					<li>OTP관리 유의사항</br>
					- OTP를 교체하신 경우 당행 인터넷뱅킹에서 변경 등록 후 사용하시기 바랍니다.(홈페이지>인터넷뱅킹>인터넷뱅킹관리>OTP온라인타기관등록)</br>
					- 단,OTP 교체를 위해서는 당행 인터넷뱅킹에 등록된 공인인증서가 필요합니다. OTP를 교체하시기 전 당행 인터넷뱅킹에 공인인증서를 등록(혹은 발급/재발급)하셨는지 필히 확인해주시기 바랍니다. 공인인증서 등록없이 OTP교체하신 경우 당행 영업점에 내점 하셔야 합니다.</br>
					- OTP 이체한도는 1회 최대 1억, 1일 최대 5억입니다. 이체한도 감액 설정은 당행 인터넷뱅킹에서 가능하나 증액을 위해서는 영업점을 내점하셔야 합니다.
					</li>
				</ul>
				
				<ul style="width:100%;" class="mt20">
					<li>이 예금은 예금자보호법에 따라 예금보험공사가 보호하되, 보호 한도는 본 상호저축은행에 있는 귀하의 모든 예금보호 대상 금융상품의 원금과 소정의 이자를 합하여 1인당 “최고 5천만원”이며, 5천만원을 초과하는 나머지 금액은 보호하지 않습니다.</li>
				</ul>
				<h5 class="mb45">공평저축은행 준법감시인 심의필 2017-003호 (2017.01.06)</h5>
			</div><!--//box1-->
		</div><!--//2030-->
