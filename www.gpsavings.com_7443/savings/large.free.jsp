...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 예금상품 &gt; 목돈마련상품 &gt; <span>자유적립예금</span></div>
		</div>

		<div class="con_body saving large free">
			<div class="box1">
				<h3 class="hiding">불입시기와 금액을 자유롭게 결정하실 수 있는 편리한 예금입니다.</h3>
				<p class="hiding">일정기간을 정하고 이자를 계산한 후 원금과 함께 지급하는 상품입니다.</p>
				<p style="height:70px;"></p>
				<h4><img src="../inc/img/txt/h4_savings_22.gif" alt="자유적립예금" /></h4>
				<!-- <h5><img src="../inc/img/txt/h5_savings_22.gif" alt="자유적립예금" /></h5> -->
				...
				<div class="tables type2">
					<table>
						...
						<tbody class="tbodys">
							...
							<tr>
								<th>납입금</th>
								<td>1000원 이상(계약기간내에서 자유롭게 납입)</td>
							</tr>
							<tr>
								<th>가입기간</th>
								<td>3개월 이상 24개월 이내(월단위)</td>
							</tr>
							<tr>
								<th>이율</th>
								<td>납기일로부터 만기 예치일까지 해당 기간별 정기예금 이율 적용</td>
							</tr>
						</tbody>
					</table>
				</div>
