...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/savings/free.normal.jsp">보통예금</a></li>
				<li><a href="/savings/free.just.jsp">저스트보통예금</a></li>
				<li><a href="/savings/free.just_ebk.jsp">저스트 e뱅킹 예금</a></li>
				<li><a href="/savings/free.gen_saving.jsp">아낌없이 주는 저축예금</a></li>
				<li><a href="/savings/free.gen_comp.jsp">아낌없이 주는 기업자유예금</a></li>
				<li><a href="/savings/nonFace.free.deposit.jsp">비대면 보통예금</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_savings_11.gif" alt="입출금자유상품" /></h2>
			
						
				<div class="tab_menu">
					<ul>
						
							<li class="on"><a href="/savings/free.normal.jsp">입출금자유상품</a></li>
			...
			<div class="navi">홈 &gt; 예금상품 &gt; 입출금자유상품 &gt; <span>저스트 e뱅킹 예금</span></div>
		</div>

		<div class="con_body saving just_ebk">
			<div class="box1">
				...
				<h4><img src="../inc/img/txt/h4_savings_13.gif" alt="저스트 보통예금" /></h4>
				...
				<div class="tables type2 set2">
					<table>
						...
						<tbody class="tbodys">
							<tr>
								<th>상품성격</th>
								<td>입출금이 자유로운 보통예금</td>
							</tr>
							<tr>
								<th>가입대상</th>
								<td>인터넷뱅킹 거래고객&#40;1인1계좌&#41;</td>
							</tr>
							<tr>
								<th>가입방법</th>
								<td>가까운 지점 방문 → 인터넷뱅킹 신청 + <strong>저스트 e뱅킹 예금</strong>에 가입</td>
							</tr>
							<tr>
								<th>거래요건</th>
								<td>신규계좌 가입 후 인터넷뱅킹으로만 입출금 거래 가능</td>
							</tr>
							<tr>
								<th>수수료 면제</th>
								<td>인터넷뱅킹 모든 수수료 면제</td>
							</tr>
							<tr>
								<th>이율 및 적용 방법</th>
								<td class="moreline" style="padding:0;">
									<table style="width:100%;">
										<tr>
											 <td style="width:35%; border-right:1px solid #ccc6bc;">개인</td>
											 <td>연 0.2&#37;</td>
										 </tr>
										<tr>
											 <td style="border-right:1px solid #ccc6bc;">법인 / 사업자</td>
											 <td>연 0.2&#37;</td>
										</tr>
								  </table>
							...
							<tr>
								<th>이자지급시기</th>
								<td>분기별&#40;3, 6, 9, 12월&#41;로 이자를 세금 공제한 후 원금에 가산함</td>
							</tr>
							<tr>
								<th>증빙서류</th>
								<td>실명확인증표/사업자등록증</td>
							...
							<tr>
								<th class="moreline">상품출시 이전<br />인터넷 거래고객의<br />보통예금 계좌</th>
								<td class="moreline">인터넷 뱅킹 거래고객의 보통예금계좌는 2012년 3월 26일 기준으로 1인 1계좌에 한해 일괄적으로 <strong>저스트 e-뱅킹</strong>으로 전환됨.</td>
							</tr>
						</tbody>
					</table>
				</div>
