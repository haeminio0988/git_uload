	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				...
				<li><a href="/savings/nonFace.fixed.deposit.jsp">비대면 정기예금</a></li>
				<li><a href="/savings/nonFace.installment.savings.jsp">비대면 정기적금</a></li>
				<li><a href="/savings/nonFace.free.deposit.jsp">비대면 보통예금</a></li>
			</ul>
			...
			<div class="navi">홈 &gt; 예금상품 &gt; 비대면계좌개설 &gt; <span>비대면정기예금</span></div>
		</div>
		...
		<div class="con_body saving large non face">
			<div class="box1">
				<h3 class="hiding">예치금액, 예치기간 제한없이 입출금이 자유로운 예금입니다.</h3>
				<p class="hiding">인터넷뱅킹 거래 전용 상품으로 해당계좌 3개월 평균 잔액에 따라 최고 연2.5%의 높은 이율이 적용되는 입출금이 자유로운 보통예금상품 입니다.</p>
				<p style="height:70px;"></p>
				<h4><img src="../inc/img/txt/h4_savings_26.gif" alt="비대면정기예금" /></h4>
				<!-- <h5><img src="../inc/img/txt/h5_savings_13.gif" alt="저스트 보통예금 안내" /></h5> -->
				<p style="height:50px"></p>
				<h6><img src="../inc/img/txt/txt_join.gif" alt="가입조건" /></h6>
				<div class="tables type2 set2">
					<table>
						<colgroup>
							<col width="193px" />
							<col />
						...
						<tbody class="tbodys">
							...
							<tr>
								<th>가입방법</th>
								<td><a href="/savings/guide.nonFace.jsp">'비대면 계좌개설 안내' 화면 참고 <strong>[바로가기]</strong></a></td>
							</tr>
							<tr>
								<th>이율 및 적용 방법</th>
								<td class="moreline" style="padding:0;">
									<table style="width:100%;">
										
										<tr>
											<td style="width:35%; border-right:1px solid #ccc6bc;">1개월 ~ 3개월미만</td>
											<td>연 1.8%</td>
										</tr>
										<tr>
											<td style="width:35%; border-right:1px solid #ccc6bc;">3개월 ~ 6개월미만</td>
											<td>연 1.8%</td>
										</tr>
										<tr>
											<td style="width:35%; border-right:1px solid #ccc6bc;">6개월 ~ 12개월미만</td>
											<td>연 1.9%</td>
										</tr>
										<tr>
											<td style="width:35%; border-right:1px solid #ccc6bc;">12개월이상~18개월미만</td>
											<td>연 2.40&#37;</td>
										</tr>
										<tr>
											<td style="width:35%; border-right:1px solid #ccc6bc;">18개월이상~24개월미만</td>
											<td>연 2.40&#37;</td>
										</tr>
										<tr>
											<td style="width:35%; border-right:1px solid #ccc6bc;">24개월</td>
											<td>연 2.50&#37;</td>
										</tr>
							...
							<tr>
								<th>이자지급시기</th>
								<td>단리식 : 매월 이자를 계산하여 세금을 공제한 후 지급<br>복리식 : 만기시 이자를 계산하여 세금을 공제한 후 지급</td>
							</tr>
						</tbody>
					</table>
				</div>
