...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
<!-- 				<li><a href="/savings/tax.preference.jsp">세금우대상품</a></li> -->
				<li><a href="/savings/tax.free.jsp">비과세상품</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_savings_41.gif" alt="목돈마련상품" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/savings/tax.free.jsp">절세혜택</a></li>
			...
			<div class="navi">홈 &gt; 예금상품 &gt; 절세혜택상품 &gt; <span>비과세상품</span></div>
		</div>
		<div class="con_body saving tax free">
			<div class="box1">
				<h3 class="hiding">조세특례제한법 제88조의2에 의해 일정한 자격이 있는 경우 이자소득세가 전액 면제되는 생계형저축입니다.</h3>
				<p style="height:70px;"></p>
				<h4><img src="../inc/img/txt/h4_savings_42.gif" alt="비과세상품" /></h4>
				<!-- <h5><img src="../inc/img/txt/h5_savings_42.gif" alt="비과세상품 안내" /></h5> -->
				<p style="height:50px;"></p>
				<h6><img src="../inc/img/txt/txt_join.gif" alt="가입조건" /></h6>
				<div class="tables type2 set2 mb20">
					<table>
						<colgroup>
							<col width="141px"/>
							<col />
						...
						<tbody class="tbodys">
							<tr>
								...
								<td class="moreline">
									<ul>
										<li>거주자인 남/여 만 63세 이상</li>
										<li>장애인 복지법 제 29조의 규정에 의하여 등록한 장애인</li>
										<li>국가유공자 등 대우 및 지원에 관한 법률 제 6조의 규정에 의하여 등록된 상이자</li>
										<li>국민기초생활보장법 제 2조 2호의 규정에 의한 수급자(손년소녀가장 등)</li>
										<li>독립유공자 예우에 관한 법률 제 6조의 규정에 의한 독립유공자와 그 유족 및 가족</li>
										<li>고엽제후유증환자 및 5.18민주화운동 부상자</li>
									</ul>
								</td>
							</tr>
							<tr>
								<th>계약기간</th>
								<td>제한없이 만기해지, 중도해지, 이자지급시 이자소득세 전액 비과세</td>
							</tr>
							<tr>
								<th>저축한도</th>
								<td>
							...
							<tr>
								...
								<td class="moreline">
									<ul>
										<li>남/여자 만 63세 이상 - 신분증</li>
										<li>장애인 - 장애인 등록증 또는 복지카드</li>
										<li>생활보호 대상자 - 수급자 증명서</li>
										<li>독립유공자와 그 유족 및 가족 - 독립유공자증, 유족증, 국가유공자 확인원</li>
									</ul>
								</td>
							</tr>
						</tbody>
				...
				<h6><img src="../inc/img/txt/txt_guide.gif" alt="상품안내" /></h6>
					...
					<table>
						...
						<tbody class="tbodys">
							<tr>
								<th>정기적금</th>
								<td class="moreline">
									일정 기간과 불입금액을 정하여 정기적으로 적금을 납입하고 해지 시 가입 고객에게 불입금 총액과 일정한 이자를 지급하는 목돈마련 상품입니다.
								</td>
							</tr>
							<tr>
								<th>자유적립예금</th>
								<td class="moreline">
									불입시기와 금액을 자유로이 결정하실 수 있는 편리한 예금이며 일정한 기간을 정하고 금액 및 횟수에 제한 없이 자유롭게 부금을 납입하여 만기에 월 복리로 이자를 계산한 후 원금과 함께 지급하는 상품입니다.
								</td>
							</tr>
							<tr>
								<th>정기예금</th>
								<td>
									일정기간 여유자금을 예금하시면 확정 금리로 높은 수익을 드리는 상품입니다.
								</td>
							</tr>
						</tbody>
					</table>
				</div>
				<ul style="width:100%" class="mt30">
