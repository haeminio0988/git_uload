...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/savings/guide.rate.jsp">예금금리안내</a></li>
				<li><a href="/savings/guide.clause.jsp">예금거래기본약관</a></li>
				<li><a href="/savings/guide.document.jsp">예금거래시 필요서류</a></li>
				<li><a href="/savings/guide.commission.jsp">예금업무 관련 수수료</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_savings_51.gif" alt="예금가이드" /></h2>
			
						
				<div class="tab_menu">
					<ul>
						
							<li ><a href="/savings/free.normal.jsp">입출금자유상품</a></li>
							<li ><a href="/savings/large.installment.jsp">목돈마련상품</a></li>
							<li ><a href="/savings/large.fixed.jsp">목돈운용상품</a></li>
							<li ><a href="/savings/tax.free.jsp">절세혜택</a></li>
							<li class="on"><a href="/savings/guide.rate.jsp">예금가이드</a></li>
							<li ><a href="/savings/guide.nonFace.jsp">비대면계좌개설</a></li>
						
					</ul>
				</div>
			
			<div class="navi">홈 &gt; 예금상품 &gt; 예금가이드 &gt; <span>예금거래기본약관</span></div>
		</div>
		<div class="con_body saving guide clause">
			<div class="box1">
				<h4><img src="../inc/img/txt/h4_savings_52.gif" alt="예금거래기본약관" /></h4>
				<h5><img src="../inc/img/txt/h5_savings_521.gif" alt="예금거래기본약관" /></h5>
				<p class="mb35">이 예금거래기본약관(이하 “약관”이라 한다)은 ㈜공평저축은행과 거래처(또는 예금주)가 서로믿음을 바탕으로 예금거래를 빠르고 틀림 없이 처리하는 한편, 서로의 이해관계를 합리적으로 조정하기 위해 기본적이고 일반적인 사항을 정한 것이다.
				상호저축은행은 이 약관을 영업점에 놓아두고, 거래처는 영업시간 중 언제든지 이 약관을 볼 수 있고 또한 그 교부를 청구할 수 있다.</p>
				<div class="term">
					<ul>
						<li><a href="#제1조"><img src="../inc/img/txt/li_saving.guide.clause01.gif" alt="제1조 적용범위" /></a></li>
						<li><a href="#제2조"><img src="../inc/img/txt/li_saving.guide.clause02.gif" alt="제2조 실명거래" /></a></li>
						<li><a href="#제3조"><img src="../inc/img/txt/li_saving.guide.clause03.gif" alt="제3조 거래장소" /></a></li>
						<li><a href="#제4조"><img src="../inc/img/txt/li_saving.guide.clause04.gif" alt="제4조 거래방법" /></a></li>
						<li><a href="#제5조"><img src="../inc/img/txt/li_saving.guide.clause05.gif" alt="제5조 인감과 비밀번호 등의 신고" /></a></li>
						<li><a href="#제6조"><img src="../inc/img/txt/li_saving.guide.clause06.gif" alt="제6조 입금" /></a></li>
						<li><a href="#제7조"><img src="../inc/img/txt/li_saving.guide.clause07.gif" alt="제7조 예금이 되는 시기" /></a></li>
						<li><a href="#제8조"><img src="../inc/img/txt/li_saving.guide.clause08.gif" alt="제8조 증권의 부도" /></a></li>
						<li><a href="#제9조"><img src="../inc/img/txt/li_saving.guide.clause09.gif" alt="제9조 이자" /></a></li>
						<li><a href="#제10조"><img src="../inc/img/txt/li_saving.guide.clause10.gif" alt="제10조 지급이나 해지청구" /></a></li>
					</ul>
					<ul>
						<li><a href="#제11조"><img src="../inc/img/txt/li_saving.guide.clause11.gif" alt="제11조 지급시기" /></a></li>
						<li><a href="#제12조"><img src="../inc/img/txt/li_saving.guide.clause12.gif" alt="제12조 양도 및 질권설정" /></a></li>
						<li><a href="#제13조"><img src="../inc/img/txt/li_saving.guide.clause13.gif" alt="제13조 사고, 변경사항의 신고" /></a></li>
						<li><a href="#제14조"><img src="../inc/img/txt/li_saving.guide.clause14.gif" alt="제14조 통장, 카드의 재발급 등" /></a></li>
						<li><a href="#제15조"><img src="../inc/img/txt/li_saving.guide.clause15.gif" alt="제15조 통지방법 및 효력" /></a></li>
						<li><a href="#제16조"><img src="../inc/img/txt/li_saving.guide.clause16.gif" alt="제16조 면책" /></a></li>
						<li><a href="#제17조"><img src="../inc/img/txt/li_saving.guide.clause17.gif" alt="제17조 수수료" /></a></li>
						<li><a href="#제18조"><img src="../inc/img/txt/li_saving.guide.clause18.gif" alt="제18조 오류처리 등" /></a></li>
						<li><a href="#제19조"><img src="../inc/img/txt/li_saving.guide.clause19.gif" alt="제19조 예금의 비밀보장" /></a></li>
						<li><a href="#제20조"><img src="../inc/img/txt/li_saving.guide.clause20.gif" alt="제20조 약관 변경" /></a></li>
					</ul>
					<ul>
						<li><a href="#제21조"><img src="../inc/img/txt/li_saving.guide.clause21.gif" alt="제21조 약관적용의 우선순서" /></a></li>
						<li><a href="#제22조"><img src="../inc/img/txt/li_saving.guide.clause22.gif" alt="제22조 이의제기" /></a></li>
					</ul>
				</div>
				<div class="clause_box" id="제1조">
					<h6>제1조 적용범위</h6>
					<p>이 약관은 저축은행과 거래처 사이의 모든 예금거래(이하 '거래'라 한다)에 입출금이 자유로운 예금약관, 거치식, 적립식예금약관과 함께 적용한다.</p>
				</div>
				<div class="clause_box" id="제2조">
					<h6>제2조 실명거래</h6>
					<ol>
						<li><strong>01.</strong><span>거래처는 실명으로 거래하여야 한다.</span></li>
						<li><strong>02.</strong><span>저축은행은 거래처의 실명을 확인하기 위해 주민등록증,사업자등록증 등 실명확인증표 또는 그밖에 필요한 서류의 제시나 제출을 요구할 수 있으며, 거래처는 이에 따라야 한다.</span></li>
					</ol>
				</div>
				<div class="clause_box" id="제3조">
					<h6>제3조 거래장소</h6>
					<p>거래처는 예금계좌를 개설한 영업점(이하 '개설점' 이라 한다)에서 모든 예금거래를 한다. 다만, 저축은행이 정하는 바에 따라 다른 영업점이나 다른 금융기관 또는 현금자동지급기, 현금 자동입/출금기, 컴퓨터, 전화기 등(이하 '전산통신기기'라 한다)을 통해 거래할 수 있다.</p>
				</div>
				<div class="clause_box" id="제4조">
					<h6>제4조 거래방법</h6>
					<p>거래처는 저축은행에서 내준 통장(증서, 전자통장을 포함한다) 또는 어음으로 거래해야 한다. 그러나 입금할 때와 자동이체, 전산통신기기 이용약정 등에 따라 거래할 때에는 통장 없이도 거래할 수 있다</p>
				</div>
				<div class="clause_box" id="제5조">
					<h6>제5조 인감과 비밀번호등의 신고</h6>
					<ol>
						<li><strong>01.</strong><span>거래처는 거래를 시작할 때 인감 또는 서명, 비밀번호, 성명, 상호, 대표자명, 대리인명, 주소 등 거래에 필요한 사항을 신고해야 한다. 다만, 거치식, 적립식 예금은 비밀 번호를 신고하지 않을 수 있다. </span></li>
						<li><strong>02.</strong><span>거래처는 인감과 서명을 함께 신고할 수 있으며, 이 경우에는 거래 시마다 서명 또는 인감을 선택하여 사용할 수 있다.</span></li>
					</ol>
				</div>
				<div class="clause_box" id="제6조">
					<h6>제6조 입금</h6>
					<ol>
						<li><strong>01.</strong><span>거래처는 현금이나 곧 추심할 수 있는 수표, 어음, 기타증권(이하 '증권'이라 한다)으로 입금할 수 있다. </span></li>
						<li><strong>02.</strong><span>거래처는 현금이나 증권으로 계좌송금(거래처가 개설점 이외에서 자기계좌에 입금하거나, 제3자가 개설점 또는 다른 영업점이나, 다른 금융기관에서 거래처계좌에 입금하는 것)하거나, 계좌이체(다른 계좌에서 거래처계좌에 입금하는 것)를 할 수 있다.</span></li>
						<li><strong>03.</strong><span>증권으로 입금할 때 입금인은 증권의 백지보충이나 배서 또는 영수기명날인 등 필요한 절차를 밟아야 하며, 저축은행은 백지보충 등의 의무를 지지 않는다.</span></li>
						<li><strong>04.</strong><span>입금하는 증권이 수표나 어음일 때 저축은행은 부기금액과 상관없이 주 금액란에 적힌 금액으로 처리한다.</span></li>
					</ol>
				</div>
				<div class="clause_box" id="제7조">
					<h6>제7조 예금이 되는 시기</h6>
					<ol>
						<li><strong>01.</strong><span>제6조에 따라 입금한 경우 다음 각 호의 시기에 예금이 된다.
							<ol>
								<li><strong>a.</strong><span>현금으로 입금했을 경우: 다음 각 호의 시기에 예금이 된다.</span></li>
								<li><strong>b.</strong><span>현금으로 계좌 송금하거나 또는 계좌 이체한 경우: 예금원장에 입금의 기록을 한 때</span></li>
								<li><strong>c.</strong><span>증권으로 입금하거나 계좌 송금한 경우: 저축은행이 그 증권을 교환에 돌려 결제시간 연장없이 부도반환 시한이 지나고 저축은행이 결제를 확인한 때</span></li>
							</ol>
						</span></li>
						<li><strong>02.</strong><span>제1항 제3호에도 불구하고 증권이 자기앞수표로서 지급제시기간 이내에 사고신고가 없으며 결제될 것이 틀림없음을 저축은행이 확인한 경우에는 예금원장에 입금의 기록이 된 때 예금이 된다.</span></li>
						<li><strong>03.</strong><span>저축은행은 특별한 사정이 없는 한 제1항 및 제2항의 확인 또는 입금기록을 신속히 하여야 한다.</span></li>
					</ol>
				</div>
				<div class="clause_box" id="제8조">
					<h6>제8조 증권의 부도</h6>
					<ol>
						<li><strong>01.</strong><span>제6조 제1항에 따라 입금한 증권이 지급거절 되었을 때에는 저축은행은 그 금액을 예금원장의 잔액에서 뺀 뒤, 거래처 (무통장입금일 때는 입금의뢰인)가 신고한 연락처로 그 사실을 알린다. 다만, 통화불능 등 부득이한 사유로 그 사실을 알릴 수 없는 경우에는 그러하지 아니하다.</span></li>
						<li><strong>02.</strong><span>저축은행은 지급거절 된 증권을 그 권리보전절차를 밟지 아니하고, 입금한 영업점에서 거래처(무통장입금일 때는 입금의뢰인)가 반환 청구할 때 돌려준다. 다만, 증권발행인이 지급 거절한 날의 다음 영업일 까지 증권을 입금한 예금계좌에 해당자금을 현금이나 즉시 현금으로 바꿀 수 있는 증권으로 입금했을 때는 발행인에게 돌려줄 수 있다.</span></li>
					</ol>
				</div>
				<div class="clause_box" id="제9조">
					<h6>제9조 이자</h6>
					<ol>
						<li><strong>01.</strong><span>이자는 원을 단위로, 약정한 예치기간 또는 제7조에 따라 예금이 된 날(자기앞수표, 가계수표는 입금일)부터 지급일 전날까지 기간에 대해 저축은행이 정한 이율로 셈한다. </span></li>
						<li><strong>02.</strong><span>저축은행은 예금 별 이율을 적은 예금 이율표를 영업점에 놓아두거나 게시하며, 이율을 바꾼 때는 그 바꾼 내용을 영업점에 1개월 동안 게시한다.</span></li>
						<li><strong>03.</strong><span>제2항에 따라 이율을 바꾼 때에는, 입출금이 자유로운 예금은 바꾼 날부터 바꾼 이율을 적용하며, 거치식·적립식예금은 계약 당시의 이율을 적용함을 원칙으로 하되, 변동금리가 적용되는 예금은 바꾼 날로부터 바꾼 이율을 적용한다.</span></li>
						<li><strong>04.</strong><span>거래처가 실제 받는 이자는 제1항에 따라 셈한 이자에서 소득세법 등 관계법령에 따라 원천징수한 세액을 뺀 금액이다.</span></li>
					</ol>
				</div>
				<div class="clause_box" id="제10조">
					<h6>제10조 지급이나 해지청구</h6>
					<ol>
						<li><strong>01.</strong><span>거래처가 통장으로 예금·이자를 찾거나 예금계약을 해지하고자 할 때는 신고한 비밀번호 등 필요한 사항을 적고, 거래인감을 날인하거나 서명감과 일치하게 서명한 지급 또는 해지청구서를 제출하여야 한다. </span></li>
						<li><strong>02.</strong><span>거래처가 자동이체, 전산통신기기 등을 이용하여 예금이나 이자를 찾을 때는 그 약관 또는 약정에서 정한 바에 따른다. </span></li>
					</ol>
				</div>
				<div class="clause_box" id="제11조">
					<h6>제11조 지급시기</h6>
					<ol>
						<li><strong>01.</strong><span>입출금이 자유로운 예금은 거래처가 찾을 때 지급한다.</span></li>
						<li><strong>02.</strong><span>거치식, 적립식예금은 만기일 이후에 거래처가 찾을 때 지급한다.</span></li>
					</ol>
				</div>
				<div class="clause_box" id="제12조">
					<h6>제12조 양도 및 질권설정</h6>
					<ol>
						<li><strong>01.</strong><span>거래처가 예금을 양도하거나 질권설정 하려면 사전에 저축은행에 통지하고 동의를 받아야 한다. 다만, 법령으로 금지한 경우에는 양도나 질권설정을 할 수 없다. </span></li>
						<li><strong>02.</strong><span>입출금이 자유로운 예금은 질권설정 할 수 없다. </span></li>
					</ol>
				</div>
				<div class="clause_box" id="제13조">
					<h6>제13조 사고, 변경사항의 신고</h6>
					<ol>
						<li><strong>01.</strong><span>거래처는 통장, 도장, 카드 또는 증권이나 그 용지를 분실, 도난, 멸실, 훼손했을 때는 곧 서면으로 신고하여야 한다. 다만, 긴급하거나 부득이할 때는 영업시간 중에 전화 등으로 신고할 수 있으며 이 때는 다음 영업일 이내에 서면신고 하여야 한다. </span></li>
						<li><strong>02.</strong><span>거래처는 인감 또는 서명, 비밀번호, 성명, 상호, 대표자명, 대리인명, 주소, 전화번호 기타 신고사항을 바꿀 때는 서면으로 신고하여야 한다.</span></li>
						<li><strong>03.</strong><span>제1항 및 제2항의 신고는 저축은행이 이를 접수한 뒤 전산입력 등 필요한 조치를 하는데 걸리는 합리적인 시간이 지나면 그 효력이 생기며 전산장애 등 불가항력적인 사유로 처리하지 못한 때는 복구 등 사유 해제 시 즉시 처리하여야 한다.</span></li>
						<li><strong>04.</strong><span>제1항의 신고를 철회할 때는 거래처 본인이 직접 서면으로 하여야 한다. </span></li>
					</ol>
				</div>
				<div class="clause_box" id="제14조">
					<h6>제14조 통장, 카드의 재발급 등</h6>
					<p>제13조에 따라 통장, 도장, 카드에 대한 사고신고가 있을 때에는 저축은행은 신고인이 거래처 본인임을 확인하는 등 필요한 조치를 마친 뒤에 재발급하거나 지급한다. </p>
				</div>
				<div class="clause_box" id="제15조">
					<h6>제15조 통지방법 및 효력</h6>
					<ol>
						<li><strong>01.</strong><span>저축은행은 오류의 정정 등 예금거래에서 발생하는 일반적 사항을 통보하는 경우에는 거래처가 신고한 주소지 또는 연락처로 서면 또는 전화로 통보한다. <개정 2013.5.31></span></li>
						<li><strong>02.</strong><span>저축은행이 예금거래에서 발생하는 일반적 사항을 서면으로 통지했을 때는 천재지변 등 불가항력적인 경우 외에는 보통의 우송기간이 지났을 때는 도달한 것으로 본다.</span></li>
						<li><strong>03.</strong><span>관계법령 또는 어음교환소규약 등에 의해 예금계약을 해지한 경우 외에 저축은행이 임의로 예금을 해지하기 위해 서면 통지하는 등 중요한 의사표시의 경우는 그 통지가 거래처에 도달되어야 의사표시의 효력이 생긴다. 다만, 거래처가 제13조에 의하여 변경신고를 게을리하여 도달되지 않은 때에는 그러하지 아니하다. </span></li>
					</ol>
				</div>
				<div class="clause_box" id="제16조">
					<h6>제16조 면책</h6>
					<ol>
						<li><strong>01.</strong><span>저축은행은 예금지급청구서, 증권 또는 신고서 등에 찍힌 인영(또는 서명)을 신고한 인감(또는 서명감)과 육안으로 주의 깊게 비교, 대조하여 틀림없다고 여기고, 예금지급청구서 등에 적힌 비밀번호가 신고한 것과 같아서 예금을 지급하였거나 기타 거래처가 요구하는 업무를 처리하였을 때에는 인감 이나 서명의 위조, 변조 또는 도용이나 그 밖의 다른 사고로 인하여 거래처에 손해가 생겨도 그 책임을 지지 않는다. 다만, 저축은행이 거래처의 인감이나 서명에 관한 위조, 변조 또는 도용된 사실을 알았거나 알 수 있었을 때는 그러하지 아니하다. </span></li>
						<li><strong>02.</strong><span>전산통신기기 등을 이용하거나 거래정보 등의 제공 및 금융거래명세 등의 통보와 관련하여 저축은행이 책임질 수 없는 사유로 계좌번호, 비밀번호 등의 금융정보가 새어나가 거래처에 손해가 생겨도 저축은행은 그 책임을 지지 않는다.</span></li>
						<li><strong>03.</strong><span>저축은행이 주민등록증 등 실명확인증표로 주의 깊게 실명 확인하거나 실명 전환한 계좌는 거래처가 실명확인증표 또는 서류의 위조, 변조, 도용 등을 한 경우 이로 인하여 거래처에 손해가 생겨도 저축은행은 그 책임을 지지 않는다.</span></li>
						<li><strong>04.</strong><span>거래처가 제13조 제1항, 제2항, 제4항의 신고나 절차를 미루어 생긴 손해에 대해 저축은행은 그 책임을 지지 않는다. 다만, 이 경우에도 저축은행은 거래처에 손해가 발생하지 않도록 선량한 관리자로서의 주의를 다하여야 한다. </span></li>
					</ol>
				</div>
				<div class="clause_box" id="제17조">
					<h6>제17조 수수료</h6>
					<ol>
						<li><strong>01.</strong><span>거래처가 개설점 아닌 다른 영업점이나 다른 금융기관 또는 전산통신기기 등을 통해 거래할 때 저축은행은 온라인수수료나 추심수수료 등을 받을 수 있다. </span></li>
						<li><strong>02.</strong><span>저축은행은 제1항의 경우 외에도 거래처가 잔액증명서발급, 통장 재발행 등을 원하거나 거래처 잘못으로 통장 재발행 등을 요청하는 경우 그 사무처리와 관련하여 수수료를 받을 수 있다.</span></li>
						<li><strong>03.</strong><span>제1항, 제2항과 관련한 수수료 표는 영업점에 놓아두거나 게시한다.</span></li>
					</ol>
				</div>
				<div class="clause_box" id="제18조">
					<h6>제18조 오류처리등</h6>
					<ol>
						<li><strong>01.</strong><span>저축은행이 예금원장이나 통장거래내용을 사실과 다르게 처리했을 때는, 이를 확인하여 바르게 고치고 그 사실을 거래처에 통지하여야 한다. </span></li>
						<li><strong>02.</strong><span>거래처는 거래를 마친 때 그 내용이 맞는가를 확인하고, 거래내용이 사실과 다를 때는 바르게 고칠 것을 요구할 수 있으며, 저축은행은 그 사실을 확인하고 바르게 처리하여야 한다. </span></li>
					</ol>
				</div>
				<div class="clause_box" id="제19조">
					<h6>제19조 예금의 비밀보장</h6>
					<ol>
						<li><strong>01.</strong><span>저축은행은 금융실명 거래 및 비밀 보장에 관한 법률 등 법령에서 정한 경우를 제외하고는 거래처의 거래내용에 대한 자료나 정보를 남에게 제공하지 않는다. </span></li>
						<li><strong>02.</strong><span>저축은행은 거래처가 전화 등으로 무통장입금(송금 포함), 예금잔액 등에 관한 정보의 제공을 요청한 때는 명의인, 계좌번호, 비밀번호(자동응답서비스(ARS)는 계좌번호·비밀번호)가 맞으면 그 요청자를 본인으로 여겨 입금인, 입금액, 예금잔액 등에 관한 정보를 제공할 수 있으며, 이로 인하여 금융거래 정보 누설 등으로 거래처에 손해가 생겨도 그 책임을 지지 않는다.</span></li>
					</ol>
				</div>
				<div class="clause_box" id="제20조">
					<h6>제20조 약관변경</h6>
					<ol>
						<li><strong>01.</strong><span>상호저축은행은 이 약관이나 입출금이 자유로운 예금약관 또는 거치식․적립식 예금약관 및 기타 약관을 변경하고자 하는 경우 변경예정일 직전 1개월간 상호저축은행의 영업점 및 인터넷 홈페이지 등에 변경내용을 게시하여 예금주에게 알려야 한다. 다만, 법령의 개정이나 제도의 개선 등으로 긴급히 약관을 변경한 때에는 즉시 이를 게시(최소 1개월이상)하여야 한다. <개정 2013.5.31></span></li>
						<li><strong>02.</strong><span>제1항의 약관변경 내용이 예금주에게 불리하게 변경된 경우 제1항의 게시 외에 상호저축은행은 서면•전자우편 등 예금주와 사전에 합의한 방법으로 변경 전 최소 1개월 전까지(제1항 단서의 경우 즉시) 개별통지 하여야 한다. 다만, 기존 예금주에게 변경 전 내용이 그대로 적용되는 경우 또는 예금주가 변경내용에 대한 통지를 받지 아니하겠다는 의사를 명시적으로 표시한 경우에는 그러하지 아니한다. <신설 2013. 5.31></span></li>
						<li><strong>03.</strong><span>상호저축은행은 제1항의 게시 또는 제2항의 통지를 할 경우 “예금주가 변경에 동의하지 아니한 경우 제1항의 게시 또는 제2항의 통지를 받은 날로부터 1개월 이내에 서면에 의한 이의를 제기하거나 계약을 해지할 수 있으며, 서면에 의한 이의 또는 계약해지의 의사표시를 하지 아니한 경우에는 변경에 동의한 것으로 본다”라는 취지의 내용을 함께 게시 또는 통지하여야 한다. <신설 2013.5.31></span></li>
						<li><strong>04.</strong><span>제1항의 게시 또는 제2항의 통지(제3항의 게시•통지내용 포함)를 받은 날로부터 1개월 이내에 예금주의 서면에 의한 이의 또는 계약해지의 의사표시가 상호저축은행에 도달하지 않은 때에는 예금주가 변경에 동의한 것으로 본다. <신설 2013.5.31></span></li>
						<li><strong>05.</strong><span>상호저축은행은 약관을 영업점에 비치 또는 게시하여 예금주가 요구할 경우 약관 사본을 교부하여야 한다.<신설 2013.5.31.></span></li> 
					</ol>
					<!--<p>제13조에 따라 통장, 도장, 카드에 대한 사고신고가 있을 때에는 저축은행은 신고인이 거래처 본인임을 확인하는 등 필요한 조치를 마친 뒤에 재발급하거나 지급한다. </p>-->
				</div>
				<div class="clause_box" id="제21조">
					<h6>제21조 약관적용의 우선순서</h6>
					<ol>
						<li><strong>01.</strong><span>저축은행과 거래처 사이에 개별적으로 합의한 사항이 약관조항과 다를 때는 그 합의사항을 약관에 우선하여 적용한다. </span></li>
						<li><strong>02.</strong><span>이 약관에 정한 사항과 입출금이 자유로운 예금약관 또는 거치식, 적립식 예금약관에서 정한 사항이 다를 때는 입출금이 자유로운 예금약관이나 거치식, 적립식 예금약관을 먼저 적용한다. </span></li>
						<li><strong>03.</strong><span>이 약관과 입출금이 자유로운 예금약관 또는 거치식·적립식 예금약관에서 정하지 않은 사항은 따로 약정이 없으면 관계법령, 어음교환소규약을 적용한다. </span></li>
					</ol>
				</div>
				<div class="clause_box" id="제22조">
					<h6>제22조 이의제기</h6>
					<p>거래처는 저축은행과 거래에 이의가 있을 때 저축은행의 분쟁처리기구에 해결을 요구하거나 금융분쟁조정위원회 등을 통해 분쟁조정을 신청할 수 있다. </p>
				</div>
			</div>
		</div>
	</div>
