...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 예금상품 &gt; 입출금자유상품 &gt; <span>저스트 보통예금</span></div>
		</div>

		<div class="con_body saving just">
			<div class="box1">
				<h3 class="hiding">가입조건, 거래조건, 예치한도 없음! 예치금액에 관계없이 하루만 맡겨도 연 2.0% 이자율</h3>
				<p style="height:70px"></p>
				<h4><img src="../inc/img/txt/h4_savings_12.gif" alt="저스트 보통예금" /></h4>
				<!-- <h5><img src="../inc/img/txt/h5_savings_12.gif" alt="저스트 보통예금 안내" /></h5> -->
				...
				<div class="tables type2 set2">
					<table>
						...
						<tbody class="tbodys">
							...
							<tr>
								<th>이자지급</th>
								<td style="letter-spacing:-1px;">분기별&#40;3, 6, 9, 12월&#41;이자를 계산하여 세금을 공제한 후 원금에 가산</td>
							</tr>
							<tr>
								<th>이자율</th>
								<td>연 0.1&#37;</td>
