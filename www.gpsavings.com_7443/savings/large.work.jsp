...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/savings/large.installment.jsp">정기적금</a></li>
				<li><a href="/savings/large.generously.jsp">아낌없이 주는 적금</a></li>
				<li><a href="/savings/large.2030.jsp">2030누구나 정기적금</a></li>
				<li><a href="/savings/large.free.jsp">자유적립예금</a></li>
				<li><a href="/savings/large.work.jsp">공평재형저축</a></li>
				<li><a href="/savings/nonFace.installment.savings.jsp">비대면 정기적금</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_savings_21.gif" alt="목돈마련상품" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/savings/large.installment.jsp">목돈마련상품</a></li>
			...
			<div class="navi">홈 &gt; 예금상품 &gt; 목돈마련상품 &gt; <span>공평재형저축</span></div>
		</div>

		<div class="con_body saving large work">
			<div class="box1">
				<h3 class="hiding">서민의 재산 형성을 위한 적립식 상품으로 만기 보유시 이자소득에 대하여 소득세가 감면되는 세제혜택상품입니다.</h3>
				<p style="height:70px;"></p>
				<h4><img src="../inc/img/txt/h4_savings_24.gif" alt="공평재형저축" /></h4>
				<p style="height:20px;"></p>
				<h6><img src="../inc/img/txt/txt_join.gif" alt="가입조건" /></h6>
				...
				<div class="tables type2">
					<table>
						...
						<tbody class="tbodys">
							<tr>
								<th>가입대상</th>
								<td class="moreline">가입일 현재 다음의 어느 하나에 해당하는 세법상 거주자인 개인고객
<ul class=&quot;default_list&quot;>
<li><strong>1.</strong><span>직전 과세기간의 총급여액이 5천만원 이하인 고객<br />
* 근로소득만 있거나 근로소득 및 종합소득과세표준에 합산되지 않는 종합소득이 있는 경우에 한함</span></li>
<li><strong>2.</strong><span>위 1번 이외의 고객 중 직전 과세기간의 종합소득과세표준에 합산되는 종합소득금액이 3천500만원 이하인 고객<br />
* 근로소득 또는 사업소득이 있는 경우에 한함</span></li>
</ul></td>
							</tr>
							<tr>
								<th>저축한도</th>
								<td>분기당 300만원 이내 &#40;1만원 단위로 자유롭게 저축&#41;</td>
							</tr>
							<tr>
								<th>계약기간</th>
								<td>7년 &#40;단, 1회에 한해 3년 이내에서 1년 단위로 연장가능&#41;</td>
							</tr>
							<tr>
								<th class="moreline">세제혜택 및<br />유의사항</th>
								<td class="moreline">이자소득에 대해 비과세 &#40;단, 농어촌특별세 1.4&#37;는 적용&#41;
<ul>
<li>계약기간 만료일 이전에 중도 해지하는 경우 일반과세 적용됩니다.
<br />&#40;계약기간 연장 후 중도 해지하는 경우도 일반과세&#41;
<br />계약기간 만료일 이후 발생하는 이자소득은 일반과세 적용됩니다.</li>
</ul>
<ul>
<li>예금의 중도해지에도 불구하고 재형저축특약 제7조의 특별해지사유에 해당하는 경우 이자소득에 대해 비과세 적용됩니다.</li>
</ul></td>
							</tr>
							<tr>
								<th>최고 이자율</th>
								<td>최대 연4.8&#37;&#40;우대이자율 포함&#41;</td>
							</tr>
							<tr>
								<th>기본 이자율</th>
								<td class="moreline">연4.4&#37;
<ul>
<li>기본이자율은 가입 후 3년간 고정 적용되고, 3년 후에는 매년 신규 가입 해당일 현재 영업점 및 홈페이지에 고시한 기본이자율이 1년 단위로 적용됩니다.</li>
</ul></td>
							</tr>
							<tr>
								<th>우대 이자율</th>
								<td class="moreline">다음 각각의 우대요건 충족 여부에 따라 가입일로부터 3년간 최대 0.3&#37;p까지 우대이자율이 적용됩니다.&#40;단, 자녀가 2명 이상인 경우엔 다른 우대요건 충족시 최대 0.4&#37;p까지 우대이자율이 적용됩니다.&#41;
<ul class=&quot;default_list&quot;>
<li><strong>1.</strong><span>가입시점에 자녀&#40;태아 포함&#41;가 2명 이상인 경우 0.2&#37;p &#40;가족관계증명서 또는 주민등록등본 제출&#41;</span></li>
<li><strong>2.</strong><span>가입시점 소득확인증명서의 소득금액이 3천만원 이하인 경우 0.1&#37;p</span></li>
<li><strong>3.</strong><span>가입시점에 당사 인터넷뱅킹에 가입한 경우 0.1&#37;p</span></li>
<li><strong>4.</strong><span>가입시점에 당사 스마트폰뱅킹에 가입한 경우 0.1&#37;p</span></li>
<li><strong>5.</strong><span>가입시점 이전부터 당사와 거래 중인 경우 0.1&#37;p</span></li>
</ul></td>
							</tr>
							<tr>
								<th>중도해지 이자율</th>
								<td class="moreline">만기일 전에 계좌를 해지하는 경우 다음 예치기간별 중도해지이자율이 적용됩니다.
									<div class="tables type1 mt10 mb10">
										<table>
											<colgroup>
												<col width="210px"/>
												<col />
									...
									<ul>
<li>계약기간 연장 후 중도 해지하는 경우에는 7년이 되는 날까지는 정상이자율을 적용하며, 연장일부터 중도해지 기간까지는 연장된 기간이 시작되는 날 영업점 및 홈페이지에 고시된 예치기간별 중도해지이자율이 적용됩니다.</li>
</ul>
								</td>
							</tr>
							<tr>
								<th>만기후 이자율</th>
								<td class="moreline">계약기간 종료 후에는 다음 만기 후 이자율이 적용됩니다.<br />&#40;만기 후 이자에 대한 소득세는 일반 과세 됩니다&#41;
									<div class="tables type2 mt10 mb10">
										<table>
											<colgroup>
												<col width="210px"/>
												<col />
									...
									<ul>
<li>계약기간 연장 후 만기후이자율은 연장된 기간이 시작되는 날 영업점 및 홈페이지에 고시된 만기후이자율이 적용됩니다.</li>
</ul>
								</td>
							</tr>
							<tr>
								<th>제한사항</th>
								<td>재형저축은 제3자 양도, 계좌분할, 일부해지, 상품전환이 금지됩니다.</td>
							</tr>
							<tr>
								<th>제출서류</th>
								<td class="moreline">소득확인증명서 &#40;재형저축 가입용&#41;
<ul>
<li>근로소득만 있는 고객은 2014년 귀속 근로소득 원천징수영수증을 2015.6.30까지 소득확인증명서로 갈음.</li>
</ul></td>
							</tr>
							<tr>
								<th>기  타</th>
								<td class="moreline">가입대상 적격여부 확인<br />
<ul class=&quot;default_list&quot;>
<li><strong>-</strong><span>조세특례제한법에 의거 소득확인증명서 미제출시 가입 불가능 합니다.</span></li>
<li><strong>-</strong><span>국세청은 이 예금에 가입한 고객의 가입대상 적격여부를 점검하여 가입일 다음해 2월말까지 부적격가입 여부를 저축은행에 통보하며, 저축은행이 통보를 받은 날로부터 해지된 것으로 보아 추가납입 및 이자의 제공이 중단됩니다.</span></li>
<li><strong>-</strong><span>부적격통보에 이의가 있는 경우 저축은행이 통보를 받은 날로부터 2개월 이내 국세청에 의견을 제시할 수 있습니다.</span></li>
<li><strong>-</strong><span>조세특례제한법에서 정하는 사유에 해당시 비과세로 특별해지 하실 수 있으며, 이 경우 특별해지사유신고서를 제출해야 합니다.</span></li>
</ul></td>
							</tr>
						</tbody>
					</table>
				...
				<ul style="width:100%;" class="mt20">
					<li>이 예금은 예금자보호법에 따라 예금보험공사가 보호하되, 보호한도는 본 상호저축은행에 있는 귀하의 모든 예금보호대상 금융상품의 원금과 소정의 이자를 합하여 1인당 “최고 5천만원”이며, 5천만원을 초과하는 나머지 금액은 보호하지 않습니다.</li>
				</ul>
				<h5 class="mb45">공평저축은행 준법감시인 심의필 2017-004호(2017.1.19)</h5>
			</div><!--//box1-->
		</div><!--//2030-->
