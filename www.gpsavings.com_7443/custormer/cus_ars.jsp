...
<script type="text/javascript">
	function goSubmit() {
		...
		var guest_phone1 = $('#guest_phone1');
		var guest_phone2 = $('#guest_phone2');
		var guest_phone3 = $('#guest_phone3');
		...
		if (check_flag.is(':checked')) {
			...
			else if (guest_phone1.val() == '') {
				alert('전화번호를 입력해 주십시오.');
				guest_phone1.focus();
			}
			else if (guest_phone2.val() == '') {
				alert('전화번호를 입력해 주십시오.');
				guest_phone2.focus();
			}
			else if (guest_phone3.val() == '') {
				alert('전화번호를 입력해 주십시오.');
				guest_phone3.focus();
			}
...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<h2><img src="../inc/img/txt/ars_tit.jpg" alt="전자민원접수" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/custormer/cus_ars.jsp">ARS 구성도</a></li>
			...
			<div class="navi">홈 &gt; 고객센터 &gt; 전자민원접수 &gt; <strong>ARS 구성도</strong></div>
		</div>
		<div class="con_body  ">
			<div>
				<h3 class="hiding">ARS TREE</h3>
                <h4><img src="../inc/img/img/bg_cus_ars.jpg" alt="ARS TREE" /></h4>
               <p><img src="../inc/img/img/cus_ars_img01.jpg" alt="ARS_메인메뉴" /></p>
               <p><img src="../inc/img/img/cus_ars_img02.jpg" alt="ARS_예금" /></p>
               <p><img src="../inc/img/img/cus_ars_img03.jpg" alt="ARS_신용대출" /></p>
               <p><img src="../inc/img/img/cus_ars_img04.jpg" alt="ARS_담보대출" /></p>
               <p><img src="../inc/img/img/cus_ars_img05.jpg" alt="ARS_채무조회" /></p>
               <p><img src="../inc/img/img/cus_ars_img06.jpg" alt="ARS_인터넷뱅킹" /></p>
               <p><img src="../inc/img/img/cus_ars_img07.jpg" alt="ARS_콜백" /></p>
               <p><img src="../inc/img/img/cus_ars_img08.jpg" alt="ARS_콜백2" /></p>
