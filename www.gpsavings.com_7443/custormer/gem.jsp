...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<h2><img src="../inc/img/txt/gong_tit.jpg" alt="자주하는질문" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/custormer/gem.jsp">상품공시실</a></li>
						
					</ul>
				</div>
			 
			<div class="navi">홈 &gt; 고객센터 &gt; 상품공시실</div>
		</div>
		<div class="con_body bank_info gem">
			<div class="box1">
				<div class="faq_bg">
					<h3><a href="http://consumer.fss.or.kr/fss/consumer/main.jsp" target="_blank"><img src="../inc/img/txt/gong_txt_03.jpg" alt="금융감독원 금융소비자정보 포털시스템 바로가기" /></a></h3>
					<p class="mt25b15"><img src="../inc/img/txt/gong_txt_04.jpg" alt="다른 금융회사의 금융상품과 비교해 보세요!" /></p>
					<h3 class="mb5i"><a href="http://www.fsb.or.kr/financepro/deposit_info04.do" target="_blank"><img src="../inc/img/txt/gong_txt_06.jpg" alt="상호저축은행중앙회 홈페이지 내 예금금리 비교공시 바로가기" /></a><br/>
					<a href="http://www.fsb.or.kr/financepro/loan_rates_new.do" target="_blank"><img src="../inc/img/txt/gong_txt_09.jpg" alt="상호저축은행중앙회 홈페이지 내 대출금리 비교공시 바로가기" /></a><br/>
					<a href="http://consumer.fss.or.kr/fss/consumer/main.jsp" target="_blank"><img src="../inc/img/txt/gong_txt_11.jpg" alt="금융감독원 금융소비자정보 포털시스템 바로가기" /></a></h3>
					<p class="mt25b15"><img src="../inc/img/txt/gong_txt_14.jpg" alt="금융계산기를 이용하여 만기예상금액 등을 설계해 보세요!" /></p>
					<p class="txt">예금액, 이자방식, 기간, 금리 등을 선택하여 월납부액 또는 만기예상금액 직접 계산해 볼 수 있습니다.</p>
					<a href="http://www.fsb.or.kr/assurance/asr_cac1.do" target="_blank"><img src="../inc/img/txt/gong_txt_16.jpg" alt="상호저축은행중앙회 홈페이지 내 금융계산기 바로가기" /></a></h3>
					<p class="mt25b15"><img src="../inc/img/txt/gong_txt_19.jpg" alt="자격있는 금융상품 모집인과 거래하세요!" /></p>
					<p class="txt">무자격모집인과 거래시 문제가 발생할 수 있으며 피해구제도 곤란할 수 있으므로 자격여부를 꼭 확인하고 거래하세요.</p>
					<h3><a href="http://www.loanconsultant.or.kr/" target="_blank"><img src="../inc/img/txt/gong_txt_22.jpg" alt="상호저축은행중앙회 홈페이지 내 대출상담사조회 바로가기" /></a></h3>
					<p class="mt25b15"><img src="../inc/img/txt/gong_txt_25.jpg" alt="예금자보호제도의 보호대상 기관인지, 보호대상 금융상품인지 확인하세요!" /></p>
					<h3><a href="http://www.kdic.or.kr/protect/new_index.jsp" target="_blank"><img src="../inc/img/txt/gong_txt_28.jpg" alt="상호저축은행중앙회 홈페이지 내 대출상담사조회 바로가기" /></a></h3>
					<p class="mt25b15"><img src="../inc/img/txt/gong_txt_31.jpg" alt="예금자보호제도의 보호대상 기관인지, 보호대상 금융상품인지 확인하세요!" /></p>
					<p class="txt">금융상품에 대해 상담 및 불만(민원)이 있을 경우 금융회사 민원센터에 문의할 수 있으며, 처리결과에 이의가 있으면<br />
					금융감독원에 민원 또는 분쟁조정을 신청하실 수 있습니다.</p>
					<h3 class="fll"><a href="/custormer/cus_compl.jsp"><img src="../inc/img/txt/gong_txt_34.jpg" alt="당행고객센터 바로가기" /></a></h3>
					<h3 class="fll"><a href="http://www.fsb.or.kr/customer/question_form.do" target="_blank"><img src="../inc/img/txt/gong_txt_36.jpg" alt="저축은행 민원센터 바로가기" /></a></h3>
					<h3 class="fll"><a href="http://www.fcsc.kr/main.jsp" target="_blank"><img src="../inc/img/txt/gong_txt_38.jpg" alt="금융감독원 민원상담 바로가기" /></a></h3>
                </div>
			</div><!-- box1 -->
		</div><!-- saving -->
	</div>
