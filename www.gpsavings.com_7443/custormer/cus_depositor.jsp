...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			<ul>
				<li><a href="/custormer/cus_depositor.jsp">예금자보호제도</a></li>
				<li><a href="/custormer/cus_finance.jsp">보호금융상품등록부</a></li>
			</ul>
			<h2><img src="../inc/img/txt/h2_custormer_1.gif" alt="예금자보호안내" /></h2>
				...
				<div class="tab_menu">
					<ul>
							...
							<li class="on"><a href="/custormer/cus_depositor.jsp">예금자보호 안내</a></li>
							<li ><a href="/custormer/gem.jsp">상품공시실</a></li>
						
					</ul>
				</div>
			 
			<div class="navi">홈 &gt; 고객센터 &gt; 예금자보호안내 &gt; <span>예금자보호제도</span></div>
		</div>
		<div class="con_body custormer depositor">
			<div class="box1">
                <h4><img src="../inc/img/txt/h4_custormer_41.gif" alt="예금자보호제도" /></h4>
                <ol class="term">
                    <li><h6><img src="../inc/img/txt/h6_custormer_411.gif" alt="1.예금보호안내" /></h6>
                        <ul>
                            <li>- <span>예금자 보호 및 금융제도의 안정성 유지를 위하여, 예금보호대상 금융기관이 영업정지나 파산 등으로 고객이 맡긴 예금을 돌려 주지 못하게 되면 예금보험공사가 예금자에게 예금보험금을 지급합니다.</span></li>
                        </ul>
                    </li>
                    <li><h6><img src="../inc/img/txt/h6_custormer_412.gif" alt="2.보호대상 금융기관" /></h6>
                        <ul>
                            <li>- <span>은행(농.수협중앙회 포함, 농.수협 단위조합 제외)/증권회사/보험회사/종합금융회사/저축은행의 예금 등을 보호대상으로 합니다.</span></li>
                            <li>- <span>신용협동조합은 예금보험공사에 의하여 2003년말까지만 보호되었으나, 2004년부터는 신협중앙회의 예금자보호기금에 의하여 보호되며, 농.수협 단위조합은 각 중앙회의 상호금융 예금자보호기금에 의하여 보호됩니다.</span></li>
                        </ul>
                    </li>
                    <li><h6><img src="../inc/img/txt/h6_custormer_413.gif" alt="3.1인당 보호한도" /></h6>
                        <ul>
                            <li>- <span>원금과 소정의 이자를 합하여 예금자 1인당 최고 5천만원까지 보호됩니다.</span></li>
                            <li>- <span>1인당 보호한도는 각 금융기관별로 적용되며, 동일 금융기관 본점 및 지점의 예금은 모두 합산하여 적용됩니다.</span></li>
                            <li>- <span>예금한 금융기관으로부터 대출을 받은 경우에는 대출 채무액을 차감한 후 1인당 보호한도가 적용됩니다.</span></li>
                        </ul>
                    </li>
                    <li class="last"><h6><img src="../inc/img/txt/h6_custormer_414.gif" alt="4.기타 유의사항" /></h6>
                        <ul>
                            <li>- <span>예금보험금은 금융실명거래 및 비밀보장에 관한 법률에 따라 실명 확인 절차를 거친 예금 명의인에게 지급합니다.</span></li>
                            <li>- <span>정부 및 지방자치단체, 한국은행, 금융감독원, 부보금융기관의 예금은 보호되지 않습니다.</span></li>
                        </ul>
                    </li>
                </ol>
                <h5><img src="../inc/img/txt/h5_custormer_411.gif" alt="금융권별 보호금융상품 현황 (2008년 7월 1일 기준)" /></h5>
                <div class="tables type1">
                    <table>
                        ...
                        <tbody class="tbodys">
                            <tr>
                                <td class="first">저축은행</td>
                                <td>
                                    <ul>
                                        <li>- <span>보통예금, 저축예금, 정기예금, 정기적금, 신용부금, 표지어음 등</span></li>
                                    </ul>
                                </td>
                                <td>
                                    <ul>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li>- <span>보통예금, 별단예금, 당좌예금 등 요구불예금</span></li>
                                        <li>- <span>정기예금, 저축예금, 기업자유예금, 주택청약예금 등 저축성예금</span></li>
                                        <li>- <span>정기적금, 주택청약부금, 상호부금 등 적립식예금</span></li>
                                        <li>- <span>연금신탁, 퇴직신탁 등 원금보전형신탁 및 표지어음</span></li>
                                    </ul>
                                </td>
                                <td>
                                    <ul>
                                        <li>- <span>외화예금, 양도성 예금증서(CD), 환매조건부채권(RP), 은행발행채권</span></li>
                                        <li>- <span>특정금전신탁 등 실적배당형신탁 및 개발신탁</span></li>
                                        <li>- <span>간접투자자산운용업법에 의한 간접투자상품(수익증권, 뮤추얼펀드 등)</span></li>
                                        <li>- <span>농•수협 중앙회 공제상품</span></li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                                <td class="first">증권회사</td>
                                <td>
                                    <ul>
                                        <li>- <span>위탁자예수금, 저축자예수금, 수익자예수금 등의 현금 잔액</span></li>
                                        <li>- <span>자기신용대주담보금, 신용거래계좌 설정보증금, 신용공여 담보금 등의 현금 잔액</span></li>
                                    </ul>
                                </td>
                                <td>
                                    <ul>
                                        <li>- <span>유가증권, 청약자예수금, 제세금예수금, 유통금융대주담보금, 환매조건부채권(RP), 증권사발행채권</span></li>
                                        <li>- <span>간접투자자산운용업법에 의한 간접투자상품(수익증권, 뮤추얼펀드 등)</span></li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                                <td class="first">보험회사</td>
                                <td>
                                    <ul>
                                        <li>- <span>개인이 가입한 보험계약, 퇴직보험계약</span></li>
                                    </ul>
                                </td>
                                <td>
                                    <ul>
                                        <li>- <span>법인보험계약(보험계약자 및 보험료 납부자가 법인인 보험계약), 보증보험계약, 변액보험계약, 재보험계약</span></li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                                <td class="first">종합금융회사</td>
                                <td>
                                    <ul>
                                        <li>- <span>발행어음, 표지어음, 어음관리계좌(CMA)</span></li>
                                    </ul>
                                </td>
                                <td>
                                    <ul>
                                        <li>- <span>수익증권, 환매조건부채권(RP), 종금사발행채권, 기업어음(CP)</span></li>
                                    </ul>
                                </td>
                            </tr>
                        </tbody>
