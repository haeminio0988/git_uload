...
<!-- 								</li> -->
	...
	<div id="body" class="contents subtype">
		<div class="con_head">
			...
			<div class="navi">홈 &gt; 고객센터 &gt; 예금자보호안내 &gt; <span>보호금융상품등록부</span></div>
		</div>
		<div class="con_body custormer finance">
			<div class="box1">
                <h4><img src="../inc/img/txt/h4_custormer_42.gif" alt="보호금융상품등록부" /></h4>
                <p>본 금융기관이 취급하는 금융상품 중 예금보험공사가 예금자보호법에 의하여 보호하는 금융상품의 종류는 다음과 같습니다.</p>
                <span><strong><font color="black" size="3">보호금융상품 목록</font><font size="1"> (2017년 7월 1일 기준)</font></strong></span>
                <div class="tables type1">
                    <table>
                        ...
                        <tbody class="tbodys">
                            ...
                            <tr>
                                <td class="first">5</td>
                                <td class="second">수입부금</td>
                                <td class="third">100일적금</td>
                                <td class="fourth"> </td>
                                <td> </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>방카슈랑스</td>
                                <td>Samsung's Trademark Package</td>
                                <td> </td>
                                <td> </td>
                            </tr> -->
                        </tbody>
                ...
                <ul>
                    <li>예금자보호제도에 관한 자세한 내용은 <span>영업점에 비치된 예금자보호 안내책자 등을 참고</span>하시거나 <span><strong>예금보험공사 (1588-0037, www.kdic.or.kr)</strong></span>로 문의하시기 바랍니다.</li>
                </ul>
                <div class="cus_finance_box1">
                    <ul>
                        <li>정부, 지방자치단체, 한국은행, 금융감독원, 예금보험공사, 부보금융기관(예금보험 가입 금융기관)이 가입한 금융상품은 보호되지 않습니다.</li>
                        <li>보험상품은 보험계약자 및 보험료 납부자가 법인이면 보호되지 않습니다. 단, 확정기여형퇴직연금보험은 보호받을 수 있습니다.</li>
                    </ul>
                </div>
			</div><!-- box1 -->
		</div><!-- saving -->
